...
void cfg_T14(void)
{
 TIM_Reset(((BTIM_SFRmap *)((uint32_t)0x40001800)));
 BTIM_Updata_Immediately_Config(((BTIM_SFRmap *)((uint32_t)0x40001800)),TRUE);
 BTIM_Updata_Enable(((BTIM_SFRmap *)((uint32_t)0x40001800)),TRUE);
 BTIM_Work_Mode_Config(((BTIM_SFRmap *)((uint32_t)0x40001800)),((uint32_t)0 << (1)));
 BTIM_Set_Counter(((BTIM_SFRmap *)((uint32_t)0x40001800)),0);
 BTIM_Set_Period(((BTIM_SFRmap *)((uint32_t)0x40001800)),999);
 BTIM_Set_Prescaler(((BTIM_SFRmap *)((uint32_t)0x40001800)),15);
 BTIM_Counter_Mode_Config(((BTIM_SFRmap *)((uint32_t)0x40001800)),((uint32_t)4 << (6)));
 BTIM_Clock_Config(((BTIM_SFRmap *)((uint32_t)0x40001800)),((uint32_t)1 << (3)));
 INT_Interrupt_Priority_Config(INT_T14,4,0);
 BTIM_Overflow_INT_Enable(((BTIM_SFRmap *)((uint32_t)0x40001800)),TRUE);
 INT_Interrupt_Enable(INT_T14,TRUE);
 INT_Clear_Interrupt_Flag(INT_T14);
 BTIM_Cmd(((BTIM_SFRmap *)((uint32_t)0x40001800)),TRUE);
 INT_Stack_Align_Config(((uint32_t)1<<((7))));
}
