...
void cfg_GPIO_for_USART0(void)
{
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0008),GPIO_MODE_RMP);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0080),GPIO_MODE_RMP);

 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint32_t)0x3),((uint32_t)0x0303));
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint32_t)0x7),((uint32_t)0x0303));
}

void cfg_USART0(void)
{
 USART_Reset(((USART_SFRmap *) ((uint32_t)0x40000980)));
    USART_Receive_Order_Config(((USART_SFRmap *) ((uint32_t)0x40000980)), ((uint32_t)0<<(5)));
    USART_Transmit_Order_Config(((USART_SFRmap *) ((uint32_t)0x40000980)), ((uint32_t)0<<(4)));
    USART_BaudRate_Clock_Config(((USART_SFRmap *) ((uint32_t)0x40000980)), ((uint32_t)0<<(1)));
    USART_Clock_Source_Config(((USART_SFRmap *) ((uint32_t)0x40000980)), ((uint32_t)1<<(8)));
    USART_SYNC_Choice_Config(((USART_SFRmap *) ((uint32_t)0x40000980)), ((uint32_t)0<<(14)));
    USART_Transmit_Data_Enable(((USART_SFRmap *) ((uint32_t)0x40000980)), TRUE);
    USART_Receive_Data_Enable(((USART_SFRmap *) ((uint32_t)0x40000980)), TRUE);
    USART_STOP_Word_Config(((USART_SFRmap *) ((uint32_t)0x40000980)), ((uint32_t)0<<(18)));
    USART_9Data_Enable(((USART_SFRmap *) ((uint32_t)0x40000980)), FALSE);
    USART_RESHD_Enable(((USART_SFRmap *) ((uint32_t)0x40000980)), TRUE);
    USART_BaudRate_Integer_Config(((USART_SFRmap *) ((uint32_t)0x40000980)), ((uint16_t)((120)*1000000/((115200)*16))));
    USART_Cmd(((USART_SFRmap *) ((uint32_t)0x40000980)), TRUE);
}
