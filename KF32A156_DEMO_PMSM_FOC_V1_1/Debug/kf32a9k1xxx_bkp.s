	...
	.stabs	"../src/kf32a9k1xxx_bkp.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_bkp.h",130,0,0,0
...
BKP_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext2
.Ltext2:
...
BKP_Write_And_Read_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext3
.Ltext3:
...
.L7:
	...
	LJMP	r5
	.stabn	68,0,56,.LM10-.LFBB3
.LM10:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L8
	.stabn	68,0,60,.LM11-.LFBB3
.LM11:
	MOV	r5,#1
	LSL	r5,#30
	LD.w	r5,[r5]
	ST.w	[sp],r5
	.stabn	68,0,61,.LM12-.LFBB3
.LM12:
	LD.w	r4,[sp]
	MOV	r5,#1
	ANL	r5,r4,r5
	CMP	r5,#0
	JZ	.L9
	.stabn	68,0,63,.LM13-.LFBB3
.LM13:
	LD	r4,#pmwrenbkp.2108
	MOV	r5,#1
	ST.w	[r4],r5
	JMP	.L10
.L9:
	.stabn	68,0,67,.LM14-.LFBB3
.LM14:
	LD	r4,#pmwrenbkp.2108
	MOV	r5,#0
	ST.w	[r4],r5
	.stabn	68,0,69,.LM15-.LFBB3
.LM15:
	MOV	r5,#1
	LSL	r5,#30
// inline asm begin
...
// inline asm end
.L10:
	.stabn	68,0,73,.LM16-.LFBB3
.LM16:
	LD	r5,#1073747328
	LD.w	r5,[r5]
	ST.w	[sp],r5
	.stabn	68,0,74,.LM17-.LFBB3
.LM17:
	LD.w	r4,[sp]
	MOV	r5,#1
	LSL	r5,#22
...
.LM23:
	...
	JMP	.L4
.L13:
	.stabn	68,0,93,.LM24-.LFBB3
.LM24:
	LD	r4,#bkpwrbkp.2110
	MOV	r5,#0
	ST.w	[r4],r5
	.stabn	68,0,95,.LM25-.LFBB3
.LM25:
	LD	r5,#1073747328
// inline asm begin
...
.LM27:
	...
	JMP	.L16
.L15:
	.stabn	68,0,108,.LM28-.LFBB3
.LM28:
	LD	r4,#pmwrenbkp.2108
	MOV	r5,#0
	ST.w	[r4],r5
	.stabn	68,0,110,.LM29-.LFBB3
.LM29:
	MOV	r5,#1
	LSL	r5,#30
// inline asm begin
...
.LM38:
	...
	.stabs	"pmwrenbkp:V(3,6)",38,0,49,pmwrenbkp.2108
	.stabs	"bkpregclrbkp:V(3,6)",38,0,50,bkpregclrbkp.2109
	.stabs	"bkpwrbkp:V(3,6)",38,0,51,bkpwrbkp.2110
...
BKP_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext4
.Ltext4:
...
.L23:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,158,.LM41-.LFBB4
.LM41:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L24
	.stabn	68,0,161,.LM42-.LFBB4
.LM42:
	LD	r5,#1073746944
// inline asm begin
...
BKP_Pin_Effective_Level_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext5
.Ltext5:
...
.LM49:
	...
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,192,.LM50-.LFBB5
.LM50:
	LD.w	r5,[sp+#2]
	CMP	r5,#0
	JZ	.L33
	.stabn	68,0,195,.LM51-.LFBB5
.LM51:
	LD	r5,#1073746944
	LD	r4,#1073746944
	LD.w	r3,[r4]
...
BKP_Pin_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,215,.LM54-.LFBB6
.LM54:
.LFBB6:
	PUSH	lr
	SUB	sp,#12
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,216,.LM55-.LFBB6
.LM55:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,219,.LM56-.LFBB6
.LM56:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L36
...
.Lscope6:
	...
	.type	.text$BKP_TAMP_SYNC_Mode_Select$scode_local_7, @function
	.text$BKP_TAMP_SYNC_Mode_Select$scode_loacal_7:
	.align	1
	.stabs	"BKP_TAMP_SYNC_Mode_Select:F(0,15)",36,0,244,BKP_TAMP_SYNC_Mode_Select
	.stabs	"Mode:p(3,6)",160,0,244,0
	.export	BKP_TAMP_SYNC_Mode_Select
	.type	BKP_TAMP_SYNC_Mode_Select, @function
BKP_TAMP_SYNC_Mode_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,245,.LM63-.LFBB7
.LM63:
.LFBB7:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,247,.LM64-.LFBB7
.LM64:
	MOV	r5,#1
	LD.w	r4,[sp]
	CMP	r4,#1
...
.Lscope7:
	...
	.type	.text$BKP_TAMP_SCK_Select$scode_local_8, @function
	.text$BKP_TAMP_SCK_Select$scode_loacal_8:
	.align	1
	.stabs	"BKP_TAMP_SCK_Select:F(0,15)",36,0,260,BKP_TAMP_SCK_Select
	.stabs	"CLK:p(3,6)",160,0,260,0
	.export	BKP_TAMP_SCK_Select
	.type	BKP_TAMP_SCK_Select, @function
BKP_TAMP_SCK_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,261,.LM67-.LFBB8
.LM67:
.LFBB8:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,263,.LM68-.LFBB8
.LM68:
	MOV	r5,#1
	LD.w	r4,[sp]
	CMP	r4,#1
...
.Lscope8:
	...
	.text$BKP_External_Clock_Bypass_Enable$scode_loacal_9:
	.align	1
	.stabs	"BKP_External_Clock_Bypass_Enable:F(0,15)",36,0,277,BKP_External_Clock_Bypass_Enable
	.stabs	"Source:p(3,6)",160,0,277,4
	.stabs	"NewState:p(2,2)",160,0,277,8
	.export	BKP_External_Clock_Bypass_Enable
	.type	BKP_External_Clock_Bypass_Enable, @function
BKP_External_Clock_Bypass_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,278,.LM71-.LFBB9
.LM71:
.LFBB9:
	PUSH	lr
	SUB	sp,#12
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,279,.LM72-.LFBB9
.LM72:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,282,.LM73-.LFBB9
.LM73:
	LD.w	r5,[sp+#1]
	CMP	r5,#1
	JZ	.L49
...
.L54:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,286,.LM75-.LFBB9
.LM75:
	LD.w	r4,[sp+#1]
	MOV	r5,#2
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,287,.LM76-.LFBB9
.LM76:
	LD.w	r5,[sp+#2]
	CMP	r5,#0
	JZ	.L55
	.stabn	68,0,290,.LM77-.LFBB9
.LM77:
	LD	r5,#1073746944
	LD	r4,#1073746944
	LD.w	r3,[r4]
...
.Lscope9:
	...
	.text$BKP_Data_Config$scode_loacal_10:
	.align	1
	.stabs	"BKP_Data_Config:F(0,15)",36,0,306,BKP_Data_Config
	.stabs	"OrderNumber:p(3,6)",160,0,306,0
	.stabs	"WriteData:p(3,6)",160,0,306,4
	.export	BKP_Data_Config
	.type	BKP_Data_Config, @function
BKP_Data_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,307,.LM80-.LFBB10
.LM80:
.LFBB10:
	PUSH	lr
	SUB	sp,#8
...
.Lscope10:
	...
	.text$BKP_Get_Data$scode_loacal_11:
	.align	1
	.stabs	"BKP_Get_Data:F(3,6)",36,0,321,BKP_Get_Data
	.stabs	"OrderNumber:p(3,6)",160,0,321,4
	.export	BKP_Get_Data
	.type	BKP_Get_Data, @function
BKP_Get_Data:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,322,.LM84-.LFBB11
.LM84:
.LFBB11:
	PUSH	lr
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,323,.LM85-.LFBB11
.LM85:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,326,.LM86-.LFBB11
.LM86:
	MOV	r5,#1
	LD.w	r4,[sp+#1]
	CMP	r4,#7
...
.LM87:
	...
	LD.w	r5,[r5]
	ST.w	[sp],r5
	.stabn	68,0,331,.LM88-.LFBB11
.LM88:
	LD.w	r5,[sp]
	.stabn	68,0,332,.LM89-.LFBB11
.LM89:
	MOV	r0,r5
	ADD	sp,#8
	POP	lr
...
.Lscope11:
	...
	.text$BKP_Pin_TAMP_INT_Enable$scode_loacal_12:
	.align	1
	.stabs	"BKP_Pin_TAMP_INT_Enable:F(0,15)",36,0,351,BKP_Pin_TAMP_INT_Enable
	.stabs	"PinSel:p(3,6)",160,0,351,4
	.stabs	"NewState:p(2,2)",160,0,351,8
	.export	BKP_Pin_TAMP_INT_Enable
	.type	BKP_Pin_TAMP_INT_Enable, @function
BKP_Pin_TAMP_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,352,.LM90-.LFBB12
.LM90:
.LFBB12:
	PUSH	lr
	SUB	sp,#12
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,353,.LM91-.LFBB12
.LM91:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,356,.LM92-.LFBB12
.LM92:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L63
...
.LM94:
	...
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,361,.LM95-.LFBB12
.LM95:
	LD.w	r5,[sp+#2]
	CMP	r5,#0
	JZ	.L69
	.stabn	68,0,364,.LM96-.LFBB12
.LM96:
	LD	r5,#1073746944
	LD	r4,#1073746944
	LD.w	r3,[r4+#1]
...
.LM97:
	...
	ST.w	[r4+#1],r5
.L62:
	.stabn	68,0,371,.LM98-.LFBB12
.LM98:
	ADD	sp,#12
	POP	lr
	JMP	lr
	.size	BKP_Pin_TAMP_INT_Enable, .-BKP_Pin_TAMP_INT_Enable
	.stabs	"tmpreg:(3,6)",128,0,353,0
...
.Lscope12:
	...
	.text$BKP_Get_Pin_TAMP_INT_Flag$scode_loacal_13:
	.align	1
	.stabs	"BKP_Get_Pin_TAMP_INT_Flag:F(2,4)",36,0,382,BKP_Get_Pin_TAMP_INT_Flag
	.stabs	"PinSel:p(3,6)",160,0,382,4
	.export	BKP_Get_Pin_TAMP_INT_Flag
	.type	BKP_Get_Pin_TAMP_INT_Flag, @function
BKP_Get_Pin_TAMP_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,383,.LM99-.LFBB13
.LM99:
.LFBB13:
	PUSH	lr
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,384,.LM100-.LFBB13
.LM100:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,387,.LM101-.LFBB13
.LM101:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L72
...
.LM103:
	...
	CMP	r5,#0
	JZ	.L75
	.stabn	68,0,394,.LM104-.LFBB13
.LM104:
	MOV	r5,#1
	JMP	.L76
.L75:
	.stabn	68,0,399,.LM105-.LFBB13
.LM105:
	MOV	r5,#0
.L76:
	.stabn	68,0,401,.LM106-.LFBB13
.LM106:
	MOV	r0,r5
	ADD	sp,#8
	POP	lr
...
.Lscope13:
	...
	.text$BKP_Clear_Pin_TAMP_INT_Flag$scode_loacal_14:
	.align	1
	.stabs	"BKP_Clear_Pin_TAMP_INT_Flag:F(0,15)",36,0,412,BKP_Clear_Pin_TAMP_INT_Flag
	.stabs	"PinSel:p(3,6)",160,0,412,8
	.export	BKP_Clear_Pin_TAMP_INT_Flag
	.type	BKP_Clear_Pin_TAMP_INT_Flag, @function
BKP_Clear_Pin_TAMP_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_bkp.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,413,.LM107-.LFBB14
.LM107:
.LFBB14:
	PUSH	lr
	SUB	sp,#12
	ST.w	[sp+#2],r0
	.stabn	68,0,414,.LM108-.LFBB14
.LM108:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,415,.LM109-.LFBB14
.LM109:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,417,.LM110-.LFBB14
.LM110:
	LD.w	r5,[sp+#2]
	CMP	r5,#0
	JZ	.L78
...
.L80:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,420,.LM111-.LFBB14
.LM111:
	LD.w	r4,[sp+#2]
	MOV	r5,#1
	LSL	r5,r5,r4
	ST.w	[sp],r5
	.stabn	68,0,421,.LM112-.LFBB14
.LM112:
	LD.w	r4,[sp+#2]
	MOV	r5,#1
	LSL	r5,#16
...
.LM115:
	...
	ANL	r5,r3,r5
	ST.w	[r4+#1],r5
	.stabn	68,0,425,.LM116-.LFBB14
.LM116:
	ADD	sp,#12
	POP	lr
	JMP	lr
	.size	BKP_Clear_Pin_TAMP_INT_Flag, .-BKP_Clear_Pin_TAMP_INT_Flag
	.stabs	"tmpreg:(3,6)",128,0,414,0
	.stabs	"tmpreg1:(3,6)",128,0,415,4
...
.Lscope14:
	...
	.type	.data$static$pmwrenbkp.2108$scode_local_15, @function
	.data$static$pmwrenbkp.2108$scode_loacal_15:
	.align	2
...
pmwrenbkp.2108:
	...
	.type	.data$static$bkpregclrbkp.2109$scode_local_16, @function
	.data$static$bkpregclrbkp.2109$scode_loacal_16:
	.align	2
...
bkpregclrbkp.2109:
	...
	.type	.data$static$bkpwrbkp.2110$scode_local_17, @function
	.data$static$bkpwrbkp.2110$scode_loacal_17:
	.align	2
