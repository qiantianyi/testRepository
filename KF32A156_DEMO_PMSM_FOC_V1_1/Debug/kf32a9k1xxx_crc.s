	...
	.stabs	"../src/kf32a9k1xxx_crc.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"CRC_InitTypeDef:t(1,1)=(1,2)=s44m_CalUnitReset:(3,6),0,32;m_InputSize:(3,6),32,32;m_InputReverse:(3,6),64,32;m_ResultReverse:(3,6),96,32;m_Data:(3,6),128,32;m_Result:(3,6),160,32;m_InitialData:(3,6),192,32;m_Polynomial:(3,6),224,32;m_ResultXOR:(3,6),256,32;m_IndepentData:(3,6),288,32;m_Temp:(3,6),320,32;;",128,0,38,0
	.stabn	162,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"CRC_Reset:F(0,15)",36,0,29,CRC_Reset
	.export	CRC_Reset
	.type	CRC_Reset, @function
CRC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext2
.Ltext2:
...
.Lscope2:
	...
	.align	1
	.stabs	"CRC_Configuration:F(0,15)",36,0,42,CRC_Configuration
	.stabs	"CRCInitStruct:p(0,16)=*(1,1)",160,0,42,4
	.export	CRC_Configuration
	.type	CRC_Configuration, @function
CRC_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext3
.Ltext3:
...
.Lscope3:
	...
	.align	1
	.stabs	"CRC_Struct_Init:F(0,15)",36,0,72,CRC_Struct_Init
	.stabs	"CRCInitStruct:p(0,16)",160,0,72,0
	.export	CRC_Struct_Init
	.type	CRC_Struct_Init, @function
CRC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,73,.LM23-.LFBB4
.LM23:
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
...
.LM24:
	...
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,77,.LM25-.LFBB4
.LM25:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,79,.LM26-.LFBB4
.LM26:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,81,.LM27-.LFBB4
.LM27:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,82,.LM28-.LFBB4
.LM28:
	ADD	sp,#4
	JMP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"CRC_INPUT_DATA:F(0,15)",36,0,90,CRC_INPUT_DATA
	.stabs	"DATA:p(3,6)",160,0,90,0
	.export	CRC_INPUT_DATA
	.type	CRC_INPUT_DATA, @function
CRC_INPUT_DATA:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,91,.LM29-.LFBB5
.LM29:
.LFBB5:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,93,.LM30-.LFBB5
.LM30:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#1],r4
	.stabn	68,0,94,.LM31-.LFBB5
.LM31:
	ADD	sp,#4
	JMP	lr
...
.Lscope5:
	...
	.align	1
	.stabs	"CRC_GET_RESULT:F(3,6)",36,0,101,CRC_GET_RESULT
	.export	CRC_GET_RESULT
	.type	CRC_GET_RESULT, @function
CRC_GET_RESULT:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,102,.LM32-.LFBB6
.LM32:
.LFBB6:
	SUB	sp,#4
...
.LM33:
	...
	LD.w	r5,[r5+#2]
	ST.w	[sp],r5
	.stabn	68,0,106,.LM34-.LFBB6
.LM34:
	LD.w	r5,[sp]
	.stabn	68,0,107,.LM35-.LFBB6
.LM35:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	CRC_GET_RESULT, .-CRC_GET_RESULT
	.stabs	"DATA:(3,6)",128,0,104,0
...
.Lscope6:
	...
	.align	1
	.stabs	"CRC_SET_INITVALUE:F(0,15)",36,0,114,CRC_SET_INITVALUE
	.stabs	"DATA:p(3,6)",160,0,114,0
	.export	CRC_SET_INITVALUE
	.type	CRC_SET_INITVALUE, @function
CRC_SET_INITVALUE:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,115,.LM36-.LFBB7
.LM36:
.LFBB7:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,117,.LM37-.LFBB7
.LM37:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#3],r4
	.stabn	68,0,118,.LM38-.LFBB7
.LM38:
	ADD	sp,#4
	JMP	lr
...
.Lscope7:
	...
	.align	1
	.stabs	"CRC_SET_PLN:F(0,15)",36,0,125,CRC_SET_PLN
	.stabs	"DATA:p(3,6)",160,0,125,0
	.export	CRC_SET_PLN
	.type	CRC_SET_PLN, @function
CRC_SET_PLN:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,126,.LM39-.LFBB8
.LM39:
.LFBB8:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,128,.LM40-.LFBB8
.LM40:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#4],r4
...
.Lscope8:
	...
	.align	1
	.stabs	"CRC_SET_RXOR:F(0,15)",36,0,136,CRC_SET_RXOR
	.stabs	"DATA:p(3,6)",160,0,136,0
	.export	CRC_SET_RXOR
	.type	CRC_SET_RXOR, @function
CRC_SET_RXOR:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,137,.LM42-.LFBB9
.LM42:
.LFBB9:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,139,.LM43-.LFBB9
.LM43:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#5],r4
...
.Lscope9:
	...
	.align	1
	.stabs	"CRC_SET_IDATA:F(0,15)",36,0,147,CRC_SET_IDATA
	.stabs	"DATA:p(3,6)",160,0,147,0
	.export	CRC_SET_IDATA
	.type	CRC_SET_IDATA, @function
CRC_SET_IDATA:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext10
.Ltext10:
...
.LFBB10:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,150,.LM46-.LFBB10
.LM46:
	LD	r5,#1073751680
	LD.w	r4,[sp]
	ST.w	[r5+#6],r4
	.stabn	68,0,151,.LM47-.LFBB10
.LM47:
	ADD	sp,#4
	JMP	lr
...
.Lscope10:
	...
	.align	1
	.stabs	"CRC_GET_TEMP:F(3,6)",36,0,158,CRC_GET_TEMP
	.export	CRC_GET_TEMP
	.type	CRC_GET_TEMP, @function
CRC_GET_TEMP:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,159,.LM48-.LFBB11
.LM48:
.LFBB11:
	SUB	sp,#4
	.stabn	68,0,162,.LM49-.LFBB11
.LM49:
	LD	r5,#1073751680
	LD.w	r5,[r5+#7]
	ST.w	[sp],r5
	.stabn	68,0,163,.LM50-.LFBB11
.LM50:
	LD.w	r5,[sp]
	.stabn	68,0,164,.LM51-.LFBB11
.LM51:
	MOV	r0,r5
	ADD	sp,#4
	JMP	lr
	.size	CRC_GET_TEMP, .-CRC_GET_TEMP
	.stabs	"DATA:(3,6)",128,0,161,0
...
.Lscope11:
	...
	.align	1
	.stabs	"CRC_SET_RSET:F(0,15)",36,0,171,CRC_SET_RSET
	.export	CRC_SET_RSET
	.type	CRC_SET_RSET, @function
CRC_SET_RSET:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,172,.LM52-.LFBB12
.LM52:
.LFBB12:
	.stabn	68,0,174,.LM53-.LFBB12
.LM53:
	LD	r4,#1073751680
	LD	r5,#1073751680
	LD.w	r5,[r5]
