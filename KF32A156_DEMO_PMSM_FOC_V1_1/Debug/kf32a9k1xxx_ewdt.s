...
.Lscope1:
	...
	.type	.text$EWDT_Reset$scode_local_2, @function
	.text$EWDT_Reset$scode_loacal_2:
	.align	1
...
.Lscope2:
	...
	.type	.text$EWDT_Output_Effective_Single_Select$scode_local_3, @function
	.text$EWDT_Output_Effective_Single_Select$scode_loacal_3:
	.align	1
	.stabs	"EWDT_Output_Effective_Single_Select:F(0,15)",36,0,38,EWDT_Output_Effective_Single_Select
	.stabs	"Select:p(3,6)",160,0,38,4
...
EWDT_Output_Effective_Single_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,39,.LM8-.LFBB3
.LM8:
.LFBB3:
	PUSH	{r6, lr}
	SUB	sp,#8
...
.L5:
	...
	LJMP	r5
	.stabn	68,0,45,.LM11-.LFBB3
.LM11:
	LD.w	r5,[sp+#1]
	LSL	r5,#24
	ST.w	[sp],r5
	.stabn	68,0,46,.LM12-.LFBB3
.LM12:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope3:
	...
	.type	.text$EWDT_Get_Reset_INT_Flag$scode_local_4, @function
	.text$EWDT_Get_Reset_INT_Flag$scode_loacal_4:
	.align	1
...
.Ltext4:
	.stabn	68,0,57,.LM14-.LFBB4
.LM14:
.LFBB4:
	.stabn	68,0,58,.LM15-.LFBB4
.LM15:
	LD	r5,#1073752832
	LD.w	r4,[r5]
	MOV	r5,#1
...
.Lscope4:
	...
	.type	.text$EWDT_Clear_Reset_INT_Flag$scode_local_5, @function
	.text$EWDT_Clear_Reset_INT_Flag$scode_loacal_5:
	.align	1
...
.Ltext5:
	.stabn	68,0,68,.LM17-.LFBB5
.LM17:
.LFBB5:
	.stabn	68,0,69,.LM18-.LFBB5
.LM18:
	LD	r5,#1073752832
// inline asm begin
	// 69 "../src/kf32a9k1xxx_ewdt.c" 1
	SET [r5], #22
	.stabn	68,0,70,.LM19-.LFBB5
.LM19:
// inline asm end
	NOP
.L9:
	...
	CMP	r5,#0
	JNZ	.L9
	.stabn	68,0,71,.LM20-.LFBB5
.LM20:
	LD	r5,#1073752832
// inline asm begin
	// 71 "../src/kf32a9k1xxx_ewdt.c" 1
	CLR [r5], #22
	.stabn	68,0,72,.LM21-.LFBB5
.LM21:
// inline asm end
	JMP	lr
...
.Lscope5:
	...
	.type	.text$EWDT_Reset_Single_INT_Enable$scode_local_6, @function
	.text$EWDT_Reset_Single_INT_Enable$scode_loacal_6:
	.align	1
	.stabs	"EWDT_Reset_Single_INT_Enable:F(0,15)",36,0,81,EWDT_Reset_Single_INT_Enable
	.stabs	"NewState:p(2,2)",160,0,81,4
...
.Ltext6:
	.stabn	68,0,82,.LM22-.LFBB6
.LM22:
.LFBB6:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,83,.LM23-.LFBB6
.LM23:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,86,.LM24-.LFBB6
.LM24:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L11
...
.L13:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,88,.LM25-.LFBB6
.LM25:
	LD.w	r5,[sp+#1]
	LSL	r5,#21
	ST.w	[sp],r5
	.stabn	68,0,89,.LM26-.LFBB6
.LM26:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope6:
	...
	.type	.text$EWDT_CLK_Select$scode_local_7, @function
	.text$EWDT_CLK_Select$scode_loacal_7:
	.align	1
	.stabs	"EWDT_CLK_Select:F(0,15)",36,0,102,EWDT_CLK_Select
	.stabs	"CLK:p(3,6)",160,0,102,4
...
.Ltext7:
	.stabn	68,0,103,.LM28-.LFBB7
.LM28:
.LFBB7:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,104,.LM29-.LFBB7
.LM29:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,107,.LM30-.LFBB7
.LM30:
	MOV	r5,#1
	LD.w	r4,[sp+#1]
	CMP	r4,#3
...
.L15:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,109,.LM31-.LFBB7
.LM31:
	LD.w	r5,[sp+#1]
	LSL	r5,#18
	ST.w	[sp],r5
	.stabn	68,0,110,.LM32-.LFBB7
.LM32:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope7:
	...
	.type	.text$EWDT_Input_Effective_Single_Select$scode_local_8, @function
	.text$EWDT_Input_Effective_Single_Select$scode_loacal_8:
	.align	1
	.stabs	"EWDT_Input_Effective_Single_Select:F(0,15)",36,0,120,EWDT_Input_Effective_Single_Select
	.stabs	"Select:p(3,6)",160,0,120,4
...
EWDT_Input_Effective_Single_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,121,.LM34-.LFBB8
.LM34:
.LFBB8:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,122,.LM35-.LFBB8
.LM35:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,125,.LM36-.LFBB8
.LM36:
	MOV	r5,#1
	LD.w	r4,[sp+#1]
	CMP	r4,#1
...
.L17:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,127,.LM37-.LFBB8
.LM37:
	LD.w	r5,[sp+#1]
	LSL	r5,#17
	ST.w	[sp],r5
	.stabn	68,0,128,.LM38-.LFBB8
.LM38:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope8:
	...
	.type	.text$EWDT_Input_Single_Enable$scode_local_9, @function
	.text$EWDT_Input_Single_Enable$scode_loacal_9:
	.align	1
	.stabs	"EWDT_Input_Single_Enable:F(0,15)",36,0,138,EWDT_Input_Single_Enable
	.stabs	"NewState:p(2,2)",160,0,138,4
...
.Ltext9:
	.stabn	68,0,139,.LM40-.LFBB9
.LM40:
.LFBB9:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,140,.LM41-.LFBB9
.LM41:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,143,.LM42-.LFBB9
.LM42:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L19
...
.L21:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,145,.LM43-.LFBB9
.LM43:
	LD.w	r5,[sp+#1]
	LSL	r5,#16
	ST.w	[sp],r5
	.stabn	68,0,146,.LM44-.LFBB9
.LM44:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope9:
	...
	.type	.text$EWDT_Clear_Count40_INT_Flag$scode_local_10, @function
	.text$EWDT_Clear_Count40_INT_Flag$scode_loacal_10:
	.align	1
...
.Ltext10:
	.stabn	68,0,156,.LM46-.LFBB10
.LM46:
.LFBB10:
	.stabn	68,0,157,.LM47-.LFBB10
.LM47:
	LD	r5,#1073752832
// inline asm begin
	// 157 "../src/kf32a9k1xxx_ewdt.c" 1
	SET [r5], #15
	.stabn	68,0,158,.LM48-.LFBB10
.LM48:
// inline asm end
	NOP
.L23:
	...
	CMP	r5,#0
	JNZ	.L23
	.stabn	68,0,159,.LM49-.LFBB10
.LM49:
	LD	r5,#1073752832
// inline asm begin
	// 159 "../src/kf32a9k1xxx_ewdt.c" 1
	CLR [r5], #15
	.stabn	68,0,160,.LM50-.LFBB10
.LM50:
// inline asm end
	JMP	lr
...
.Lscope10:
	...
	.type	.text$EWDT_Threshold_Config$scode_local_11, @function
	.text$EWDT_Threshold_Config$scode_loacal_11:
	.align	1
	.stabs	"EWDT_Threshold_Config:F(0,15)",36,0,168,EWDT_Threshold_Config
	.stabs	"Threshold:p(3,6)",160,0,168,4
	.export	EWDT_Threshold_Config
	.type	EWDT_Threshold_Config, @function
EWDT_Threshold_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,169,.LM51-.LFBB11
.LM51:
.LFBB11:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,170,.LM52-.LFBB11
.LM52:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,173,.LM53-.LFBB11
.LM53:
	MOV	r5,#1
	LD.w	r4,[sp+#1]
	CMP	r4,#127
...
.L25:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,175,.LM54-.LFBB11
.LM54:
	LD.w	r5,[sp+#1]
	LSL	r5,#8
	ST.w	[sp],r5
	.stabn	68,0,176,.LM55-.LFBB11
.LM55:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope11:
	...
	.type	.text$EWDT_Clock_Div_Select$scode_local_12, @function
	.text$EWDT_Clock_Div_Select$scode_loacal_12:
	.align	1
	.stabs	"EWDT_Clock_Div_Select:F(0,15)",36,0,203,EWDT_Clock_Div_Select
	.stabs	"CLK_DIV:p(3,6)",160,0,203,4
...
.Ltext12:
	.stabn	68,0,204,.LM57-.LFBB12
.LM57:
.LFBB12:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,205,.LM58-.LFBB12
.LM58:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,208,.LM59-.LFBB12
.LM59:
	MOV	r5,#1
	LD.w	r4,[sp+#1]
	CMP	r4,#18
...
.L27:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,210,.LM60-.LFBB12
.LM60:
	LD.w	r5,[sp+#1]
	LSL	r5,#3
	ST.w	[sp],r5
	.stabn	68,0,211,.LM61-.LFBB12
.LM61:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope12:
	...
	.type	.text$EWDT_Get_Count40_INT_Flag$scode_local_13, @function
	.text$EWDT_Get_Count40_INT_Flag$scode_loacal_13:
	.align	1
...
.Ltext13:
	.stabn	68,0,221,.LM63-.LFBB13
.LM63:
.LFBB13:
	.stabn	68,0,222,.LM64-.LFBB13
.LM64:
	LD	r5,#1073752832
	LD.w	r4,[r5]
	MOV	r5,#4
...
.Lscope13:
	...
	.type	.text$EWDT_Count40_INT_Enable$scode_local_14, @function
	.text$EWDT_Count40_INT_Enable$scode_loacal_14:
	.align	1
	.stabs	"EWDT_Count40_INT_Enable:F(0,15)",36,0,232,EWDT_Count40_INT_Enable
	.stabs	"NewState:p(2,2)",160,0,232,4
	.export	EWDT_Count40_INT_Enable
	.type	EWDT_Count40_INT_Enable, @function
EWDT_Count40_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,233,.LM66-.LFBB14
.LM66:
.LFBB14:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,234,.LM67-.LFBB14
.LM67:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,237,.LM68-.LFBB14
.LM68:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L31
...
.L33:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,239,.LM69-.LFBB14
.LM69:
	LD.w	r5,[sp+#1]
	ADD	r5,r5,r5
	ST.w	[sp],r5
	.stabn	68,0,240,.LM70-.LFBB14
.LM70:
	LD	r6,#1073752832
	LD	r5,#1073752832
	LD.w	r5,[r5]
...
.Lscope14:
	...
	.type	.text$EWDT_Enable$scode_local_15, @function
	.text$EWDT_Enable$scode_loacal_15:
	.align	1
	.stabs	"EWDT_Enable:F(0,15)",36,0,250,EWDT_Enable
	.stabs	"NewState:p(2,2)",160,0,250,0
	.export	EWDT_Enable
...
.Ltext15:
	.stabn	68,0,251,.LM72-.LFBB15
.LM72:
.LFBB15:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,253,.LM73-.LFBB15
.LM73:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L35
...
.Lscope15:
	...
	.type	.text$EWDT_Get_Count_Value$scode_local_16, @function
	.text$EWDT_Get_Count_Value$scode_loacal_16:
	.align	1
...
.Ltext16:
	.stabn	68,0,265,.LM76-.LFBB16
.LM76:
.LFBB16:
	.stabn	68,0,266,.LM77-.LFBB16
.LM77:
	LD	r5,#1073752832
	LD.w	r5,[r5+#1]
	ZXT.b	r4,r5
...
.Lscope16:
	...
	.type	.text$EWDT_Set_Count_Value$scode_local_17, @function
	.text$EWDT_Set_Count_Value$scode_loacal_17:
	.align	1
	.stabs	"EWDT_Set_Count_Value:F(0,15)",36,0,275,EWDT_Set_Count_Value
	.stabs	"Value:p(3,2)",160,0,275,0
	.export	EWDT_Set_Count_Value
	.type	EWDT_Set_Count_Value, @function
EWDT_Set_Count_Value:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,276,.LM79-.LFBB17
.LM79:
.LFBB17:
	PUSH	{r6, lr}
	SUB	sp,#4
