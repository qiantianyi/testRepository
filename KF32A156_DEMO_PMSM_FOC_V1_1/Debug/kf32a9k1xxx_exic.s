	...
	.stabs	"../src/kf32a9k1xxx_exic.c",100,0,2,.Ltext0
	.text
.Ltext0:
...
.Lscope1:
	...
	.align	1
	.stabs	"EXIC_Reset:F(0,15)",36,0,38,EXIC_Reset
	.export	EXIC_Reset
	.type	EXIC_Reset, @function
EXIC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,39,.LM3-.LFBB2
.LM3:
.LFBB2:
	PUSH	lr
	.stabn	68,0,40,.LM4-.LFBB2
.LM4:
	MOV	r0,#1
	LSL	r0,#16
	MOV	r1,#1
...
.Lscope2:
	...
	.align	1
	.stabs	"EXIC_Configuration:F(0,15)",36,0,50,EXIC_Configuration
	.stabs	"EXICInitStruct:p(0,16)=*(1,1)",160,0,50,4
	.export	EXIC_Configuration
	.type	EXIC_Configuration, @function
EXIC_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext3
.Ltext3:
...
.LM31:
	ORL	r4,r4,r5
	.stabn	68,0,90,.LM32-.LFBB3
.LM32:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#4]
	LSL	r5,#4
	.stabn	68,0,89,.LM33-.LFBB3
.LM33:
	ORL	r4,r4,r5
	.stabn	68,0,91,.LM34-.LFBB3
.LM34:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#5]
	LSL	r5,#8
...
.LM35:
	ORL	r4,r4,r5
	.stabn	68,0,92,.LM36-.LFBB3
.LM36:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#6]
	LSL	r5,#9
	.stabn	68,0,91,.LM37-.LFBB3
.LM37:
	ORL	r4,r4,r5
	.stabn	68,0,93,.LM38-.LFBB3
.LM38:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#7]
	LSL	r5,#16
...
.LM39:
	ORL	r4,r4,r5
	.stabn	68,0,94,.LM40-.LFBB3
.LM40:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#8]
	LSL	r5,#17
	.stabn	68,0,93,.LM41-.LFBB3
.LM41:
	ORL	r4,r4,r5
...
.LM43:
	ORL	r4,r4,r5
	.stabn	68,0,96,.LM44-.LFBB3
.LM44:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#10]
	LSL	r5,#29
	.stabn	68,0,95,.LM45-.LFBB3
.LM45:
	ORL	r4,r4,r5
...
.LM46:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#11]
	.stabn	68,0,96,.LM47-.LFBB3
.LM47:
	ORL	r4,r4,r5
	.stabn	68,0,98,.LM48-.LFBB3
.LM48:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#12]
	.stabn	68,0,97,.LM49-.LFBB3
.LM49:
	ORL	r4,r4,r5
	.stabn	68,0,99,.LM50-.LFBB3
.LM50:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#13]
	.stabn	68,0,98,.LM51-.LFBB3
.LM51:
	ORL	r4,r4,r5
	.stabn	68,0,100,.LM52-.LFBB3
.LM52:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#14]
...
.LM54:
	...
	MOV	r5,r0
	ST.w	[r6],r5
	.stabn	68,0,107,.LM55-.LFBB3
.LM55:
	LD.w	r5,[sp+#1]
	LD.w	r4,[r5+#13]
	.stabn	68,0,108,.LM56-.LFBB3
.LM56:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#14]
	.stabn	68,0,107,.LM57-.LFBB3
.LM57:
	ORL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,109,.LM58-.LFBB3
.LM58:
	LD	r6,#1073752064
	LD	r5,#1073752064
	LD.w	r5,[r5+#1]
...
.Lscope3:
	...
	.align	1
	.stabs	"EXIC_Struct_Init:F(0,15)",36,0,119,EXIC_Struct_Init
	.stabs	"EXICInitStruct:p(0,16)",160,0,119,0
	.export	EXIC_Struct_Init
	.type	EXIC_Struct_Init, @function
EXIC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,120,.LM60-.LFBB4
.LM60:
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,122,.LM61-.LFBB4
.LM61:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,124,.LM62-.LFBB4
.LM62:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,126,.LM63-.LFBB4
.LM63:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,128,.LM64-.LFBB4
.LM64:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,130,.LM65-.LFBB4
.LM65:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#4],r4
	.stabn	68,0,132,.LM66-.LFBB4
.LM66:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#5],r4
	.stabn	68,0,134,.LM67-.LFBB4
.LM67:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#6],r4
	.stabn	68,0,136,.LM68-.LFBB4
.LM68:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#7],r4
	.stabn	68,0,138,.LM69-.LFBB4
.LM69:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#8],r4
	.stabn	68,0,140,.LM70-.LFBB4
.LM70:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#9],r4
	.stabn	68,0,142,.LM71-.LFBB4
.LM71:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#10],r4
	.stabn	68,0,144,.LM72-.LFBB4
.LM72:
	LD.w	r4,[sp]
	MOV	r5,#1
	LSL	r5,#30
	ST.w	[r4+#11],r5
	.stabn	68,0,146,.LM73-.LFBB4
.LM73:
	LD.w	r4,[sp]
	MOV	r5,#1
	LSL	r5,#31
	ST.w	[r4+#12],r5
	.stabn	68,0,148,.LM74-.LFBB4
.LM74:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#13],r4
	.stabn	68,0,150,.LM75-.LFBB4
.LM75:
	LD.w	r5,[sp]
	MOV	r4,#64
	ST.w	[r5+#14],r4
	.stabn	68,0,151,.LM76-.LFBB4
.LM76:
	ADD	sp,#4
	JMP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"EXIC_Get_Write_Finish_INT_Flag:F(2,4)",36,0,158,EXIC_Get_Write_Finish_INT_Flag
	.export	EXIC_Get_Write_Finish_INT_Flag
	.type	EXIC_Get_Write_Finish_INT_Flag, @function
EXIC_Get_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,159,.LM77-.LFBB5
.LM77:
.LFBB5:
	.stabn	68,0,161,.LM78-.LFBB5
.LM78:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r5,#1
	...
	CMP	r5,#0
	JZ	.L52
	.stabn	68,0,164,.LM79-.LFBB5
.LM79:
	MOV	r5,#1
	JMP	.L53
.L52:
	.stabn	68,0,169,.LM80-.LFBB5
.LM80:
	MOV	r5,#0
.L53:
	.stabn	68,0,171,.LM81-.LFBB5
.LM81:
	MOV	r0,r5
	JMP	lr
...
.Lscope5:
	...
	.align	1
	.stabs	"EXIC_Clear_Write_Finish_INT_Flag:F(0,15)",36,0,177,EXIC_Clear_Write_Finish_INT_Flag
	.export	EXIC_Clear_Write_Finish_INT_Flag
	.type	EXIC_Clear_Write_Finish_INT_Flag, @function
EXIC_Clear_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,178,.LM82-.LFBB6
.LM82:
.LFBB6:
	.stabn	68,0,180,.LM83-.LFBB6
.LM83:
	JMP	.L55
.L56:
	.stabn	68,0,182,.LM84-.LFBB6
.LM84:
	LD	r5,#1073752064
	LD	r4,#1073752064
	LD.w	r4,[r4+#2]
...
.Lscope6:
	...
	.align	1
	.stabs	"EXIC_Get_Read_Finish_INT_Flag:F(2,4)",36,0,191,EXIC_Get_Read_Finish_INT_Flag
	.export	EXIC_Get_Read_Finish_INT_Flag
	.type	EXIC_Get_Read_Finish_INT_Flag, @function
EXIC_Get_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,192,.LM87-.LFBB7
.LM87:
.LFBB7:
	.stabn	68,0,194,.LM88-.LFBB7
.LM88:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r5,#2
	...
	CMP	r5,#0
	JZ	.L58
	.stabn	68,0,197,.LM89-.LFBB7
.LM89:
	MOV	r5,#1
	JMP	.L59
.L58:
	.stabn	68,0,202,.LM90-.LFBB7
.LM90:
	MOV	r5,#0
.L59:
	.stabn	68,0,204,.LM91-.LFBB7
.LM91:
	MOV	r0,r5
	JMP	lr
...
.Lscope7:
	...
	.align	1
	.stabs	"EXIC_Clear_Read_Finish_INT_Flag:F(0,15)",36,0,210,EXIC_Clear_Read_Finish_INT_Flag
	.export	EXIC_Clear_Read_Finish_INT_Flag
	.type	EXIC_Clear_Read_Finish_INT_Flag, @function
EXIC_Clear_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,211,.LM92-.LFBB8
.LM92:
.LFBB8:
	.stabn	68,0,213,.LM93-.LFBB8
.LM93:
	JMP	.L61
.L62:
	.stabn	68,0,215,.LM94-.LFBB8
.LM94:
	LD	r5,#1073752064
	LD	r4,#1073752064
	LD.w	r4,[r4+#2]
...
.Lscope8:
	...
	.align	1
	.stabs	"EXIC_Write_Buff:F(0,15)",36,0,224,EXIC_Write_Buff
	.stabs	"DATA:p(3,6)",160,0,224,0
	.export	EXIC_Write_Buff
	.type	EXIC_Write_Buff, @function
EXIC_Write_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,225,.LM97-.LFBB9
.LM97:
.LFBB9:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,226,.LM98-.LFBB9
.LM98:
	LD	r5,#1073752064
	LD.w	r4,[sp]
	ST.w	[r5+#4],r4
	.stabn	68,0,227,.LM99-.LFBB9
.LM99:
	ADD	sp,#4
	JMP	lr
...
.Lscope9:
	...
	.align	1
	.stabs	"EXIC_Read_Buff:F(3,6)",36,0,234,EXIC_Read_Buff
	.export	EXIC_Read_Buff
	.type	EXIC_Read_Buff, @function
EXIC_Read_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,235,.LM100-.LFBB10
.LM100:
.LFBB10:
	.stabn	68,0,237,.LM101-.LFBB10
.LM101:
	LD	r5,#1073752064
	LD.w	r5,[r5+#5]
