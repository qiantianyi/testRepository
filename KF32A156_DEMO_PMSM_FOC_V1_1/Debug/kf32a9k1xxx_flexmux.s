...
.Lscope1:
	...
	.type	.text$FMUX_Reset$scode_local_2, @function
	.text$FMUX_Reset$scode_loacal_2:
	.align	1
...
.Lscope2:
	...
	.type	.text$FMUX_Channel_Enable$scode_local_3, @function
	.text$FMUX_Channel_Enable$scode_loacal_3:
	.align	1
	.stabs	"FMUX_Channel_Enable:F(0,15)",36,0,36,FMUX_Channel_Enable
	.stabs	"Channel:p(3,6)",160,0,36,8
	.stabs	"NewState:p(2,2)",160,0,36,12
	.export	FMUX_Channel_Enable
	.type	FMUX_Channel_Enable, @function
FMUX_Channel_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext3
.Ltext3:
...
.LM9:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,39,.LM10-.LFBB3
.LM10:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,42,.LM11-.LFBB3
.LM11:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#3
...
.LM16:
	...
	.stabs	"tmpreg:(3,6)",128,0,38,0
	.stabs	"tmask:(3,6)",128,0,39,4
...
.Lscope3:
	...
	.type	.text$FMUX_Channel_Triggle_Source_Select$scode_local_4, @function
	.text$FMUX_Channel_Triggle_Source_Select$scode_loacal_4:
	.align	1
	.stabs	"FMUX_Channel_Triggle_Source_Select:F(0,15)",36,0,167,FMUX_Channel_Triggle_Source_Select
	.stabs	"Channel:p(3,6)",160,0,167,8
	.stabs	"Source:p(3,6)",160,0,167,12
...
.LFBB4:
	...
	ST.w	[sp+#2],r0
	ST.w	[sp+#3],r1
	.stabn	68,0,169,.LM18-.LFBB4
.LM18:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,170,.LM19-.LFBB4
.LM19:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,173,.LM20-.LFBB4
.LM20:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#3
...
.LM25:
	...
	.stabs	"tmpreg:(3,6)",128,0,169,0
	.stabs	"tmask:(3,6)",128,0,170,4
...
.Lscope4:
	...
	.type	.text$FMUX_Enable$scode_local_5, @function
	.text$FMUX_Enable$scode_loacal_5:
	.align	1
	.stabs	"FMUX_Enable:F(0,15)",36,0,189,FMUX_Enable
	.stabs	"NewState:p(2,2)",160,0,189,0
	.export	FMUX_Enable
	.type	FMUX_Enable, @function
FMUX_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,190,.LM26-.LFBB5
.LM26:
.LFBB5:
	PUSH	{r6, lr}
	SUB	sp,#4
...
.Lscope5:
	...
	.type	.text$FMUX_Output_Channel_DMA_Enable$scode_local_6, @function
	.text$FMUX_Output_Channel_DMA_Enable$scode_loacal_6:
	.align	1
	.stabs	"FMUX_Output_Channel_DMA_Enable:F(0,15)",36,0,207,FMUX_Output_Channel_DMA_Enable
	.stabs	"Channel:p(3,6)",160,0,207,8
	.stabs	"NewState:p(2,2)",160,0,207,12
...
.LFBB6:
	...
	ST.w	[sp+#2],r0
	ST.w	[sp+#3],r1
	.stabn	68,0,209,.LM31-.LFBB6
.LM31:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,210,.LM32-.LFBB6
.LM32:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,213,.LM33-.LFBB6
.LM33:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#3
...
.LM38:
	...
	.stabs	"tmpreg:(3,6)",128,0,209,0
	.stabs	"tmask:(3,6)",128,0,210,4
...
.Lscope6:
	...
	.type	.text$FMUX_Triggle_Single_Maintain_Time_Select$scode_local_7, @function
	.text$FMUX_Triggle_Single_Maintain_Time_Select$scode_loacal_7:
	.align	1
	.stabs	"FMUX_Triggle_Single_Maintain_Time_Select:F(0,15)",36,0,233,FMUX_Triggle_Single_Maintain_Time_Select
	.stabs	"Channel:p(3,6)",160,0,233,8
	.stabs	"DIV:p(3,6)",160,0,233,12
...
.LFBB7:
	...
	ST.w	[sp+#2],r0
	ST.w	[sp+#3],r1
	.stabn	68,0,235,.LM40-.LFBB7
.LM40:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,236,.LM41-.LFBB7
.LM41:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,239,.LM42-.LFBB7
.LM42:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#3
...
.LM47:
	...
	.stabs	"tmpreg:(3,6)",128,0,235,0
	.stabs	"tmask:(3,6)",128,0,236,4
...
.Lscope7:
	...
	.type	.text$FMUX_Output_Select$scode_local_8, @function
	.text$FMUX_Output_Select$scode_loacal_8:
	.align	1
	.stabs	"FMUX_Output_Select:F(0,15)",36,0,259,FMUX_Output_Select
	.stabs	"Channel:p(3,6)",160,0,259,8
	.stabs	"MODE:p(3,6)",160,0,259,12
	.export	FMUX_Output_Select
	.type	FMUX_Output_Select, @function
FMUX_Output_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,260,.LM48-.LFBB8
.LM48:
.LFBB8:
	PUSH	{r6, lr}
	SUB	sp,#16
	ST.w	[sp+#2],r0
	ST.w	[sp+#3],r1
	.stabn	68,0,261,.LM49-.LFBB8
.LM49:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,262,.LM50-.LFBB8
.LM50:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,265,.LM51-.LFBB8
.LM51:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#3
...
.Lscope8:
	...
	.type	.text$FMUX_Work_CLK_Select$scode_local_9, @function
	.text$FMUX_Work_CLK_Select$scode_loacal_9:
	.align	1
	.stabs	"FMUX_Work_CLK_Select:F(0,15)",36,0,280,FMUX_Work_CLK_Select
	.stabs	"CLK:p(3,6)",160,0,280,0
...
.Ltext9:
	.stabn	68,0,281,.LM57-.LFBB9
.LM57:
.LFBB9:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,283,.LM58-.LFBB9
.LM58:
	MOV	r5,#1
	LD.w	r4,[sp]
	CMP	r4,#3
