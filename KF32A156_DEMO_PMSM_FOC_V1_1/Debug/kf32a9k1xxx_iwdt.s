...
IWDT_Prescaler_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext2
.Ltext2:
...
.Lscope2:
	...
	.type	.text$IWDT_SCK_Source_Select$scode_local_3, @function
	.text$IWDT_SCK_Source_Select$scode_loacal_3:
	.align	1
	.stabs	"IWDT_SCK_Source_Select:F(0,15)",36,0,57,IWDT_SCK_Source_Select
	.stabs	"Source:p(3,6)",160,0,57,0
...
.Lscope3:
	...
	.type	.text$IWDT_Overflow_Config$scode_local_4, @function
	.text$IWDT_Overflow_Config$scode_loacal_4:
	.align	1
	.stabs	"IWDT_Overflow_Config:F(0,15)",36,0,71,IWDT_Overflow_Config
	.stabs	"Overflow:p(3,6)",160,0,71,4
...
.Ltext4:
	.stabn	68,0,72,.LM11-.LFBB4
.LM11:
.LFBB4:
	PUSH	{r6, lr}
	SUB	sp,#8
	ST.w	[sp+#1],r0
	.stabn	68,0,73,.LM12-.LFBB4
.LM12:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,76,.LM13-.LFBB4
.LM13:
	MOV	r5,#1
	LD.w	r3,[sp+#1]
	LD	r4,#4095
...
.Lscope4:
	...
	.type	.text$IWDT_Enable$scode_local_5, @function
	.text$IWDT_Enable$scode_loacal_5:
	.align	1
	.stabs	"IWDT_Enable:F(0,15)",36,0,89,IWDT_Enable
	.stabs	"NewState:p(2,2)",160,0,89,0
	.export	IWDT_Enable
	.type	IWDT_Enable, @function
IWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext5
.Ltext5:
...
.Lscope5:
	...
	.type	.text$IWDT_Feed_The_Dog$scode_local_6, @function
	.text$IWDT_Feed_The_Dog$scode_loacal_6:
	.align	1
...
.LM23:
.LFBB6:
	.stabn	68,0,115,.LM24-.LFBB6
.LM24:
	LD	r5,#1073746432
	LD	r4,#1437226410
	ST.w	[r5+#1],r4
	.stabn	68,0,116,.LM25-.LFBB6
.LM25:
	JMP	lr
