	...
	.stabs	"../src/kf32a9k1xxx_pclk.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_pclk.h",130,0,0,0
...
PCLK_CTL0_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_pclk.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.align	1
	.stabs	"PCLK_CTL1_Peripheral_Clock_Enable:F(0,15)",36,0,81,PCLK_CTL1_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL1_bit:p(3,6)",160,0,81,0
	.stabs	"NewState:p(2,2)",160,0,82,4
	.export	PCLK_CTL1_Peripheral_Clock_Enable
	.type	PCLK_CTL1_Peripheral_Clock_Enable, @function
PCLK_CTL1_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_pclk.c",132,0,0,.Ltext2
.Ltext2:
...
.Lscope2:
	...
	.align	1
	.stabs	"PCLK_CTL2_Peripheral_Clock_Enable:F(0,15)",36,0,122,PCLK_CTL2_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL2_bit:p(3,6)",160,0,122,0
	.stabs	"NewState:p(2,2)",160,0,123,4
	.export	PCLK_CTL2_Peripheral_Clock_Enable
	.type	PCLK_CTL2_Peripheral_Clock_Enable, @function
PCLK_CTL2_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_pclk.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,124,.LM14-.LFBB3
.LM14:
.LFBB3:
	PUSH	lr
	SUB	sp,#8
...
.L22:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,129,.LM17-.LFBB3
.LM17:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L23
	.stabn	68,0,131,.LM18-.LFBB3
.LM18:
	LD	r5,#1073751616
	LD	r4,#1073751616
	LD.w	r3,[r4+#2]
...
.Lscope3:
	...
	.align	1
	.stabs	"PCLK_CTL3_Peripheral_Clock_Enable:F(0,15)",36,0,171,PCLK_CTL3_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL3_bit:p(3,6)",160,0,171,0
	.stabs	"NewState:p(2,2)",160,0,172,4
	.export	PCLK_CTL3_Peripheral_Clock_Enable
	.type	PCLK_CTL3_Peripheral_Clock_Enable, @function
PCLK_CTL3_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_pclk.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,173,.LM21-.LFBB4
.LM21:
.LFBB4:
	PUSH	lr
	SUB	sp,#8
