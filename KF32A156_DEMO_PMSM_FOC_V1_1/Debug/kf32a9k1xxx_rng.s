...
.Lscope1:
	...
	.type	.text$RNG_Reset$scode_local_2, @function
	.text$RNG_Reset$scode_loacal_2:
	.align	1
...
.Lscope2:
	...
	.type	.text$RNG_Real_RNG_Mode_Enable$scode_local_3, @function
	.text$RNG_Real_RNG_Mode_Enable$scode_loacal_3:
	.align	1
	.stabs	"RNG_Real_RNG_Mode_Enable:F(0,15)",36,0,32,RNG_Real_RNG_Mode_Enable
	.stabs	"NewState:p(2,2)",160,0,32,0
	.export	RNG_Real_RNG_Mode_Enable
	.type	RNG_Real_RNG_Mode_Enable, @function
RNG_Real_RNG_Mode_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rng.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,33,.LM8-.LFBB3
.LM8:
.LFBB3:
	PUSH	{r6, lr}
	SUB	sp,#4
...
.Lscope3:
	...
	.type	.text$RNG_Real_RNG_Seed_Correct_Enable$scode_local_4, @function
	.text$RNG_Real_RNG_Seed_Correct_Enable$scode_loacal_4:
	.align	1
	.stabs	"RNG_Real_RNG_Seed_Correct_Enable:F(0,15)",36,0,47,RNG_Real_RNG_Seed_Correct_Enable
	.stabs	"NewState:p(2,2)",160,0,47,0
...
.Lscope4:
	...
	.type	.text$RNG_Real_RNG_Seed_High_Pow_Enable$scode_local_5, @function
	.text$RNG_Real_RNG_Seed_High_Pow_Enable$scode_loacal_5:
	.align	1
	.stabs	"RNG_Real_RNG_Seed_High_Pow_Enable:F(0,15)",36,0,62,RNG_Real_RNG_Seed_High_Pow_Enable
	.stabs	"NewState:p(2,2)",160,0,62,0
...
.Ltext5:
	.stabn	68,0,63,.LM16-.LFBB5
.LM16:
.LFBB5:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,65,.LM17-.LFBB5
.LM17:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L13
...
.Lscope5:
	...
	.type	.text$RNG_Real_RNG_Seed_Frequency_Cail_Select$scode_local_6, @function
	.text$RNG_Real_RNG_Seed_Frequency_Cail_Select$scode_loacal_6:
	.align	1
	.stabs	"RNG_Real_RNG_Seed_Frequency_Cail_Select:F(0,15)",36,0,79,RNG_Real_RNG_Seed_Frequency_Cail_Select
	.stabs	"Select:p(3,6)",160,0,79,0
...
RNG_Real_RNG_Seed_Frequency_Cail_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rng.c",132,0,0,.Ltext6
.Ltext6:
...
.Lscope6:
	...
	.type	.text$RNG_Real_RNG_Seed_Output_Enable$scode_local_7, @function
	.text$RNG_Real_RNG_Seed_Output_Enable$scode_loacal_7:
	.align	1
	.stabs	"RNG_Real_RNG_Seed_Output_Enable:F(0,15)",36,0,94,RNG_Real_RNG_Seed_Output_Enable
	.stabs	"NewState:p(2,2)",160,0,94,0
...
.Ltext7:
	.stabn	68,0,95,.LM24-.LFBB7
.LM24:
.LFBB7:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,97,.LM25-.LFBB7
.LM25:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L19
...
.Lscope7:
	...
	.type	.text$RNG_Real_RNG_Seed_Generator_Enable$scode_local_8, @function
	.text$RNG_Real_RNG_Seed_Generator_Enable$scode_loacal_8:
	.align	1
	.stabs	"RNG_Real_RNG_Seed_Generator_Enable:F(0,15)",36,0,109,RNG_Real_RNG_Seed_Generator_Enable
	.stabs	"NewState:p(2,2)",160,0,109,0
...
.Ltext8:
	.stabn	68,0,110,.LM28-.LFBB8
.LM28:
.LFBB8:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,112,.LM29-.LFBB8
.LM29:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L23
...
.Lscope8:
	...
	.type	.text$RNG_CLK_DIV_Select$scode_local_9, @function
	.text$RNG_CLK_DIV_Select$scode_loacal_9:
	.align	1
	.stabs	"RNG_CLK_DIV_Select:F(0,15)",36,0,138,RNG_CLK_DIV_Select
	.stabs	"DIV:p(3,6)",160,0,138,0
	.export	RNG_CLK_DIV_Select
	.type	RNG_CLK_DIV_Select, @function
RNG_CLK_DIV_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rng.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,139,.LM32-.LFBB9
.LM32:
.LFBB9:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,141,.LM33-.LFBB9
.LM33:
	MOV	r5,#1
	LD.w	r4,[sp]
	CMP	r4,#15
...
.Lscope9:
	...
	.type	.text$RNG_Work_CLK_Select$scode_local_10, @function
	.text$RNG_Work_CLK_Select$scode_loacal_10:
	.align	1
	.stabs	"RNG_Work_CLK_Select:F(0,15)",36,0,155,RNG_Work_CLK_Select
	.stabs	"CLK:p(3,6)",160,0,155,0
...
.Ltext10:
	.stabn	68,0,156,.LM36-.LFBB10
.LM36:
.LFBB10:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,158,.LM37-.LFBB10
.LM37:
	MOV	r5,#1
	LD.w	r4,[sp]
	CMP	r4,#3
...
.Lscope10:
	...
	.type	.text$RNG_Seed_Select$scode_local_11, @function
	.text$RNG_Seed_Select$scode_loacal_11:
	.align	1
	.stabs	"RNG_Seed_Select:F(0,15)",36,0,170,RNG_Seed_Select
	.stabs	"Seed:p(3,6)",160,0,170,0
...
.Ltext11:
	.stabn	68,0,171,.LM40-.LFBB11
.LM40:
.LFBB11:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,173,.LM41-.LFBB11
.LM41:
	MOV	r5,#1
	LD.w	r4,[sp]
	CMP	r4,#1
...
.Lscope11:
	...
	.type	.text$RNG_Enable$scode_local_12, @function
	.text$RNG_Enable$scode_loacal_12:
	.align	1
	.stabs	"RNG_Enable:F(0,15)",36,0,185,RNG_Enable
	.stabs	"NewState:p(2,2)",160,0,185,0
	.export	RNG_Enable
	.type	RNG_Enable, @function
RNG_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rng.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,186,.LM44-.LFBB12
.LM44:
.LFBB12:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,188,.LM45-.LFBB12
.LM45:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L33
...
.Lscope12:
	...
	.type	.text$RNG_Get_Current_Error_Status$scode_local_13, @function
	.text$RNG_Get_Current_Error_Status$scode_loacal_13:
	.align	1
...
.Ltext13:
	.stabn	68,0,202,.LM48-.LFBB13
.LM48:
.LFBB13:
	.stabn	68,0,203,.LM49-.LFBB13
.LM49:
	LD	r5,#1073753984
	LD.w	r4,[r5+#1]
	MOV	r5,#1
...
.Lscope13:
	...
	.type	.text$RNG_INT_Enable$scode_local_14, @function
	.text$RNG_INT_Enable$scode_loacal_14:
	.align	1
	.stabs	"RNG_INT_Enable:F(0,15)",36,0,215,RNG_INT_Enable
	.stabs	"Select:p(3,6)",160,0,215,8
	.stabs	"NewState:p(2,2)",160,0,215,12
...
.LFBB14:
	...
	ST.w	[sp+#2],r0
	ST.w	[sp+#3],r1
	.stabn	68,0,217,.LM52-.LFBB14
.LM52:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,218,.LM53-.LFBB14
.LM53:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,221,.LM54-.LFBB14
.LM54:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#2
...
.LM59:
	...
	.stabs	"tmpreg:(3,6)",128,0,217,0
	.stabs	"tmask:(3,6)",128,0,218,4
...
.Lscope14:
	...
	.type	.text$RNG_Clear_INT_Flag$scode_local_15, @function
	.text$RNG_Clear_INT_Flag$scode_loacal_15:
	.align	1
	.stabs	"RNG_Clear_INT_Flag:F(0,15)",36,0,236,RNG_Clear_INT_Flag
	.stabs	"Select:p(3,6)",160,0,236,8
	.export	RNG_Clear_INT_Flag
	.type	RNG_Clear_INT_Flag, @function
RNG_Clear_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rng.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,237,.LM60-.LFBB15
.LM60:
.LFBB15:
	PUSH	{r6, lr}
	SUB	sp,#12
	ST.w	[sp+#2],r0
	.stabn	68,0,238,.LM61-.LFBB15
.LM61:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,239,.LM62-.LFBB15
.LM62:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,242,.LM63-.LFBB15
.LM63:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#2
...
.LM69:
	...
	.stabs	"tmpreg:(3,6)",128,0,238,0
	.stabs	"tmask:(3,6)",128,0,239,4
...
.Lscope15:
	...
	.type	.text$RNG_Get_INT_Flag$scode_local_16, @function
	.text$RNG_Get_INT_Flag$scode_loacal_16:
	.align	1
	.stabs	"RNG_Get_INT_Flag:F(2,4)",36,0,259,RNG_Get_INT_Flag
	.stabs	"Select:p(3,6)",160,0,259,8
...
.Ltext16:
	.stabn	68,0,260,.LM70-.LFBB16
.LM70:
.LFBB16:
	PUSH	lr
	SUB	sp,#12
	ST.w	[sp+#2],r0
	.stabn	68,0,261,.LM71-.LFBB16
.LM71:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,262,.LM72-.LFBB16
.LM72:
	MOV	r5,#0
	ST.w	[sp+#1],r5
	.stabn	68,0,265,.LM73-.LFBB16
.LM73:
	MOV	r5,#1
	LD.w	r4,[sp+#2]
	CMP	r4,#2
...
.L47:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,267,.LM74-.LFBB16
.LM74:
	LD.w	r4,[sp+#2]
	MOV	r5,#1
	LSL	r5,r5,r4
	ST.w	[sp+#1],r5
	.stabn	68,0,268,.LM75-.LFBB16
.LM75:
	LD	r5,#1073753984
	LD.w	r4,[r5+#1]
	LD.w	r5,[sp+#1]
...
.Lscope16:
	...
	.type	.text$RNG_Seed_Value$scode_local_17, @function
	.text$RNG_Seed_Value$scode_loacal_17:
	.align	1
...
.Ltext17:
	.stabn	68,0,277,.LM77-.LFBB17
.LM77:
.LFBB17:
	.stabn	68,0,278,.LM78-.LFBB17
.LM78:
	LD	r5,#1073753984
	LD.w	r5,[r5+#2]
	ZXT.h	r5,r5
	.stabn	68,0,279,.LM79-.LFBB17
.LM79:
	MOV	r0,r5
	JMP	lr
...
.Lscope17:
	...
	.type	.text$RNG_Data_Value$scode_local_18, @function
	.text$RNG_Data_Value$scode_loacal_18:
	.align	1
...
RNG_Data_Value:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rng.c",132,0,0,.Ltext18
.Ltext18:
	.stabn	68,0,287,.LM80-.LFBB18
.LM80:
.LFBB18:
	.stabn	68,0,288,.LM81-.LFBB18
.LM81:
	LD	r5,#1073753984
	LD.w	r5,[r5+#3]
	.stabn	68,0,289,.LM82-.LFBB18
.LM82:
	MOV	r0,r5
	JMP	lr
