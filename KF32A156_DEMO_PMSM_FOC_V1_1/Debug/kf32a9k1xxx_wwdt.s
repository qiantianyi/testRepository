...
WWDT_Threshold_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext3
.Ltext3:
...
.Ltext4:
	.stabn	68,0,82,.LM14-.LFBB4
.LM14:
.LFBB4:
	PUSH	{r6, lr}
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,84,.LM15-.LFBB4
.LM15:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L7
...
.Lscope4:
	...
	.type	.text$WWDT_Work_CLK_Selest$scode_local_5, @function
	.text$WWDT_Work_CLK_Selest$scode_loacal_5:
	.align	1
	.stabs	"WWDT_Work_CLK_Selest:F(0,15)",36,0,100,WWDT_Work_CLK_Selest
	.stabs	"Source:p(3,6)",160,0,100,0
...
.Lscope5:
	...
	.type	.text$WWDT_Enable$scode_local_6, @function
	.text$WWDT_Enable$scode_loacal_6:
	.align	1
	.stabs	"WWDT_Enable:F(0,15)",36,0,114,WWDT_Enable
	.stabs	"NewState:p(2,2)",160,0,114,0
	.export	WWDT_Enable
	.type	WWDT_Enable, @function
WWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,115,.LM22-.LFBB6
.LM22:
.LFBB6:
	PUSH	lr
	SUB	sp,#4
...
.Lscope6:
	...
	.type	.text$WWDT_Counter_Config$scode_local_7, @function
	.text$WWDT_Counter_Config$scode_loacal_7:
	.align	1
	.stabs	"WWDT_Counter_Config:F(0,15)",36,0,138,WWDT_Counter_Config
	.stabs	"Counter:p(3,6)",160,0,138,0
...
.Ltext7:
	.stabn	68,0,139,.LM28-.LFBB7
.LM28:
.LFBB7:
	PUSH	lr
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,141,.LM29-.LFBB7
.LM29:
	MOV	r5,#1
	LD.w	r4,[sp]
	CMP	r4,#63
...
.L19:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,144,.LM30-.LFBB7
.LM30:
	LD	r5,#1073746560
	LD.w	r4,[sp]
	ST.w	[r5+#1],r4
	.stabn	68,0,145,.LM31-.LFBB7
.LM31:
	ADD	sp,#4
	POP	lr
	JMP	lr
...
.Lscope7:
	...
	.type	.text$WWDT_Get_Counter$scode_local_8, @function
	.text$WWDT_Get_Counter$scode_loacal_8:
	.align	1
...
.Ltext8:
	.stabn	68,0,154,.LM32-.LFBB8
.LM32:
.LFBB8:
	SUB	sp,#4
	.stabn	68,0,155,.LM33-.LFBB8
.LM33:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,158,.LM34-.LFBB8
.LM34:
	LD	r5,#1073746560
	LD.w	r4,[r5+#1]
	MOV	r5,#127
...
.Lscope8:
	...
	.type	.text$WWDT_INT_Enable$scode_local_9, @function
	.text$WWDT_INT_Enable$scode_loacal_9:
	.align	1
	.stabs	"WWDT_INT_Enable:F(0,15)",36,0,177,WWDT_INT_Enable
	.stabs	"NewState:p(2,2)",160,0,177,0
	.export	WWDT_INT_Enable
	.type	WWDT_INT_Enable, @function
WWDT_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,178,.LM37-.LFBB9
.LM37:
.LFBB9:
	PUSH	lr
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,180,.LM38-.LFBB9
.LM38:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L23
...
.L25:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,183,.LM39-.LFBB9
.LM39:
	LD.w	r5,[sp]
	CMP	r5,#0
	JZ	.L26
	.stabn	68,0,186,.LM40-.LFBB9
.LM40:
	LD	r5,#1073746560
// inline asm begin
...
.Lscope9:
	...
	.type	.text$WWDT_Get_INT_Flag$scode_local_10, @function
	.text$WWDT_Get_INT_Flag$scode_loacal_10:
	.align	1
...
.Ltext10:
	.stabn	68,0,202,.LM43-.LFBB10
.LM43:
.LFBB10:
	.stabn	68,0,204,.LM44-.LFBB10
.LM44:
	LD	r5,#1073746560
	LD.w	r4,[r5]
	MOV	r5,#4
	...
	CMP	r5,#0
	JZ	.L29
	.stabn	68,0,207,.LM45-.LFBB10
.LM45:
	MOV	r5,#1
	JMP	.L30
.L29:
	.stabn	68,0,212,.LM46-.LFBB10
.LM46:
	MOV	r5,#0
.L30:
	.stabn	68,0,214,.LM47-.LFBB10
.LM47:
	MOV	r0,r5
	JMP	lr
...
.Lscope10:
	...
	.type	.text$WWDT_Clear_INT_Flag$scode_local_11, @function
	.text$WWDT_Clear_INT_Flag$scode_loacal_11:
	.align	1
...
.Ltext11:
	.stabn	68,0,223,.LM48-.LFBB11
.LM48:
.LFBB11:
	.stabn	68,0,225,.LM49-.LFBB11
.LM49:
	LD	r5,#1073746560
// inline asm begin
	// 225 "../src/kf32a9k1xxx_wwdt.c" 1
	SET [r5], #15
	.stabn	68,0,226,.LM50-.LFBB11
.LM50:
// inline asm end
	NOP
.L32:
	...
	CMP	r5,#0
	JNZ	.L32
	.stabn	68,0,227,.LM51-.LFBB11
.LM51:
	LD	r5,#1073746560
// inline asm begin
	// 227 "../src/kf32a9k1xxx_wwdt.c" 1
	CLR [r5], #15
	.stabn	68,0,228,.LM52-.LFBB11
.LM52:
// inline asm end
	JMP	lr
