...
.Ltext0:
	...
	.align	2
	.stabs	"startup:F(0,15)",36,0,19,startup
	.export	startup
...
.LM12:
	...
	CMP	r4,r5
	JHI	.L5
	.stabn	68,0,52,.LM13-.LFBB1
.LM13:
	LD	r5,#main
	LJMP	r5
	.stabn	68,0,53,.LM14-.LFBB1
.LM14:
	ADD	sp,#12
	POP	lr
	JMP	lr
	.size	startup, .-startup
	.stabs	"s:(0,16)=*(0,4)",128,0,21,0
	.stabs	"begin:(0,16)",128,0,21,4
	.stabs	"end:(0,16)",128,0,21,8
