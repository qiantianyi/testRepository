...
# 11 "../application/alarm.h"
# 1 "D:/Program Files (x86)/ChipON IDE/KungFu32/ChipONCC32/include/Sys/string.h" 1
# 17 "D:/Program Files (x86)/ChipON IDE/KungFu32/ChipONCC32/include/Sys/string.h"
...
# 35 "D:/Program Files (x86)/ChipON IDE/KungFu32/ChipONCC32/include/Sys/stddef.h"
...
# 22 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h"
...
# 10 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\application/user.h"
...
void alarm_process(void)
{
 ...
 {
  (((GPIO_SFRmap *) ((uint32_t)0x50000040))->POR &= ~((uint16_t)0x4000));
 }
 else
 {
  (((GPIO_SFRmap *) ((uint32_t)0x50000040))->POR |= ((uint16_t)0x4000));
...
void over_current_check(void)
{
    if(adc_data.Ia_pu<error_param.over_current_min||adc_data.Ia_pu>error_param.over_current_max||adc_data.Ib_pu<error_param.over_current_min||adc_data.Ib_pu>error_param.over_current_max)
    {
     ...
     if(error_param.over_current_count>(10))
     {
         pwm_disable();
...
void over_voltage_check(void)
{
 if(adc_data.Vbus_pu>error_param.over_voltage_max)
 {
  ...
  if(error_param.over_voltage_count>(2))
  {
...
void current_offset_check(void)
{
 if(Q15abs(2048-adc_data.Ia_offset)>((10)*2048/100)||Q15abs(2048-adc_data.Ib_offset)>((10)*2048/100))
 {
...
void start_error_check(void)
{
 ...
 if(control_param.current_step==2&&error_param.start_check_count<(1000))
 {
  ...
  if(error_param.start_error_count>(100))
  {
...
void phase_lost_check(void)
{
 if(control_param.current_step!=0)
 {
  ...
  if(error_param.current_integral_count<(1000))
  {
