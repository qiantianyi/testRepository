...
{
 ((USART_SFRmap *) ((uint32_t)0x40000980))->TBUFR = data;
}


static uint8_t (receiveSerialFcn)()
{
 return ((USART_SFRmap *) ((uint32_t)0x40000980))->RBUFR;
}

static uint8_t (isReceiveDataAvailableFcn)()
{
 if(((USART_SFRmap *) ((uint32_t)0x40000980))->STR & ((uint32_t)1<<((11))))
 {
  return SET;
 }
 else
...
{
 if(((USART_SFRmap *) ((uint32_t)0x40000980))->STR & ((uint32_t)1<<((13))))
 {
  return SET;
 }
 else
