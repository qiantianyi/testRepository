...
void __attribute__((section(".indata"))) DoControl( void )
{
    ...
    {
       PIParmD.qErr = ParkParm.qVdRef - ParkParm.qId;
       CalcPI(&PIParmD);
    ParkParm.qVd = PIParmD.qOut;
    Q15SQRT_VqMax((29000)*(29000)-ParkParm.qVd*ParkParm.qVd);
       PIParmQ.qErr = ParkParm.qVqRef - ParkParm.qIq;
       CalcPI(&PIParmQ);
