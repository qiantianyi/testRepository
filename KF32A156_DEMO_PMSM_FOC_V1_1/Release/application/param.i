...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\driver/driver_gpio.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\driver/driver_gpio.h" 2
...
# 8 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\driver/driver_pwm.h" 2
...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\driver/driver_timer.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\driver/driver_timer.h" 2
...
# 9 "../application/param.c" 2

volatile tSVGenParm SVGenParm;
volatile tParkParm ParkParm;
volatile tPIParm PIParmD;
volatile tPIParm PIParmQ;
volatile tPIParm PIParmW;
volatile SMC smc1;

void param_init(void)
{
 control_param.debug_start_speed = (uint32_t)((100)*(4)*(1.0/((20)*1000))*65536*65536/60.0);
 control_param.start_speed = (uint32_t)((200)*(4)*(1.0/((20)*1000))*65536*65536/60.0);
 control_param.startup_lock_time = (unsigned short)((1.0)*(1.0/(1.0/((20)*1000))));
 control_param.IRP_per_calc = (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000)));
 control_param._pi_calc = ((3.1416/(unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) < 0.0) ? (SFRAC16)(32768 * (3.1416/(unsigned short)((float)(1.0/2000)/(1.0/((20)*1000)))) - 0.5) : (SFRAC16)(32767 * (3.1416/(unsigned short)((float)(1.0/2000)/(1.0/((20)*1000)))) + 0.5));
 control_param.omega0_rad_calc = (((float)((200) * (1.0/((20)*1000)) * (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) * (4) * 2.0 / 60.0)*3.1416/(unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) < 0.0) ? (SFRAC16)(32768 * ((float)((200) * (1.0/((20)*1000)) * (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) * (4) * 2.0 / 60.0)*3.1416/(unsigned short)((float)(1.0/2000)/(1.0/((20)*1000)))) - 0.5) : (SFRAC16)(32767 * ((float)((200) * (1.0/((20)*1000)) * (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) * (4) * 2.0 / 60.0)*3.1416/(unsigned short)((float)(1.0/2000)/(1.0/((20)*1000)))) + 0.5));

    ParkParm.qIaOffset = adc_data.Ia_offset;
    ParkParm.qIbOffset = adc_data.Ib_offset;
    current_offset_check();

    error_param.over_current_max = (float)((50.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))*2048.0 + 2048.0;
    error_param.over_current_min = 2048.0 - (float)((50.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))*2048.0;
    if(error_param.over_current_max>4095||error_param.over_current_min<0)
    {
     error_state.bit.param_init_error = 1;
    }

    error_param.over_voltage_max = (float)((36.0)/((5.0)/(1180.0)*((10000.0)+(1180.0))))*4096.0;
    if(error_param.over_voltage_max>4095||error_param.over_voltage_max<0)
    {
     error_state.bit.param_init_error = 1;
    }

    error_param.start_omega_acc_max = (6000.0)*4.0/60.0*(4)*0.001*0.001*65536.0;

    error_param.stall_omega_max = (6000.0)/60.0*(4)*(float)(1.0/2000)*65536;

 SVGenParm.iPWMPeriod = ((120)*1000/(20)/2);

    control_param.motor_direction = (0);


    PIParmD.qKp = (((0.5) < 0.0) ? (SFRAC16)(32768 * ((0.5)) - 0.5) : (SFRAC16)(32767 * ((0.5)) + 0.5));
    PIParmD.qKi = (((0.02) < 0.0) ? (SFRAC16)(32768 * ((0.02)) - 0.5) : (SFRAC16)(32767 * ((0.02)) + 0.5));
    PIParmD.qOutMax = (((0.5) < 0.0) ? (SFRAC16)(32768 * ((0.5)) - 0.5) : (SFRAC16)(32767 * ((0.5)) + 0.5));
    PIParmD.qOutMin = -PIParmD.qOutMax;

    InitPI(&PIParmD);


    PIParmQ.qKp = (((0.5) < 0.0) ? (SFRAC16)(32768 * ((0.5)) - 0.5) : (SFRAC16)(32767 * ((0.5)) + 0.5));
    PIParmQ.qKi = (((0.02) < 0.0) ? (SFRAC16)(32768 * ((0.02)) - 0.5) : (SFRAC16)(32767 * ((0.02)) + 0.5));
    PIParmQ.qOutMax = (((0.5) < 0.0) ? (SFRAC16)(32768 * ((0.5)) - 0.5) : (SFRAC16)(32767 * ((0.5)) + 0.5));
    PIParmQ.qOutMin = -PIParmQ.qOutMax;

    InitPI(&PIParmQ);


    PIParmW.qKp = (((0.8) < 0.0) ? (SFRAC16)(32768 * ((0.8)) - 0.5) : (SFRAC16)(32767 * ((0.8)) + 0.5));
    PIParmW.qKi = (((0.001) < 0.0) ? (SFRAC16)(32768 * ((0.001)) - 0.5) : (SFRAC16)(32767 * ((0.001)) + 0.5));
    PIParmW.qOutMax = (((0.99) < 0.0) ? (SFRAC16)(32768 * ((0.99)) - 0.5) : (SFRAC16)(32767 * ((0.99)) + 0.5));
