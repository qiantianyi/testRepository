...
# 5 "../application/smc.c" 2


void SMCInit(SMC *s)
{
 if ((((0.1)*(1.0/((20)*1000)) < 0.0) ? (SFRAC16)(32768 * ((0.1)*(1.0/((20)*1000))) - 0.5) : (SFRAC16)(32767 * ((0.1)*(1.0/((20)*1000))) + 0.5)) > (((0.00015) < 0.0) ? (SFRAC16)(32768 * ((0.00015)) - 0.5) : (SFRAC16)(32767 * ((0.00015)) + 0.5)))
  s->Fsmopos = ((0.0 < 0.0) ? (SFRAC16)(32768 * (0.0) - 0.5) : (SFRAC16)(32767 * (0.0) + 0.5));
 else
  s->Fsmopos = ((1 - (0.1)*(1.0/((20)*1000))/(0.00015) < 0.0) ? (SFRAC16)(32768 * (1 - (0.1)*(1.0/((20)*1000))/(0.00015)) - 0.5) : (SFRAC16)(32767 * (1 - (0.1)*(1.0/((20)*1000))/(0.00015)) + 0.5));

 if ((((1.0/((20)*1000)) < 0.0) ? (SFRAC16)(32768 * ((1.0/((20)*1000))) - 0.5) : (SFRAC16)(32767 * ((1.0/((20)*1000))) + 0.5)) > (((0.00015) < 0.0) ? (SFRAC16)(32768 * ((0.00015)) - 0.5) : (SFRAC16)(32767 * ((0.00015)) + 0.5)))
  s->Gsmopos = ((0.99999 < 0.0) ? (SFRAC16)(32768 * (0.99999) - 0.5) : (SFRAC16)(32767 * (0.99999) + 0.5));
 else
  s->Gsmopos = (((1.0/((20)*1000))/(0.00015)*(24.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)) < 0.0) ? (SFRAC16)(32768 * ((1.0/((20)*1000))/(0.00015)*(24.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002))) - 0.5) : (SFRAC16)(32767 * ((1.0/((20)*1000))/(0.00015)*(24.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002))) + 0.5));

 s->Kslide = ((0.5 < 0.0) ? (SFRAC16)(32768 * (0.5) - 0.5) : (SFRAC16)(32767 * (0.5) + 0.5));
 s->MaxSMCError = ((0.5 < 0.0) ? (SFRAC16)(32768 * (0.5) - 0.5) : (SFRAC16)(32767 * (0.5) + 0.5));
 s->FiltOmCoef = (((float)((200) * (1.0/((20)*1000)) * (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) * (4) * 2.0 / 60.0) * 3.1416 / (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) < 0.0) ? (SFRAC16)(32768 * ((float)((200) * (1.0/((20)*1000)) * (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) * (4) * 2.0 / 60.0) * 3.1416 / (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000)))) - 0.5) : (SFRAC16)(32767 * ((float)((200) * (1.0/((20)*1000)) * (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000))) * (4) * 2.0 / 60.0) * 3.1416 / (unsigned short)((float)(1.0/2000)/(1.0/((20)*1000)))) + 0.5));
 s->ThetaOffset = (unsigned short)(90 / 180.0 * 32768.0);
}
