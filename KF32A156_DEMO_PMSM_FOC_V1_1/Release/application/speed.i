...
void speed_param_init(void)
{
    ...
    speed_data.speed_base = (6000);
    speed_data.speed_acc_time = (9);
    speed_data.speed_omega_coef = 1118481*(4)/2000;
    speed_data.omega_base = (speed_data.speed_base*speed_data.speed_omega_coef)>>10;
    speed_data.omega_q15_coef = 33554432/speed_data.omega_base;
    speed_data.speed_omega_q15_coef = (speed_data.speed_omega_coef*speed_data.omega_q15_coef)>>10;
    speed_data.omega_min_pu = ((1000)*speed_data.speed_omega_q15_coef)>>10;
    speed_data.omega_max_pu = ((4000)*speed_data.speed_omega_q15_coef)>>10;
    speed_data.omega_acc_pu = speed_data.omega_max_pu/(9)/1000;
...
void run_speed_init_process(void)
{
 ...
 {
     speed_data.speed_give = Q15abs((2000));
 }
 else
 {
  speed_data.speed_give = -Q15abs((2000));
