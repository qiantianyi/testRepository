...
# 4 "../application/state_machine.c" 2
...
void run_param_set_process(void)
{
 ...
 if(4==1)
 {
  ...
  {
   control_param.debug_current_ref = (int32_t)((15)*32768)/100;
  }
  else
  {
   control_param.debug_current_ref = -(int32_t)((15)*32768)/100;
 ...
 else
 {
  ...
  if(control_param.motor_direction==(0))
  {
      control_param.start_current_ref = (((((20.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002))) < 0.0) ? (SFRAC16)(32768 * (((20.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))) - 0.5) : (SFRAC16)(32767 * (((20.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))) + 0.5)));
      control_param.current_ref = (((((10.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002))) < 0.0) ? (SFRAC16)(32768 * (((10.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))) - 0.5) : (SFRAC16)(32767 * (((10.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))) + 0.5)));
  }
  else
  {
   control_param.start_current_ref = -(((((20.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002))) < 0.0) ? (SFRAC16)(32768 * (((20.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))) - 0.5) : (SFRAC16)(32767 * (((20.0)/((5.0)/2/((49900.0)/(3000.0))/(0.002)))) + 0.5)));
...
void run_open_debug_process(void)
{
 ...
 {
     if(Q15abs(ParkParm.qVqRef-ParkParm.qVq)>=(10))
  {
      ParkParm.qVq += (10);
  }
 }
...
void run_open_loop_process(void)
{
 ...
 {
  if(Q15abs(control_param.start_current_ref-ParkParm.qVqRef)>=(10))
  {
      ParkParm.qVqRef += (10);
  }
 }
...
void run_current_loop_process(void)
{
 ...
 {
  if(Q15abs(control_param.current_ref-ParkParm.qVqRef)>=(10))
  {
      ParkParm.qVqRef += (10);
  }
 }
