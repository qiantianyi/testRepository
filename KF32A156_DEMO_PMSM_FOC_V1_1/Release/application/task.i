...
# 4 "../application/task.c" 2
# 1 "../application/application_init.h" 1
# 12 "../application/application_init.h"
...
void task_process(void)
{
 ...
 if(time_count.time_1ms_count>=1)
 {
 ...
 if(time_count.time_10ms_count>=10)
 {
 ...
 if(time_count.time_100ms_count>=100)
 {
        time_count.time_100ms_count = 0;

 }

 if(time_count.time_1s_count>=1000)
 {
  time_count.time_1s_count = 0;

  (((GPIO_SFRmap *) ((uint32_t)0x50000040))->POR ^= ((uint16_t)0x2000));
 }
}

void motor_start_process(void)
{
 if((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x8000)))==(0)&&sys_control.sys_enable_flag==FALSE&&control_param.start_count>50)
 {
  control_param.start_count = 0;
  sys_control.sys_enable_flag = TRUE;
 }
 if((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x8000)))==(0)&&sys_control.sys_enable_flag==TRUE&&control_param.start_count>50)
 {
  control_param.start_count = 0;
  sys_control.sys_enable_flag = FALSE;
 }
 else if((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x8000)))==(1)&&control_param.start_count<100)
 {
