...
# 1 "../driver/system_init.h" 1
# 11 "../driver/system_init.h"
...
# 12 "../driver/system_init.h" 2
# 1 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_atim.h" 1
# 13 "../driver/system_init.h" 2
# 1 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_epwm.h" 1
# 14 "../driver/system_init.h" 2
# 1 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_gpio.h" 1
# 15 "../driver/system_init.h" 2
# 1 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_flexmux.h" 1
# 16 "../driver/system_init.h" 2
...
void cfg_ADC_GPIO(void)
{
 ...
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0040),GPIO_MODE_AN);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x2000),GPIO_MODE_AN);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0001),GPIO_MODE_AN);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x4000),GPIO_MODE_AN);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x2000),GPIO_MODE_AN);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x1000),GPIO_MODE_AN);
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0800),GPIO_MODE_AN);
...
void cfg_ADC0(void)
{
 ...
 adcStruct.m_Clock = ((uint32_t)0<<(1));

 adcStruct.m_ClockDiv = ((uint32_t)2<<(8));
 ...
 adcStruct.m_ExternalTrig = ((uint32_t)0x34<<(4));

 adcStruct.m_HPExternalTrig_EN = TRUE;

 adcStruct.m_HPExternalTrig = ((uint32_t)0x36<<(20));
 ...
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000019), 0x01);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000000), 0x02);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000000), 0x03);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x0000001D), 0x04);
...
void cfg_ADC0_IT(void)
{
 ADC_Set_INT_Enable (((ADC_SFRmap *) ((uint32_t)0x40000580)),((uint32_t)0x00060309), TRUE);
 INT_Interrupt_Priority_Config(INT_ADC0,1,0);
 INT_Clear_Interrupt_Flag(INT_ADC0);
 INT_Interrupt_Enable(INT_ADC0,TRUE);
}
...
void cfg_ADC1(void)
{
 ...
 ADC_Reset (((ADC_SFRmap *) ((uint32_t)0x40000600)));
 ADC_Struct_Init(&adcStruct);
 ...
 adcStruct.m_NumOfHPConv = 4;
 ADC_Configuration (((ADC_SFRmap *) ((uint32_t)0x40000600)), &adcStruct);

 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000600)), ((uint32_t)0x00000017), 0x01);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000600)), ((uint32_t)0x0000002B), 0x02);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000600)), ((uint32_t)0x00000023), 0x03);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000600)), ((uint32_t)0x00000017), 0x04);

 ADC_Cmd (((ADC_SFRmap *) ((uint32_t)0x40000600)), TRUE);
}
...
void cfg_ADC2(void)
{
 ...
 ADC_Reset (((ADC_SFRmap *) ((uint32_t)0x40000680)));
 ADC_Struct_Init(&adcStruct);
 ...
 adcStruct.m_NumOfHPConv = 4;
 ADC_Configuration (((ADC_SFRmap *) ((uint32_t)0x40000680)), &adcStruct);

 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000680)), ((uint32_t)0x00000029), 0x01);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000680)), ((uint32_t)0x0000002A), 0x02);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000680)), ((uint32_t)0x0000005B), 0x03);
 ADC_High_Priority_Channel_Config(((ADC_SFRmap *) ((uint32_t)0x40000680)), ((uint32_t)0x00000009), 0x04);

 ADC_Cmd (((ADC_SFRmap *) ((uint32_t)0x40000680)), TRUE);
}
...
{
 adc_buf[0] = ((ADC_SFRmap *) ((uint32_t)0x40000580))->HPDATA0;
 adc_buf[1] = ((ADC_SFRmap *) ((uint32_t)0x40000580))->HPDATA1;
 adc_buf[2] = ((ADC_SFRmap *) ((uint32_t)0x40000580))->HPDATA2;
 adc_buf[3] = ((ADC_SFRmap *) ((uint32_t)0x40000580))->HPDATA3;
    adc_buf[4] = ((ADC_SFRmap *) ((uint32_t)0x40000600))->HPDATA0;
 adc_buf[5] = ((ADC_SFRmap *) ((uint32_t)0x40000600))->HPDATA1;
 adc_buf[6] = ((ADC_SFRmap *) ((uint32_t)0x40000600))->HPDATA2;
 adc_buf[7] = ((ADC_SFRmap *) ((uint32_t)0x40000600))->HPDATA3;
    adc_buf[8] = ((ADC_SFRmap *) ((uint32_t)0x40000680))->HPDATA0;
 adc_buf[9] = ((ADC_SFRmap *) ((uint32_t)0x40000680))->HPDATA1;
 adc_buf[10] = ((ADC_SFRmap *) ((uint32_t)0x40000680))->HPDATA2;
...
void adc_offset_calc(void)
{
 ...
 for(i=0;i<1025;i++)
 {
  (((ADC_SFRmap *) ((uint32_t)0x40000580))->CTL1 |= ((uint32_t)1<<((3))));
  (((ADC_SFRmap *) ((uint32_t)0x40000600))->CTL1 |= ((uint32_t)1<<((3))));
  (((ADC_SFRmap *) ((uint32_t)0x40000680))->CTL1 |= ((uint32_t)1<<((3))));
  while(!(((((ADC_SFRmap *) ((uint32_t)0x40000580))->STATE&((uint32_t)1<<((3))))!=0)&&((((ADC_SFRmap *) ((uint32_t)0x40000600))->STATE&((uint32_t)1<<((3))))!=0)&&((((ADC_SFRmap *) ((uint32_t)0x40000680))->STATE&((uint32_t)1<<((3))))!=0)));
  (((ADC_SFRmap *) ((uint32_t)0x40000580))->STATE|=((uint32_t)1<<((6))));
  (((ADC_SFRmap *) ((uint32_t)0x40000600))->STATE|=((uint32_t)1<<((6))));
  (((ADC_SFRmap *) ((uint32_t)0x40000680))->STATE|=((uint32_t)1<<((6))));
  (((ADC_SFRmap *) ((uint32_t)0x40000580))->STATE &= ~((uint32_t)1<<((6))));
  (((ADC_SFRmap *) ((uint32_t)0x40000600))->STATE &= ~((uint32_t)1<<((6))));
  (((ADC_SFRmap *) ((uint32_t)0x40000680))->STATE &= ~((uint32_t)1<<((6))));
  adc_buf[0] = ((ADC_SFRmap *) ((uint32_t)0x40000580))->HPDATA0;
