...
# 4 "../driver/driver_flex.c" 2


void cfg_FLEXMUX(void)
{
 FMUX_Reset();
# 17 "../driver/driver_flex.c"
 FMUX_Work_CLK_Select(((uint32_t)1));

 FMUX_Channel_Enable(((uint32_t)0),TRUE);

 FMUX_Channel_Triggle_Source_Select(((uint32_t)0),((uint32_t)5));
 FMUX_Output_Select(((uint32_t)0),((uint32_t)1));
# 34 "../driver/driver_flex.c"
 FMUX_Enable(TRUE);
