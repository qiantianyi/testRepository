...
{
 (((BTIM_SFRmap *)((uint32_t)0x40001800))->SRIC |= ((uint32_t)1<<((2))));
 (((BTIM_SFRmap *)((uint32_t)0x40001800))->SRIC &= ~((uint32_t)1<<((2))));
...
{
 volatile uint8_t sample_error_flag = 0;
 (((GPIO_SFRmap *) ((uint32_t)0x50000040))->POR &= ~((uint16_t)0x8000));

 if(((((ADC_SFRmap *) ((uint32_t)0x40000580))->STATE&((uint32_t)1<<((3))))!=0))
 {
 ...
 if(((((ADC_SFRmap *) ((uint32_t)0x40000600))->STATE&((uint32_t)1<<((3))))!=0))
 {
 ...
 if(((((ADC_SFRmap *) ((uint32_t)0x40000680))->STATE&((uint32_t)1<<((3))))!=0))
 {
