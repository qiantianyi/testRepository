...
# 19 "../driver/driver_dma.c" 2


volatile uint32_t dma_adc_buf[3] = {0};
...
void cfg_DMA0(void)
{
 ...
 DMA_Reset (((DMA_SFRmap *) ((uint32_t)0x40001600)));



 dmaNewStruct.m_Number = 3;

 dmaNewStruct.m_Direction = ((uint32_t)0<<(4));

 dmaNewStruct.m_Priority = ((uint32_t)0<<(13));

 dmaNewStruct.m_PeripheralDataSize = ((uint32_t)2);

 dmaNewStruct.m_MemoryDataSize = ((uint32_t)2);

 dmaNewStruct.m_PeripheralInc = FALSE;

 dmaNewStruct.m_MemoryInc = TRUE;

 dmaNewStruct.m_Channel = ((uint32_t)2);

 dmaNewStruct.m_BlockMode = ((uint32_t)0<<(3));

 dmaNewStruct.m_LoopMode = TRUE;

 dmaNewStruct.m_PeriphAddr = (uint32_t) &(((ADC_SFRmap *) ((uint32_t)0x40000580))->DATA);


 dmaNewStruct.m_MemoryAddr = (uint32_t) dma_adc_buf;

 DMA_Configuration (((DMA_SFRmap *) ((uint32_t)0x40001600)), &dmaNewStruct);

 DMA_Channel_Enable (((DMA_SFRmap *) ((uint32_t)0x40001600)), ((uint32_t)2), TRUE);
}
...
{
 DMA_Set_INT_Enable(((DMA_SFRmap *) ((uint32_t)0x40001600)), ((uint32_t)2), ((uint32_t)2),TRUE);
 DMA_Clear_INT_Flag(((DMA_SFRmap *) ((uint32_t)0x40001600)), ((uint32_t)2), ((uint32_t)2));

 DMA_Set_INT_Enable(((DMA_SFRmap *) ((uint32_t)0x40001600)), ((uint32_t)2), ((uint32_t)1),TRUE);
 DMA_Clear_INT_Flag(((DMA_SFRmap *) ((uint32_t)0x40001600)), ((uint32_t)2), ((uint32_t)1));
