...
CRC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.stabs	"CRCInitStruct:P(0,16)=*(1,1)",64,0,42,6
...
.LM10:
	LD	r5,#1073751680
	LD.w	r2,[r5]
	.stabn	68,0,57,.LM11-.LFBB2
.LM11:
	LD.w	r1,[r6+#1]
	LD.w	r3,[r6]
	ORL	r4,r1,r3
	.stabn	68,0,58,.LM12-.LFBB2
.LM12:
	LD.w	r1,[r6+#2]
	ORL	r4,r4,r1
...
.Lscope2:
	...
	.stabs	"CRCInitStruct:P(0,16)",64,0,72,0
...
.Ltext7:
	.stabn	68,0,102,.LM28-.LFBB5
.LM28:
.LFBB5:
	.stabn	68,0,105,.LM29-.LFBB5
.LM29:
	LD	r5,#1073751680
	LD.w	r0,[r5+#2]
	.stabn	68,0,107,.LM30-.LFBB5
.LM30:
	JMP	lr
	.size	CRC_GET_RESULT, .-CRC_GET_RESULT
	.stabs	"DATA:r(3,6)",64,0,104,0
...
.LM34:
.LFBB7:
	.stabn	68,0,128,.LM35-.LFBB7
.LM35:
	LD	r5,#1073751680
	ST.w	[r5+#4],r0
	.stabn	68,0,129,.LM36-.LFBB7
.LM36:
	JMP	lr
...
.Ltext10:
	.stabn	68,0,137,.LM37-.LFBB8
.LM37:
.LFBB8:
	.stabn	68,0,139,.LM38-.LFBB8
.LM38:
	LD	r5,#1073751680
	ST.w	[r5+#5],r0
	.stabn	68,0,140,.LM39-.LFBB8
.LM39:
	JMP	lr
...
.Ltext11:
	.stabn	68,0,148,.LM40-.LFBB9
.LM40:
.LFBB9:
	.stabn	68,0,150,.LM41-.LFBB9
.LM41:
	LD	r5,#1073751680
	ST.w	[r5+#6],r0
	.stabn	68,0,151,.LM42-.LFBB9
.LM42:
	JMP	lr
...
.Ltext12:
	.stabn	68,0,159,.LM43-.LFBB10
.LM43:
.LFBB10:
	.stabn	68,0,162,.LM44-.LFBB10
.LM44:
	LD	r5,#1073751680
	LD.w	r0,[r5+#7]
	.stabn	68,0,164,.LM45-.LFBB10
.LM45:
	JMP	lr
	.size	CRC_GET_TEMP, .-CRC_GET_TEMP
	.stabs	"DATA:r(3,6)",64,0,161,0
...
CRC_SET_RSET:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_crc.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,172,.LM46-.LFBB11
.LM46:
.LFBB11:
	.stabn	68,0,174,.LM47-.LFBB11
.LM47:
	LD	r5,#1073751680
	LD.w	r4,[r5]
	SET	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,175,.LM48-.LFBB11
.LM48:
	JMP	lr
