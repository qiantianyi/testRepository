	...
	.stabs	"../src/kf32a9k1xxx_ewdt.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_ewdt.h",130,0,0,0
	...
	.align	1
	.stabs	"EWDT_Reset:F(0,15)",36,0,22,EWDT_Reset
	.export	EWDT_Reset
	.type	EWDT_Reset, @function
EWDT_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.text$EWDT_Output_Effective_Single_Select$scode_loacal_2:
	.align	1
	.stabs	"EWDT_Output_Effective_Single_Select:F(0,15)",36,0,38,EWDT_Output_Effective_Single_Select
	.stabs	"Select:P(3,6)",64,0,38,6
...
EWDT_Output_Effective_Single_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext2
.Ltext2:
...
.LBE23:
.LBE22:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext4
.Ltext4:
...
.Lscope2:
	...
	.text$EWDT_Get_Reset_INT_Flag$scode_loacal_3:
	.align	1
	.stabs	"EWDT_Get_Reset_INT_Flag:F(2,4)",36,0,56,EWDT_Get_Reset_INT_Flag
	.export	EWDT_Get_Reset_INT_Flag
	.type	EWDT_Get_Reset_INT_Flag, @function
EWDT_Get_Reset_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext5
.Ltext5:
...
.Lscope3:
	...
	.text$EWDT_Clear_Reset_INT_Flag$scode_loacal_4:
	.align	1
	.stabs	"EWDT_Clear_Reset_INT_Flag:F(0,15)",36,0,67,EWDT_Clear_Reset_INT_Flag
	.export	EWDT_Clear_Reset_INT_Flag
	.type	EWDT_Clear_Reset_INT_Flag, @function
EWDT_Clear_Reset_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,68,.LM15-.LFBB4
.LM15:
.LFBB4:
	.stabn	68,0,69,.LM16-.LFBB4
.LM16:
	LD	r5,#1073752832
// inline asm begin
	// 69 "../src/kf32a9k1xxx_ewdt.c" 1
	SET [r5], #22
	.stabn	68,0,70,.LM17-.LFBB4
.LM17:
// inline asm end
	LD	r3,#1073752832
	MOV	r4,#1
...
.Lscope4:
	...
	.text$EWDT_Reset_Single_INT_Enable$scode_loacal_5:
	.align	1
	.stabs	"EWDT_Reset_Single_INT_Enable:F(0,15)",36,0,81,EWDT_Reset_Single_INT_Enable
	.stabs	"NewState:P(2,2)",64,0,81,6
	.export	EWDT_Reset_Single_INT_Enable
	.type	EWDT_Reset_Single_INT_Enable, @function
EWDT_Reset_Single_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,82,.LM20-.LFBB5
.LM20:
.LFBB5:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,86,.LM21-.LFBB5
.LM21:
	MOV	r0,#1
	CMP	r6,r0
	JLS	.L10
...
.L10:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,89,.LM22-.LFBB5
.LM22:
	LD	r5,#1073752832
	LD.w	r4,[r5]
	.stabn	68,0,88,.LM23-.LFBB5
.LM23:
	LSL	r6,#21
.LBB24:
.LBB25:
...
.Ltext8:
	.stabn	68,0,13917,.LM24-.LFBB5
.LM24:
	CLR	r4,#21
	ORL	r6,r6,r4
.LBE25:
.LBE24:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,89,.LM25-.LFBB5
.LM25:
	ST.w	[r5],r6
	.stabn	68,0,90,.LM26-.LFBB5
.LM26:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope5:
	...
	.text$EWDT_CLK_Select$scode_loacal_6:
	.align	1
	.stabs	"EWDT_CLK_Select:F(0,15)",36,0,102,EWDT_CLK_Select
	.stabs	"CLK:P(3,6)",64,0,102,6
	.export	EWDT_CLK_Select
	.type	EWDT_CLK_Select, @function
EWDT_CLK_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,103,.LM27-.LFBB6
.LM27:
.LFBB6:
	PUSH	{r6, lr}
	MOV	r6,r0
...
.LBB26:
.LBB27:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,13917,.LM31-.LFBB6
.LM31:
	CLR	r4,#18
	CLR	r4,#19
	ORL	r6,r6,r4
.LBE27:
.LBE26:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,110,.LM32-.LFBB6
.LM32:
	ST.w	[r5],r6
	.stabn	68,0,111,.LM33-.LFBB6
.LM33:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope6:
	...
	.text$EWDT_Input_Effective_Single_Select$scode_loacal_7:
	.align	1
	.stabs	"EWDT_Input_Effective_Single_Select:F(0,15)",36,0,120,EWDT_Input_Effective_Single_Select
	.stabs	"Select:P(3,6)",64,0,120,6
...
EWDT_Input_Effective_Single_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,121,.LM34-.LFBB7
.LM34:
.LFBB7:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,125,.LM35-.LFBB7
.LM35:
	MOV	r0,#1
	CMP	r6,r0
	JLS	.L14
...
.L14:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,128,.LM36-.LFBB7
.LM36:
	LD	r5,#1073752832
	LD.w	r4,[r5]
	.stabn	68,0,127,.LM37-.LFBB7
.LM37:
	LSL	r6,#17
.LBB28:
.LBB29:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext14
.Ltext14:
...
.LBE29:
.LBE28:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,128,.LM39-.LFBB7
.LM39:
	ST.w	[r5],r6
	.stabn	68,0,129,.LM40-.LFBB7
.LM40:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope7:
	...
	.text$EWDT_Input_Single_Enable$scode_loacal_8:
	.align	1
	.stabs	"EWDT_Input_Single_Enable:F(0,15)",36,0,138,EWDT_Input_Single_Enable
	.stabs	"NewState:P(2,2)",64,0,138,6
	.export	EWDT_Input_Single_Enable
	.type	EWDT_Input_Single_Enable, @function
EWDT_Input_Single_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext16
.Ltext16:
...
.L16:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,146,.LM43-.LFBB8
.LM43:
	LD	r5,#1073752832
	LD.w	r4,[r5]
	.stabn	68,0,145,.LM44-.LFBB8
.LM44:
	LSL	r6,#16
.LBB30:
.LBB31:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,13917,.LM45-.LFBB8
.LM45:
	CLR	r4,#16
	ORL	r6,r6,r4
.LBE31:
.LBE30:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext18
.Ltext18:
	.stabn	68,0,146,.LM46-.LFBB8
.LM46:
	ST.w	[r5],r6
	.stabn	68,0,147,.LM47-.LFBB8
.LM47:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope8:
	...
	.text$EWDT_Clear_Count40_INT_Flag$scode_loacal_9:
	.align	1
	.stabs	"EWDT_Clear_Count40_INT_Flag:F(0,15)",36,0,155,EWDT_Clear_Count40_INT_Flag
	.export	EWDT_Clear_Count40_INT_Flag
	.type	EWDT_Clear_Count40_INT_Flag, @function
EWDT_Clear_Count40_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext19
.Ltext19:
	.stabn	68,0,156,.LM48-.LFBB9
.LM48:
.LFBB9:
	.stabn	68,0,157,.LM49-.LFBB9
.LM49:
	LD	r5,#1073752832
// inline asm begin
	// 157 "../src/kf32a9k1xxx_ewdt.c" 1
	SET [r5], #15
	.stabn	68,0,158,.LM50-.LFBB9
.LM50:
// inline asm end
	LD	r3,#1073752832
	MOV	r4,#4
.L18:
	...
	ANL	r5,r5,r4
	JNZ	.L18
	.stabn	68,0,159,.LM51-.LFBB9
.LM51:
	LD	r5,#1073752832
// inline asm begin
	// 159 "../src/kf32a9k1xxx_ewdt.c" 1
	CLR [r5], #15
	.stabn	68,0,160,.LM52-.LFBB9
.LM52:
// inline asm end
	JMP	lr
...
.Lscope9:
	...
	.text$EWDT_Threshold_Config$scode_loacal_10:
	.align	1
	.stabs	"EWDT_Threshold_Config:F(0,15)",36,0,168,EWDT_Threshold_Config
	.stabs	"Threshold:P(3,6)",64,0,168,6
	.export	EWDT_Threshold_Config
	.type	EWDT_Threshold_Config, @function
EWDT_Threshold_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext20
.Ltext20:
	.stabn	68,0,169,.LM53-.LFBB10
.LM53:
.LFBB10:
	PUSH	{r6, lr}
	MOV	r6,r0
...
.L21:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,176,.LM55-.LFBB10
.LM55:
	LD	r5,#1073752832
	LD.w	r3,[r5]
	.stabn	68,0,175,.LM56-.LFBB10
.LM56:
	LSL	r6,#8
.LBB32:
.LBB33:
...
.LBE33:
.LBE32:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext22
.Ltext22:
	.stabn	68,0,176,.LM58-.LFBB10
.LM58:
	ST.w	[r5],r6
	.stabn	68,0,177,.LM59-.LFBB10
.LM59:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope10:
	...
	.text$EWDT_Clock_Div_Select$scode_loacal_11:
	.align	1
	.stabs	"EWDT_Clock_Div_Select:F(0,15)",36,0,203,EWDT_Clock_Div_Select
	.stabs	"CLK_DIV:P(3,6)",64,0,203,6
	.export	EWDT_Clock_Div_Select
	.type	EWDT_Clock_Div_Select, @function
EWDT_Clock_Div_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext23
.Ltext23:
	.stabn	68,0,204,.LM60-.LFBB11
.LM60:
.LFBB11:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,208,.LM61-.LFBB11
.LM61:
	MOV	r0,#1
	CMP	r6,#18
	JLS	.L23
...
.L23:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,211,.LM62-.LFBB11
.LM62:
	LD	r5,#1073752832
	LD.w	r3,[r5]
	.stabn	68,0,210,.LM63-.LFBB11
.LM63:
	LSL	r6,#3
.LBB34:
.LBB35:
...
.LBE35:
.LBE34:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext25
.Ltext25:
	.stabn	68,0,211,.LM65-.LFBB11
.LM65:
	ST.w	[r5],r6
	.stabn	68,0,212,.LM66-.LFBB11
.LM66:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope11:
	...
	.text$EWDT_Get_Count40_INT_Flag$scode_loacal_12:
	.align	1
	.stabs	"EWDT_Get_Count40_INT_Flag:F(2,4)",36,0,220,EWDT_Get_Count40_INT_Flag
	.export	EWDT_Get_Count40_INT_Flag
	.type	EWDT_Get_Count40_INT_Flag, @function
EWDT_Get_Count40_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext26
.Ltext26:
	.stabn	68,0,221,.LM67-.LFBB12
.LM67:
.LFBB12:
	.stabn	68,0,222,.LM68-.LFBB12
.LM68:
	LD	r5,#1073752832
	LD.w	r0,[r5]
	MOV	r5,#4
	ANL	r0,r0,r5
	.stabn	68,0,223,.LM69-.LFBB12
.LM69:
	LSR	r0,#2
	JMP	lr
...
.Lscope12:
	...
	.text$EWDT_Count40_INT_Enable$scode_loacal_13:
	.align	1
	.stabs	"EWDT_Count40_INT_Enable:F(0,15)",36,0,232,EWDT_Count40_INT_Enable
	.stabs	"NewState:P(2,2)",64,0,232,6
	.export	EWDT_Count40_INT_Enable
	.type	EWDT_Count40_INT_Enable, @function
EWDT_Count40_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext27
.Ltext27:
	.stabn	68,0,233,.LM70-.LFBB13
.LM70:
.LFBB13:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,237,.LM71-.LFBB13
.LM71:
	MOV	r0,#1
	CMP	r6,r0
	JLS	.L26
...
.L26:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,240,.LM72-.LFBB13
.LM72:
	LD	r5,#1073752832
	LD.w	r4,[r5]
	.stabn	68,0,239,.LM73-.LFBB13
.LM73:
	ADD	r6,r6,r6
.LBB36:
.LBB37:
...
.Ltext28:
	.stabn	68,0,13917,.LM74-.LFBB13
.LM74:
	CLR	r4,#1
	ORL	r6,r6,r4
.LBE37:
.LBE36:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext29
.Ltext29:
	.stabn	68,0,240,.LM75-.LFBB13
.LM75:
	ST.w	[r5],r6
	.stabn	68,0,241,.LM76-.LFBB13
.LM76:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope13:
	...
	.text$EWDT_Enable$scode_loacal_14:
	.align	1
	.stabs	"EWDT_Enable:F(0,15)",36,0,250,EWDT_Enable
	.stabs	"NewState:P(2,2)",64,0,250,6
	.export	EWDT_Enable
	.type	EWDT_Enable, @function
EWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext30
.Ltext30:
	.stabn	68,0,251,.LM77-.LFBB14
.LM77:
.LFBB14:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,253,.LM78-.LFBB14
.LM78:
	MOV	r0,#1
	CMP	r6,r0
	JLS	.L28
...
.L28:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,255,.LM79-.LFBB14
.LM79:
	LD	r5,#1073752832
	LD.w	r4,[r5]
.LBB38:
.LBB39:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext31
.Ltext31:
	.stabn	68,0,13917,.LM80-.LFBB14
.LM80:
	CLR	r4,#0
	ORL	r6,r6,r4
.LBE39:
.LBE38:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext32
.Ltext32:
	.stabn	68,0,255,.LM81-.LFBB14
.LM81:
	ST.w	[r5],r6
	.stabn	68,0,256,.LM82-.LFBB14
.LM82:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope14:
	...
	.text$EWDT_Get_Count_Value$scode_loacal_15:
	.align	1
	.stabs	"EWDT_Get_Count_Value:F(3,2)",36,0,264,EWDT_Get_Count_Value
	.export	EWDT_Get_Count_Value
	.type	EWDT_Get_Count_Value, @function
EWDT_Get_Count_Value:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext33
.Ltext33:
	.stabn	68,0,265,.LM83-.LFBB15
.LM83:
.LFBB15:
	.stabn	68,0,266,.LM84-.LFBB15
.LM84:
	LD	r5,#1073752832
	LD.w	r0,[r5+#1]
	.stabn	68,0,267,.LM85-.LFBB15
.LM85:
	MOV	r5,#127
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope15:
	...
	.text$EWDT_Set_Count_Value$scode_loacal_16:
	.align	1
	.stabs	"EWDT_Set_Count_Value:F(0,15)",36,0,275,EWDT_Set_Count_Value
	.stabs	"Value:P(3,2)",64,0,275,6
	.export	EWDT_Set_Count_Value
	.type	EWDT_Set_Count_Value, @function
EWDT_Set_Count_Value:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext34
.Ltext34:
	.stabn	68,0,276,.LM86-.LFBB16
.LM86:
.LFBB16:
	PUSH	{r6, lr}
	ZXT.b	r6,r0
	.stabn	68,0,278,.LM87-.LFBB16
.LM87:
	MOV	r0,#1
	CMP	r6,#64
	JLS	.L31
...
.L31:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,280,.LM88-.LFBB16
.LM88:
	LD	r5,#1073752832
	LD.w	r3,[r5+#1]
.LBB40:
.LBB41:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext35
.Ltext35:
	.stabn	68,0,13917,.LM89-.LFBB16
.LM89:
	MOV	r4,#127
	NOT	r4,r4
	ANL	r4,r3,r4
...
.LBE41:
.LBE40:
	.stabs	"../src/kf32a9k1xxx_ewdt.c",132,0,0,.Ltext36
.Ltext36:
	.stabn	68,0,280,.LM90-.LFBB16
.LM90:
	ST.w	[r5+#1],r6
	.stabn	68,0,281,.LM91-.LFBB16
.LM91:
	POP	r6
	POP	lr
	JMP	lr
