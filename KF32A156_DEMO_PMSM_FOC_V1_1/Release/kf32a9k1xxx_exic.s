...
EXIC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.stabs	"EXICInitStruct:P(0,16)=*(1,1)",64,0,50,6
...
.LM30:
	ORL	r4,r1,r4
	.stabn	68,0,89,.LM31-.LFBB2
.LM31:
	LD.w	r1,[r6+#3]
	LSL	r1,#3
	.stabn	68,0,92,.LM32-.LFBB2
.LM32:
	ORL	r4,r4,r1
...
.LM34:
	ORL	r4,r4,r1
	.stabn	68,0,91,.LM35-.LFBB2
.LM35:
	LD.w	r1,[r6+#5]
	LSL	r1,#8
	.stabn	68,0,94,.LM36-.LFBB2
.LM36:
	ORL	r4,r4,r1
...
.LM39:
	LD.w	r1,[r6+#7]
	LSL	r1,#16
	.stabn	68,0,96,.LM40-.LFBB2
.LM40:
	ORL	r4,r4,r1
	.stabn	68,0,94,.LM41-.LFBB2
.LM41:
	LD.w	r1,[r6+#8]
	LSL	r1,#17
...
.LM42:
	ORL	r4,r4,r1
	.stabn	68,0,95,.LM43-.LFBB2
.LM43:
	LD.w	r1,[r6+#9]
	LSL	r1,#28
	.stabn	68,0,98,.LM44-.LFBB2
.LM44:
	ORL	r4,r4,r1
	.stabn	68,0,96,.LM45-.LFBB2
.LM45:
	LD.w	r1,[r6+#10]
	LSL	r1,#29
	.stabn	68,0,86,.LM46-.LFBB2
.LM46:
	ORL	r4,r4,r1
.LBB6:
.LBB7:
...
.Ltext4:
	.stabn	68,0,101,.LM48-.LFBB2
.LM48:
	ST.w	[r5],r4
	.stabn	68,0,109,.LM49-.LFBB2
.LM49:
	LD.w	r1,[r5+#1]
	.stabn	68,0,107,.LM50-.LFBB2
.LM50:
	ORL	r3,r2,r3
.LBB8:
.LBB9:
...
.LM52:
	ST.w	[r5+#1],r3
	.stabn	68,0,112,.LM53-.LFBB2
.LM53:
	POP	{r6, r7}
	POP	lr
	JMP	lr
.L60:
	.stabn	68,0,66,.LM54-.LFBB2
.LM54:
	MOV	r0,#0
	JMP	.L17
.L59:
	.stabn	68,0,65,.LM55-.LFBB2
.LM55:
	MOV	r0,#0
	JMP	.L15
...
.Lscope2:
	...
	.stabs	"EXICInitStruct:P(0,16)",64,0,119,0
...
.Ltext7:
	.stabn	68,0,120,.LM56-.LFBB3
.LM56:
.LFBB3:
	.stabn	68,0,122,.LM57-.LFBB3
.LM57:
	MOV	r5,#0
	ST.w	[r0],r5
	.stabn	68,0,124,.LM58-.LFBB3
.LM58:
	ST.w	[r0+#1],r5
	.stabn	68,0,126,.LM59-.LFBB3
.LM59:
	ST.w	[r0+#2],r5
	.stabn	68,0,128,.LM60-.LFBB3
.LM60:
	ST.w	[r0+#3],r5
	.stabn	68,0,130,.LM61-.LFBB3
.LM61:
	ST.w	[r0+#4],r5
	.stabn	68,0,132,.LM62-.LFBB3
.LM62:
	ST.w	[r0+#5],r5
	.stabn	68,0,134,.LM63-.LFBB3
.LM63:
	ST.w	[r0+#6],r5
	.stabn	68,0,136,.LM64-.LFBB3
.LM64:
	ST.w	[r0+#7],r5
	.stabn	68,0,138,.LM65-.LFBB3
.LM65:
	ST.w	[r0+#8],r5
	.stabn	68,0,140,.LM66-.LFBB3
.LM66:
	ST.w	[r0+#9],r5
	.stabn	68,0,142,.LM67-.LFBB3
.LM67:
	ST.w	[r0+#10],r5
	.stabn	68,0,144,.LM68-.LFBB3
.LM68:
	MOV	r4,#1
	LSL	r4,#30
	ST.w	[r0+#11],r4
	.stabn	68,0,146,.LM69-.LFBB3
.LM69:
	MOV	r4,#1
	LSL	r4,#31
	ST.w	[r0+#12],r4
	.stabn	68,0,148,.LM70-.LFBB3
.LM70:
	ST.w	[r0+#13],r5
	.stabn	68,0,150,.LM71-.LFBB3
.LM71:
	MOV	r5,#64
	ST.w	[r0+#14],r5
	.stabn	68,0,151,.LM72-.LFBB3
.LM72:
	JMP	lr
...
.Ltext9:
	.stabn	68,0,178,.LM76-.LFBB5
.LM76:
.LFBB5:
	.stabn	68,0,180,.LM77-.LFBB5
.LM77:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r3,#1
	...
	JZ	.L63
.L66:
	.stabn	68,0,182,.LM78-.LFBB5
.LM78:
	LD.w	r4,[r5+#2]
	CLR	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,180,.LM79-.LFBB5
.LM79:
	LD.w	r4,[r5+#2]
	ANL	r4,r4,r3
	JNZ	.L66
.L63:
	.stabn	68,0,184,.LM80-.LFBB5
.LM80:
	JMP	lr
...
.Ltext10:
	.stabn	68,0,192,.LM81-.LFBB6
.LM81:
.LFBB6:
	.stabn	68,0,194,.LM82-.LFBB6
.LM82:
	LD	r5,#1073752064
	LD.w	r0,[r5+#2]
	LSR	r0,#1
	.stabn	68,0,204,.LM83-.LFBB6
.LM83:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
EXIC_Clear_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,211,.LM84-.LFBB7
.LM84:
.LFBB7:
...
.Lscope7:
	...
	.stabs	"DATA:P(3,6)",64,0,224,0
	.export	EXIC_Write_Buff
	.type	EXIC_Write_Buff, @function
EXIC_Write_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,225,.LM89-.LFBB8
.LM89:
.LFBB8:
	.stabn	68,0,226,.LM90-.LFBB8
.LM90:
	LD	r5,#1073752064
	ST.w	[r5+#4],r0
	.stabn	68,0,227,.LM91-.LFBB8
.LM91:
	JMP	lr
...
EXIC_Read_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_exic.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,235,.LM92-.LFBB9
.LM92:
.LFBB9:
	.stabn	68,0,237,.LM93-.LFBB9
.LM93:
	LD	r5,#1073752064
	LD.w	r0,[r5+#5]
	.stabn	68,0,239,.LM94-.LFBB9
.LM94:
	JMP	lr
