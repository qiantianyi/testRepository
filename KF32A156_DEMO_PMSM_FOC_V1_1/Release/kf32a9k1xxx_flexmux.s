	...
	.stabs	"../src/kf32a9k1xxx_flexmux.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_flexmux.h",130,0,0,0
	...
	.align	1
	.stabs	"FMUX_Reset:F(0,15)",36,0,19,FMUX_Reset
	.export	FMUX_Reset
	.type	FMUX_Reset, @function
FMUX_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.align	1
	.stabs	"FMUX_Channel_Enable:F(0,15)",36,0,36,FMUX_Channel_Enable
	.stabs	"Channel:P(3,6)",64,0,36,7
	.stabs	"NewState:P(2,2)",64,0,36,6
	.export	FMUX_Channel_Enable
	.type	FMUX_Channel_Enable, @function
FMUX_Channel_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext2
.Ltext2:
...
.Ltext3:
	.stabn	68,0,13917,.LM12-.LFBB2
.LM12:
	ANL	r4,r4,r3
.LBE17:
.LBE16:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext4
.Ltext4:
...
.Ltext5:
	.stabn	68,0,13917,.LM14-.LFBB2
.LM14:
	ORL	r7,r4,r6
.LBE18:
.LBE19:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext6
.Ltext6:
...
.Lscope2:
	...
	.align	1
	.stabs	"FMUX_Channel_Triggle_Source_Select:F(0,15)",36,0,167,FMUX_Channel_Triggle_Source_Select
	.stabs	"Channel:P(3,6)",64,0,167,7
	.stabs	"Source:P(3,6)",64,0,167,6
...
FMUX_Channel_Triggle_Source_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,168,.LM17-.LFBB3
.LM17:
.LFBB3:
	PUSH	{r6, r7, r8, lr}
	MOV	r7,r0
	MOV	r6,r1
	.stabn	68,0,173,.LM18-.LFBB3
.LM18:
	MOV	r0,#1
	CMP	r7,#3
	JLS	.L7
...
.L8:
	LJMP	r8
	.stabn	68,0,176,.LM20-.LFBB3
.LM20:
	LSL	r7,#3
	.stabn	68,0,178,.LM21-.LFBB3
.LM21:
	LD	r5,#1073753344
	LD.w	r3,[r5]
...
.Ltext8:
	.stabn	68,0,13917,.LM24-.LFBB3
.LM24:
	ANL	r4,r4,r3
.LBE21:
.LBE20:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,176,.LM25-.LFBB3
.LM25:
	LSL	r7,r6,r7
.LBB23:
.LBB22:
...
.Ltext10:
	.stabn	68,0,13917,.LM26-.LFBB3
.LM26:
	ORL	r7,r4,r7
.LBE22:
.LBE23:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,178,.LM27-.LFBB3
.LM27:
	ST.w	[r5],r7
	.stabn	68,0,179,.LM28-.LFBB3
.LM28:
	POP	{r6, r7, r8}
	POP	lr
	JMP	lr
...
.Lscope3:
	...
	.align	1
	.stabs	"FMUX_Enable:F(0,15)",36,0,189,FMUX_Enable
	.stabs	"NewState:P(2,2)",64,0,189,6
	.export	FMUX_Enable
	.type	FMUX_Enable, @function
FMUX_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,190,.LM29-.LFBB4
.LM29:
.LFBB4:
	PUSH	{r6, lr}
	MOV	r6,r0
...
.Ltext13:
	.stabn	68,0,13917,.LM32-.LFBB4
.LM32:
	CLR	r4,#0
	ORL	r6,r6,r4
.LBE25:
.LBE24:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,194,.LM33-.LFBB4
.LM33:
	ST.w	[r5+#1],r6
	.stabn	68,0,195,.LM34-.LFBB4
.LM34:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"FMUX_Output_Channel_DMA_Enable:F(0,15)",36,0,207,FMUX_Output_Channel_DMA_Enable
	.stabs	"Channel:P(3,6)",64,0,207,7
	.stabs	"NewState:P(2,2)",64,0,207,6
	.export	FMUX_Output_Channel_DMA_Enable
	.type	FMUX_Output_Channel_DMA_Enable, @function
FMUX_Output_Channel_DMA_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,208,.LM35-.LFBB5
.LM35:
.LFBB5:
	PUSH	{r6, r7, r8, lr}
	MOV	r7,r0
	MOV	r6,r1
	.stabn	68,0,213,.LM36-.LFBB5
.LM36:
	MOV	r0,#1
	CMP	r7,#3
	JLS	.L33
...
.L34:
	LJMP	r8
	.stabn	68,0,216,.LM38-.LFBB5
.LM38:
	ADD	r7,r7,#1
	.stabn	68,0,218,.LM39-.LFBB5
.LM39:
	LD	r5,#1073753344
	LD.w	r3,[r5+#1]
	.stabn	68,0,217,.LM40-.LFBB5
.LM40:
	MOV	r4,#1
	LSL	r4,r4,r7
	.stabn	68,0,218,.LM41-.LFBB5
.LM41:
	NOT	r4,r4
.LBB26:
.LBB27:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext16
.Ltext16:
	.stabn	68,0,13917,.LM42-.LFBB5
.LM42:
	ANL	r4,r4,r3
.LBE27:
.LBE26:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,216,.LM43-.LFBB5
.LM43:
	LSL	r7,r6,r7
.LBB29:
.LBB28:
...
.Ltext18:
	.stabn	68,0,13917,.LM44-.LFBB5
.LM44:
	ORL	r7,r4,r7
.LBE28:
.LBE29:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext19
.Ltext19:
	.stabn	68,0,218,.LM45-.LFBB5
.LM45:
	ST.w	[r5+#1],r7
	.stabn	68,0,219,.LM46-.LFBB5
.LM46:
	POP	{r6, r7, r8}
	POP	lr
	JMP	lr
...
.Lscope5:
	...
	.align	1
	.stabs	"FMUX_Triggle_Single_Maintain_Time_Select:F(0,15)",36,0,233,FMUX_Triggle_Single_Maintain_Time_Select
	.stabs	"Channel:P(3,6)",64,0,233,6
	.stabs	"DIV:P(3,6)",64,0,233,7
...
FMUX_Triggle_Single_Maintain_Time_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext20
.Ltext20:
	.stabn	68,0,234,.LM47-.LFBB6
.LM47:
.LFBB6:
	PUSH	{r6, r7, r8, lr}
	MOV	r6,r0
	MOV	r7,r1
	.stabn	68,0,239,.LM48-.LFBB6
.LM48:
	MOV	r0,#1
	CMP	r6,#3
	JLS	.L36
...
.LM51:
	LD	r5,#1073753344
	LD.w	r3,[r5+#1]
	.stabn	68,0,243,.LM52-.LFBB6
.LM52:
	MOV	r4,#3
	LSL	r4,r4,r6
	.stabn	68,0,244,.LM53-.LFBB6
.LM53:
	NOT	r4,r4
.LBB30:
.LBB31:
...
.Ltext21:
	.stabn	68,0,13917,.LM54-.LFBB6
.LM54:
	ANL	r4,r4,r3
.LBE31:
.LBE30:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext22
.Ltext22:
	.stabn	68,0,242,.LM55-.LFBB6
.LM55:
	LSL	r7,r7,r6
.LBB33:
.LBB32:
...
.Ltext23:
	.stabn	68,0,13917,.LM56-.LFBB6
.LM56:
	ORL	r6,r4,r7
.LBE32:
.LBE33:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext24
.Ltext24:
	.stabn	68,0,244,.LM57-.LFBB6
.LM57:
	ST.w	[r5+#1],r6
	.stabn	68,0,245,.LM58-.LFBB6
.LM58:
	POP	{r6, r7, r8}
	POP	lr
	JMP	lr
...
.Lscope6:
	...
	.align	1
	.stabs	"FMUX_Output_Select:F(0,15)",36,0,259,FMUX_Output_Select
	.stabs	"Channel:P(3,6)",64,0,259,6
	.stabs	"MODE:P(3,6)",64,0,259,7
	.export	FMUX_Output_Select
	.type	FMUX_Output_Select, @function
FMUX_Output_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext25
.Ltext25:
	.stabn	68,0,260,.LM59-.LFBB7
.LM59:
.LFBB7:
	PUSH	{r6, r7, r8, lr}
	MOV	r6,r0
	MOV	r7,r1
	.stabn	68,0,265,.LM60-.LFBB7
.LM60:
	MOV	r0,#1
	CMP	r6,#3
	JLS	.L39
...
.L40:
	LJMP	r8
	.stabn	68,0,268,.LM62-.LFBB7
.LM62:
	ADD	r6,r6,r6
	ADD	r6,#13
	.stabn	68,0,270,.LM63-.LFBB7
.LM63:
	LD	r5,#1073753344
	LD.w	r3,[r5+#1]
	.stabn	68,0,269,.LM64-.LFBB7
.LM64:
	MOV	r4,#3
	LSL	r4,r4,r6
	.stabn	68,0,270,.LM65-.LFBB7
.LM65:
	NOT	r4,r4
.LBB34:
.LBB35:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext26
.Ltext26:
	.stabn	68,0,13917,.LM66-.LFBB7
.LM66:
	ANL	r4,r4,r3
.LBE35:
.LBE34:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext27
.Ltext27:
	.stabn	68,0,268,.LM67-.LFBB7
.LM67:
	LSL	r7,r7,r6
.LBB37:
.LBB36:
...
.Ltext28:
	.stabn	68,0,13917,.LM68-.LFBB7
.LM68:
	ORL	r6,r4,r7
.LBE36:
.LBE37:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext29
.Ltext29:
	.stabn	68,0,270,.LM69-.LFBB7
.LM69:
	ST.w	[r5+#1],r6
	.stabn	68,0,271,.LM70-.LFBB7
.LM70:
	POP	{r6, r7, r8}
	POP	lr
	JMP	lr
...
.Lscope7:
	...
	.align	1
	.stabs	"FMUX_Work_CLK_Select:F(0,15)",36,0,280,FMUX_Work_CLK_Select
	.stabs	"CLK:P(3,6)",64,0,280,6
	.export	FMUX_Work_CLK_Select
	.type	FMUX_Work_CLK_Select, @function
FMUX_Work_CLK_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext30
.Ltext30:
...
.LBE39:
.LBE38:
	.stabs	"../src/kf32a9k1xxx_flexmux.c",132,0,0,.Ltext32
.Ltext32:
	.stabn	68,0,285,.LM75-.LFBB8
.LM75:
	ST.w	[r5+#1],r6
	.stabn	68,0,286,.LM76-.LFBB8
.LM76:
	POP	r6
	POP	lr
	JMP	lr
