	...
	.stabs	"../src/kf32a9k1xxx_iwdt.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_iwdt.h",130,0,0,0
...
.LBE9:
.LBE8:
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext3
.Ltext3:
...
.Lscope1:
	...
	.align	1
	.stabs	"IWDT_SCK_Source_Select:F(0,15)",36,0,57,IWDT_SCK_Source_Select
	.stabs	"Source:P(3,6)",64,0,57,6
	.export	IWDT_SCK_Source_Select
	.type	IWDT_SCK_Source_Select, @function
IWDT_SCK_Source_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext4
.Ltext4:
...
.LBE11:
.LBE10:
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext6
.Ltext6:
...
.Lscope2:
	...
	.align	1
	.stabs	"IWDT_Overflow_Config:F(0,15)",36,0,71,IWDT_Overflow_Config
	.stabs	"Overflow:P(3,6)",64,0,71,6
	.export	IWDT_Overflow_Config
	.type	IWDT_Overflow_Config, @function
IWDT_Overflow_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,72,.LM12-.LFBB3
.LM12:
.LFBB3:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,76,.LM13-.LFBB3
.LM13:
	MOV	r0,#1
	LD	r5,#4095
	CMP	r6,r5
...
.LBE13:
.LBE12:
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,80,.LM17-.LFBB3
.LM17:
	ST.w	[r5],r6
...
.Lscope3:
	...
	.align	1
	.stabs	"IWDT_Enable:F(0,15)",36,0,89,IWDT_Enable
	.stabs	"NewState:P(2,2)",64,0,89,6
	.export	IWDT_Enable
	.type	IWDT_Enable, @function
IWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,90,.LM19-.LFBB4
.LM19:
.LFBB4:
	PUSH	{r6, lr}
	MOV	r6,r0
...
.L9:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,98,.LM21-.LFBB4
.LM21:
	LD	r5,#1073746432
	.stabn	68,0,95,.LM22-.LFBB4
.LM22:
	CMP	r6,#0
	JNZ	.L12
	.stabn	68,0,103,.LM23-.LFBB4
.LM23:
// inline asm begin
	// 103 "../src/kf32a9k1xxx_iwdt.c" 1
	CLR [r5], #31
	.stabn	68,0,105,.LM24-.LFBB4
.LM24:
// inline asm end
	POP	r6
	POP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"IWDT_Feed_The_Dog:F(0,15)",36,0,113,IWDT_Feed_The_Dog
	.export	IWDT_Feed_The_Dog
	.type	IWDT_Feed_The_Dog, @function
IWDT_Feed_The_Dog:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_iwdt.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,114,.LM27-.LFBB5
.LM27:
.LFBB5:
	.stabn	68,0,115,.LM28-.LFBB5
.LM28:
	LD	r4,#1437226410
	LD	r5,#1073746432
	ST.w	[r5+#1],r4
	.stabn	68,0,116,.LM29-.LFBB5
.LM29:
	JMP	lr
