...
.Ltext0:
	...
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_rst.h",130,0,0,0
...
.Lscope1:
	...
	.align	1
	.stabs	"RST_CTL1_Peripheral_Reset_Enable:F(0,15)",36,0,82,RST_CTL1_Peripheral_Reset_Enable
	.stabs	"RST_CTL1_bit:P(3,6)",64,0,82,6
	.stabs	"NewState:P(2,2)",64,0,83,7
	.export	RST_CTL1_Peripheral_Reset_Enable
	.type	RST_CTL1_Peripheral_Reset_Enable, @function
RST_CTL1_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rst.c",132,0,0,.Ltext2
.Ltext2:
...
.L11:
	LJMP	r8
	.stabn	68,0,91,.LM12-.LFBB2
.LM12:
	LD	r5,#1073747200
	LD.w	r4,[r5+#1]
	.stabn	68,0,89,.LM13-.LFBB2
.LM13:
	CMP	r7,#0
	JNZ	.L15
...
.Lscope2:
	...
	.align	1
	.stabs	"RST_CTL2_Peripheral_Reset_Enable:F(0,15)",36,0,123,RST_CTL2_Peripheral_Reset_Enable
	.stabs	"RST_CTL2_bit:P(3,6)",64,0,123,6
	.stabs	"NewState:P(2,2)",64,0,124,7
	.export	RST_CTL2_Peripheral_Reset_Enable
	.type	RST_CTL2_Peripheral_Reset_Enable, @function
RST_CTL2_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rst.c",132,0,0,.Ltext3
.Ltext3:
...
.L18:
	LJMP	r8
	.stabn	68,0,132,.LM21-.LFBB3
.LM21:
	LD	r5,#1073747200
	LD.w	r4,[r5+#2]
	.stabn	68,0,130,.LM22-.LFBB3
.LM22:
	CMP	r7,#0
	JNZ	.L22
	.stabn	68,0,136,.LM23-.LFBB3
.LM23:
	NOT	r6,r6
	ANL	r6,r6,r4
	ST.w	[r5+#2],r6
	.stabn	68,0,138,.LM24-.LFBB3
.LM24:
	POP	{r6, r7, r8}
	POP	lr
	JMP	lr
.L22:
	.stabn	68,0,132,.LM25-.LFBB3
.LM25:
	ORL	r6,r6,r4
	ST.w	[r5+#2],r6
	.stabn	68,0,138,.LM26-.LFBB3
.LM26:
	POP	{r6, r7, r8}
	POP	lr
	JMP	lr
...
.Lscope3:
	...
	.align	1
	.stabs	"RST_CTL3_Peripheral_Reset_Enable:F(0,15)",36,0,170,RST_CTL3_Peripheral_Reset_Enable
	.stabs	"RST_CTL3_bit:P(3,6)",64,0,170,6
	.stabs	"NewState:P(2,2)",64,0,171,7
	.export	RST_CTL3_Peripheral_Reset_Enable
	.type	RST_CTL3_Peripheral_Reset_Enable, @function
RST_CTL3_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_rst.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,172,.LM27-.LFBB4
.LM27:
.LFBB4:
	PUSH	{r6, r7, r8, lr}
	MOV	r6,r0
	MOV	r7,r1
	.stabn	68,0,174,.LM28-.LFBB4
.LM28:
	LD	r5,#301177
	ANL	r5,r0,r5
	MOV	r0,#0
...
.L25:
	LJMP	r8
	.stabn	68,0,179,.LM30-.LFBB4
.LM30:
	LD	r5,#1073747200
	LD.w	r4,[r5+#3]
	.stabn	68,0,177,.LM31-.LFBB4
.LM31:
	CMP	r7,#0
	JNZ	.L29
	.stabn	68,0,183,.LM32-.LFBB4
.LM32:
	NOT	r6,r6
	ANL	r6,r6,r4
	ST.w	[r5+#3],r6
	.stabn	68,0,185,.LM33-.LFBB4
.LM33:
	POP	{r6, r7, r8}
	POP	lr
	JMP	lr
