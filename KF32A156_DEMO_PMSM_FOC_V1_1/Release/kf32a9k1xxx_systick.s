	...
	.stabs	"../src/kf32a9k1xxx_systick.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"SYSTICK_InitTypeDef:t(1,1)=(1,2)=s12m_Period:(3,6),0,32;m_Clock:(3,6),32,32;m_SysTickINT:(3,6),64,32;;",128,0,26,0
	.stabn	162,0,0,0
	...
	.align	1
	.stabs	"SYSTICK_Configuration:F(0,15)",36,0,42,SYSTICK_Configuration
	.stabs	"Clock:P(3,6)",64,0,42,8
	.stabs	"SysTickINT:P(3,6)",64,0,42,6
	.stabs	"Reload:P(3,6)",64,0,42,9
	.export	SYSTICK_Configuration
	.type	SYSTICK_Configuration, @function
SYSTICK_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext1
.Ltext1:
...
.LBB4:
.LBB5:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,13917,.LM8-.LFBB1
.LM8:
	CLR	r4,#1
	CLR	r4,#2
.LBE5:
.LBE4:
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,64,.LM9-.LFBB1
.LM9:
	ORL	r8,r4
	ADD	r6,r6,r6
.LBB7:
.LBB6:
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,13917,.LM10-.LFBB1
.LM10:
	MOV	r4,r8
	ORL	r6,r4,r6
.LBE6:
.LBE7:
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext5
.Ltext5:
...
.Lscope1:
	...
	.align	1
	.stabs	"SYSTICK_Cmd:F(0,15)",36,0,85,SYSTICK_Cmd
	.stabs	"NewState:P(2,2)",64,0,85,6
	.export	SYSTICK_Cmd
	.type	SYSTICK_Cmd, @function
SYSTICK_Cmd:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext6
.Ltext6:
...
.L16:
	...
	LJMP	r5
	.stabn	68,0,94,.LM15-.LFBB2
.LM15:
	LD	r5,#1075839136
	.stabn	68,0,91,.LM16-.LFBB2
.LM16:
	CMP	r6,#0
	JNZ	.L19
...
// inline asm end
	...
	JMP	lr
.L19:
	.stabn	68,0,94,.LM19-.LFBB2
.LM19:
// inline asm begin
	// 94 "../src/kf32a9k1xxx_systick.c" 1
	SET [r5], #0
	.stabn	68,0,101,.LM20-.LFBB2
.LM20:
// inline asm end
	POP	r6
	POP	lr
...
.Lscope2:
	...
	.align	1
	.stabs	"SYSTICK_Clock_Config:F(0,15)",36,0,113,SYSTICK_Clock_Config
	.stabs	"SysClock:P(3,6)",64,0,113,0
	.export	SYSTICK_Clock_Config
	.type	SYSTICK_Clock_Config, @function
SYSTICK_Clock_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,114,.LM21-.LFBB3
.LM21:
.LFBB3:
	PUSH	lr
	.stabn	68,0,116,.LM22-.LFBB3
.LM22:
	CMP	r0,#0
	JZ	.L21
	MOV	r5,#1
...
.LM25:
	...
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,127,.LM26-.LFBB3
.LM26:
	LD	r5,#1075839136
// inline asm begin
	// 127 "../src/kf32a9k1xxx_systick.c" 1
	CLR [r5], #2
	.stabn	68,0,129,.LM27-.LFBB3
.LM27:
// inline asm end
	POP	lr
	JMP	lr
...
.Lscope3:
	...
	.align	1
	.stabs	"SYSTICK_Systick_INT_Enable:F(0,15)",36,0,138,SYSTICK_Systick_INT_Enable
	.stabs	"SysClock:P(3,6)",64,0,138,6
	.export	SYSTICK_Systick_INT_Enable
	.type	SYSTICK_Systick_INT_Enable, @function
SYSTICK_Systick_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,139,.LM28-.LFBB4
.LM28:
.LFBB4:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,141,.LM29-.LFBB4
.LM29:
	MOV	r0,#1
	CMP	r6,r0
	JLS	.L28
...
.L28:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,147,.LM30-.LFBB4
.LM30:
	LD	r5,#1075839136
	.stabn	68,0,144,.LM31-.LFBB4
.LM31:
	CMP	r6,#0
	JNZ	.L31
	.stabn	68,0,152,.LM32-.LFBB4
.LM32:
// inline asm begin
	// 152 "../src/kf32a9k1xxx_systick.c" 1
	CLR [r5], #1
	.stabn	68,0,154,.LM33-.LFBB4
.LM33:
// inline asm end
	POP	r6
	POP	lr
	JMP	lr
.L31:
	.stabn	68,0,147,.LM34-.LFBB4
.LM34:
// inline asm begin
	// 147 "../src/kf32a9k1xxx_systick.c" 1
	SET [r5], #1
	.stabn	68,0,154,.LM35-.LFBB4
.LM35:
// inline asm end
	POP	r6
	POP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"SYSTICK_Get_Count_Zero_Flag:F(2,4)",36,0,162,SYSTICK_Get_Count_Zero_Flag
	.export	SYSTICK_Get_Count_Zero_Flag
	.type	SYSTICK_Get_Count_Zero_Flag, @function
SYSTICK_Get_Count_Zero_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,163,.LM36-.LFBB5
.LM36:
.LFBB5:
	.stabn	68,0,165,.LM37-.LFBB5
.LM37:
	LD	r5,#1075839136
	LD.w	r0,[r5]
	LSR	r0,#16
	.stabn	68,0,175,.LM38-.LFBB5
.LM38:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope5:
	...
	.align	1
	.stabs	"SYSTICK_Reload_Config:F(0,15)",36,0,184,SYSTICK_Reload_Config
	.stabs	"Reload:P(3,6)",64,0,184,6
	.export	SYSTICK_Reload_Config
	.type	SYSTICK_Reload_Config, @function
SYSTICK_Reload_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,185,.LM39-.LFBB6
.LM39:
.LFBB6:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,187,.LM40-.LFBB6
.LM40:
	MOV	r4,#24
	LSR	r5,r0,r4
	MOV	r0,#1
...
.L34:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,190,.LM41-.LFBB6
.LM41:
	LD	r5,#1075839136
	ST.w	[r5+#1],r6
	.stabn	68,0,191,.LM42-.LFBB6
.LM42:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope6:
	...
	.align	1
	.stabs	"SYSTICK_Counter_Updata:F(0,15)",36,0,200,SYSTICK_Counter_Updata
	.export	SYSTICK_Counter_Updata
	.type	SYSTICK_Counter_Updata, @function
SYSTICK_Counter_Updata:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,201,.LM43-.LFBB7
.LM43:
.LFBB7:
	.stabn	68,0,204,.LM44-.LFBB7
.LM44:
	MOV	r4,#0
	LD	r5,#1075839136
	ST.w	[r5+#2],r4
	.stabn	68,0,205,.LM45-.LFBB7
.LM45:
	JMP	lr
...
.Lscope7:
	...
	.align	1
	.stabs	"SYSTICK_Get_Reload:F(3,6)",36,0,213,SYSTICK_Get_Reload
	.export	SYSTICK_Get_Reload
	.type	SYSTICK_Get_Reload, @function
SYSTICK_Get_Reload:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,214,.LM46-.LFBB8
.LM46:
.LFBB8:
	.stabn	68,0,218,.LM47-.LFBB8
.LM47:
	LD	r5,#1075839136
	LD.w	r0,[r5+#1]
	.stabn	68,0,221,.LM48-.LFBB8
.LM48:
	LD	r5,#16777215
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope8:
	...
	.align	1
	.stabs	"SYSTICK_Get_Counter:F(3,6)",36,0,229,SYSTICK_Get_Counter
	.export	SYSTICK_Get_Counter
	.type	SYSTICK_Get_Counter, @function
SYSTICK_Get_Counter:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_systick.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,230,.LM49-.LFBB9
.LM49:
.LFBB9:
	.stabn	68,0,234,.LM50-.LFBB9
.LM50:
	LD	r5,#1075839136
	LD.w	r0,[r5+#2]
	.stabn	68,0,237,.LM51-.LFBB9
.LM51:
	LD	r5,#16777215
	ANL	r0,r0,r5
	JMP	lr
