	...
	.stabs	"../src/kf32a9k1xxx_wwdt.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"C:\\kf32_workspace_copy\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_wwdt.h",130,0,0,0
...
WWDT_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext1
.Ltext1:
...
.LBE9:
.LBE8:
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext4
.Ltext4:
...
.LBE11:
.LBE10:
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,87,.LM16-.LFBB3
.LM16:
	ST.w	[r5],r6
...
.Lscope3:
	...
	.align	1
	.stabs	"WWDT_Work_CLK_Selest:F(0,15)",36,0,100,WWDT_Work_CLK_Selest
	.stabs	"Source:P(3,6)",64,0,100,6
	.export	WWDT_Work_CLK_Selest
	.type	WWDT_Work_CLK_Selest, @function
WWDT_Work_CLK_Selest:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,101,.LM18-.LFBB4
.LM18:
.LFBB4:
	PUSH	{r6, lr}
	MOV	r6,r0
...
.LBE13:
.LBE12:
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,105,.LM22-.LFBB4
.LM22:
	ST.w	[r5+#2],r6
	.stabn	68,0,106,.LM23-.LFBB4
.LM23:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope4:
	...
	.align	1
	.stabs	"WWDT_Enable:F(0,15)",36,0,114,WWDT_Enable
	.stabs	"NewState:P(2,2)",64,0,114,6
	.export	WWDT_Enable
	.type	WWDT_Enable, @function
WWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,115,.LM24-.LFBB5
.LM24:
.LFBB5:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,117,.LM25-.LFBB5
.LM25:
	MOV	r0,#1
	CMP	r6,r0
	JLS	.L45
...
.L45:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,123,.LM26-.LFBB5
.LM26:
	LD	r5,#1073746560
	.stabn	68,0,120,.LM27-.LFBB5
.LM27:
	CMP	r6,#0
	JNZ	.L48
	.stabn	68,0,128,.LM28-.LFBB5
.LM28:
// inline asm begin
...
// inline asm end
	...
	JMP	lr
.L48:
	.stabn	68,0,123,.LM30-.LFBB5
.LM30:
// inline asm begin
	// 123 "../src/kf32a9k1xxx_wwdt.c" 1
	SET [r5], #0
	.stabn	68,0,130,.LM31-.LFBB5
.LM31:
// inline asm end
	POP	r6
	POP	lr
...
.Lscope5:
	...
	.align	1
	.stabs	"WWDT_Counter_Config:F(0,15)",36,0,138,WWDT_Counter_Config
	.stabs	"Counter:P(3,6)",64,0,138,6
	.export	WWDT_Counter_Config
	.type	WWDT_Counter_Config, @function
WWDT_Counter_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,139,.LM32-.LFBB6
.LM32:
.LFBB6:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,141,.LM33-.LFBB6
.LM33:
	MOV	r0,#1
	CMP	r6,#63
	JLS	.L50
...
.L50:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,144,.LM34-.LFBB6
.LM34:
	LD	r5,#1073746560
	ST.w	[r5+#1],r6
	.stabn	68,0,145,.LM35-.LFBB6
.LM35:
	POP	r6
	POP	lr
	JMP	lr
...
.Lscope6:
	...
	.align	1
	.stabs	"WWDT_Get_Counter:F(3,6)",36,0,153,WWDT_Get_Counter
	.export	WWDT_Get_Counter
	.type	WWDT_Get_Counter, @function
WWDT_Get_Counter:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,154,.LM36-.LFBB7
.LM36:
.LFBB7:
	.stabn	68,0,158,.LM37-.LFBB7
.LM37:
	LD	r5,#1073746560
	LD.w	r0,[r5+#1]
	.stabn	68,0,162,.LM38-.LFBB7
.LM38:
	MOV	r5,#127
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope7:
	...
	.align	1
	.stabs	"WWDT_INT_Enable:F(0,15)",36,0,177,WWDT_INT_Enable
	.stabs	"NewState:P(2,2)",64,0,177,6
	.export	WWDT_INT_Enable
	.type	WWDT_INT_Enable, @function
WWDT_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,178,.LM39-.LFBB8
.LM39:
.LFBB8:
	PUSH	{r6, lr}
	MOV	r6,r0
	.stabn	68,0,180,.LM40-.LFBB8
.LM40:
	MOV	r0,#1
	CMP	r6,r0
	JLS	.L53
...
.L53:
	LD	r5,#CHECK_RESTRICTION
	LJMP	r5
	.stabn	68,0,186,.LM41-.LFBB8
.LM41:
	LD	r5,#1073746560
	.stabn	68,0,183,.LM42-.LFBB8
.LM42:
	CMP	r6,#0
	JNZ	.L56
	.stabn	68,0,191,.LM43-.LFBB8
.LM43:
// inline asm begin
	// 191 "../src/kf32a9k1xxx_wwdt.c" 1
	CLR [r5], #1
	.stabn	68,0,193,.LM44-.LFBB8
.LM44:
// inline asm end
	POP	r6
	POP	lr
...
.Lscope8:
	...
	.align	1
	.stabs	"WWDT_Get_INT_Flag:F(2,4)",36,0,201,WWDT_Get_INT_Flag
	.export	WWDT_Get_INT_Flag
	.type	WWDT_Get_INT_Flag, @function
WWDT_Get_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,202,.LM47-.LFBB9
.LM47:
.LFBB9:
	.stabn	68,0,204,.LM48-.LFBB9
.LM48:
	LD	r5,#1073746560
	LD.w	r0,[r5]
	LSR	r0,#2
	.stabn	68,0,214,.LM49-.LFBB9
.LM49:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope9:
	...
	.align	1
	.stabs	"WWDT_Clear_INT_Flag:F(0,15)",36,0,222,WWDT_Clear_INT_Flag
	.export	WWDT_Clear_INT_Flag
	.type	WWDT_Clear_INT_Flag, @function
WWDT_Clear_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a9k1xxx_wwdt.c",132,0,0,.Ltext16
.Ltext16:
	.stabn	68,0,223,.LM50-.LFBB10
.LM50:
.LFBB10:
	.stabn	68,0,225,.LM51-.LFBB10
.LM51:
	LD	r5,#1073746560
// inline asm begin
	// 225 "../src/kf32a9k1xxx_wwdt.c" 1
	SET [r5], #15
	.stabn	68,0,226,.LM52-.LFBB10
.LM52:
// inline asm end
	LD	r3,#1073746560
	MOV	r4,#4
.L59:
	...
	ANL	r5,r5,r4
	JNZ	.L59
	.stabn	68,0,227,.LM53-.LFBB10
.LM53:
	LD	r5,#1073746560
// inline asm begin
	// 227 "../src/kf32a9k1xxx_wwdt.c" 1
	CLR [r5], #15
	.stabn	68,0,228,.LM54-.LFBB10
.LM54:
// inline asm end
	JMP	lr
