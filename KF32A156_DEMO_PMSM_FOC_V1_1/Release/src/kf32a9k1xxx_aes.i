...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_aes.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 14 "../src/kf32a9k1xxx_aes.c" 2
# 23 "../src/kf32a9k1xxx_aes.c"
void
AES_Reset ()
{
...
# 39 "../src/kf32a9k1xxx_aes.c"
void
AES_Run_Enable(FunctionalState NewState)
{
...
# 55 "../src/kf32a9k1xxx_aes.c"
void
AES_High_Speed_Enable(FunctionalState NewState)
{
...
# 71 "../src/kf32a9k1xxx_aes.c"
void
AES_CBC_Mode_Select(uint32_t Mode)
{
...
# 88 "../src/kf32a9k1xxx_aes.c"
void
AES_TRNG_SCK_Select(uint32_t Source)
{

 CHECK_RESTRICTION(((Source) <= ((uint32_t)3)));

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)0x03<<((16))), Source << (16));
}
# 110 "../src/kf32a9k1xxx_aes.c"
void
AES_SCK_DIV_Select(uint32_t CLKDIV)
{

 CHECK_RESTRICTION(((CLKDIV) <= ((uint32_t)7)));
...
void
AES_RND_NUM_Config(uint32_t RNG_NUM)
{

 CHECK_RESTRICTION(((RNG_NUM) <= 0x1F));
...
void
AES_KEY_LEN_Config(uint32_t KEY_LEN)
{

 CHECK_RESTRICTION(((KEY_LEN) <= 0x07));

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)0x07<<((4))), KEY_LEN << (4));
}
# 155 "../src/kf32a9k1xxx_aes.c"
void
AES_SBOX_INV_Enable(uint32_t SBOXMODE)
{

 CHECK_RESTRICTION(((SBOXMODE) <= ((uint32_t)1)));

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((3))), SBOXMODE << (3));
}
# 171 "../src/kf32a9k1xxx_aes.c"
void
AES_ENCRYPT_Function_Enable(uint32_t EN_DECRYPT)
{

 CHECK_RESTRICTION(((EN_DECRYPT) <= ((uint32_t)1)));

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((2))), EN_DECRYPT << (2));
}
# 187 "../src/kf32a9k1xxx_aes.c"
void
AES_CUSTOMIZE_ALGORITHM_Enable(uint32_t ALGORITHM)
{

 CHECK_RESTRICTION(((ALGORITHM) <= ((uint32_t)1)));

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((1))), ALGORITHM << (1));
}
# 203 "../src/kf32a9k1xxx_aes.c"
void
AES_Enable(FunctionalState NewState)
{
...
# 219 "../src/kf32a9k1xxx_aes.c"
FlagStatus
AES_Get_INT_Flag(void)
{
...
# 252 "../src/kf32a9k1xxx_aes.c"
void
AES_INT_Enable(AbleStatus NewState)
{
