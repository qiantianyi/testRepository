...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_bkp.h" 2
...
# 16 "../src/kf32a9k1xxx_bkp.c" 2
# 26 "../src/kf32a9k1xxx_bkp.c"
void
BKP_Reset (void)
{
...
BKP_Pin_Effective_Level_Config (uint32_t PinSel, uint32_t Effective)
{
    ...
    CHECK_RESTRICTION((((PinSel) == ((uint32_t)0)) || ((PinSel) == ((uint32_t)1)) || ((PinSel) == ((uint32_t)2))));
    CHECK_RESTRICTION((((Effective) == ((uint32_t)0)) || ((Effective) == ((uint32_t)1))));
...
BKP_External_Clock_Bypass_Enable (uint32_t Source, FunctionalState NewState)
{
    ...
    CHECK_RESTRICTION((((Source) == ((uint32_t)1)) || ((Source) == ((uint32_t)0))));
    CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
BKP_Data_Config (uint32_t OrderNumber, uint32_t WriteData)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(OrderNumber) <= 7));
