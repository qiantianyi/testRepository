...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_btim.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_btim.c" 2
# 41 "../src/kf32a9k1xxx_btim.c"
void TIM_Reset (void* TIMx)
{

    CHECK_RESTRICTION(((((uint32_t)TIMx) == ((uint32_t)0x40000880)) || (((uint32_t)TIMx) == ((uint32_t)0x40000100)) || (((uint32_t)TIMx) == ((uint32_t)0x40000180)) || (((uint32_t)TIMx) == ((uint32_t)0x40000200)) || (((uint32_t)TIMx) == ((uint32_t)0x40000280)) || (((uint32_t)TIMx) == ((uint32_t)0x40000300)) || (((uint32_t)TIMx) == ((uint32_t)0x40000300)) || (((uint32_t)TIMx) == ((uint32_t)0x40001800)) || (((uint32_t)TIMx) == ((uint32_t)0x40001A80)) || (((uint32_t)TIMx) == ((uint32_t)0x40001B00)) || (((uint32_t)TIMx) == ((uint32_t)0x40001C00))));
...
void BTIM_Reset (BTIM_SFRmap* BTIMx)
{
    ...
    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
                    ...
                    BTIM_InitTypeDef* btimInitStruct)
{
    ...
    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
    CHECK_RESTRICTION(((((btimInitStruct->m_CounterMode) & 0x3F) == 0) && (((btimInitStruct->m_CounterMode) >> 9) == 0)));
    CHECK_RESTRICTION(((((btimInitStruct->m_Clock) & 0x7) == 0) && (((btimInitStruct->m_Clock) >> 5) == 0)));
    CHECK_RESTRICTION((((btimInitStruct->m_WorkMode) == ((uint32_t)0 << (1))) || ((btimInitStruct->m_WorkMode) == ((uint32_t)1 << (1)))));
    CHECK_RESTRICTION((((btimInitStruct->m_MasterMode) == ((uint32_t)0 << (2))) || ((btimInitStruct->m_MasterMode) == ((uint32_t)1 << (2))) || ((btimInitStruct->m_MasterMode) == ((uint32_t)2 << (2)))));
    CHECK_RESTRICTION((((btimInitStruct->m_SlaveMode) == ((uint32_t)0 << (4))) || ((btimInitStruct->m_SlaveMode) == ((uint32_t)4 << (4))) || ((btimInitStruct->m_SlaveMode) == ((uint32_t)5 << (4))) || ((btimInitStruct->m_SlaveMode) == ((uint32_t)6 << (4))) || ((btimInitStruct->m_SlaveMode) == ((uint32_t)7 << (4)))));
    CHECK_RESTRICTION((((btimInitStruct->m_EXPulseSync) == ((uint32_t)0 << (2))) || ((btimInitStruct->m_EXPulseSync) == ((uint32_t)1 << (2)))));
    CHECK_RESTRICTION((((btimInitStruct->m_MasterSlaveSync) == FALSE) || (btimInitStruct->m_MasterSlaveSync) == TRUE));
...
# 329 "../src/kf32a9k1xxx_btim.c"
void
BTIM_Counter_Mode_Config (BTIM_SFRmap* BTIMx, uint32_t CounterMode)
{

    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
    CHECK_RESTRICTION(((((CounterMode) & 0x3F) == 0) && (((CounterMode) >> 9) == 0)));
...
# 352 "../src/kf32a9k1xxx_btim.c"
void
BTIM_Clock_Config (BTIM_SFRmap* BTIMx, uint32_t NewClock)
{

    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
    CHECK_RESTRICTION(((((NewClock) & 0x7) == 0) && (((NewClock) >> 5) == 0)));
...
# 374 "../src/kf32a9k1xxx_btim.c"
void
BTIM_External_Pulse_Sync_Config (BTIM_SFRmap* BTIMx, uint32_t PulseSync)
{

    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
    CHECK_RESTRICTION((((PulseSync) == ((uint32_t)0 << (2))) || ((PulseSync) == ((uint32_t)1 << (2)))));
                    ...
                    uint32_t TriggerSelect)
{
    ...
    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
    CHECK_RESTRICTION((((TriggerSelect) == ((uint32_t)0 << (7))) || ((TriggerSelect) == ((uint32_t)1 << (7))) || ((TriggerSelect) == ((uint32_t)2 << (7))) || ((TriggerSelect) == ((uint32_t)3 << (7))) || ((TriggerSelect) == ((uint32_t)4 << (7))) || ((TriggerSelect) == ((uint32_t)6 << (7))) || ((TriggerSelect) == ((uint32_t)8 << (7))) || ((TriggerSelect) == ((uint32_t)9 << (7))) || ((TriggerSelect) == ((uint32_t)0xB << (7))) || ((TriggerSelect) == ((uint32_t)0xC << (7)))));
                    ...
                    uint32_t SlaveMode)
{
    ...
    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
    CHECK_RESTRICTION((((SlaveMode) == ((uint32_t)0 << (4))) || ((SlaveMode) == ((uint32_t)4 << (4))) || ((SlaveMode) == ((uint32_t)5 << (4))) || ((SlaveMode) == ((uint32_t)6 << (4))) || ((SlaveMode) == ((uint32_t)7 << (4)))));
                    ...
                    uint32_t MasterMode)
{
    ...
    CHECK_RESTRICTION(((BTIMx) == ((BTIM_SFRmap *)((uint32_t)0x40001800))));
    CHECK_RESTRICTION((((MasterMode) == ((uint32_t)0 << (2))) || ((MasterMode) == ((uint32_t)1 << (2))) || ((MasterMode) == ((uint32_t)2 << (2)))));
