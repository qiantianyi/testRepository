...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_dac.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_dac.c" 2
# 42 "../src/kf32a9k1xxx_dac.c"
void
DAC_Reset (DAC_SFRmap* DACx)
{

    CHECK_RESTRICTION((((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000700))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000780))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001D80))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001E00)))));
...
DAC_Configuration (DAC_SFRmap* DACx, DAC_InitTypeDef* dacInitStruct)
{
    ...
    CHECK_RESTRICTION((((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000700))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000780))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001D80))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001E00)))));
    CHECK_RESTRICTION((((dacInitStruct->m_TriggerEnable) == FALSE) || (dacInitStruct->m_TriggerEnable) == TRUE));
    CHECK_RESTRICTION(((((dacInitStruct->m_TriggerEvent) >> 8) == 0) && (((dacInitStruct->m_TriggerEvent) & 0xF) == 0)));
    CHECK_RESTRICTION((((dacInitStruct->m_TriggerDMAEnable) == FALSE) || (dacInitStruct->m_TriggerDMAEnable) == TRUE));
    CHECK_RESTRICTION((((dacInitStruct->m_Wave) == ((uint32_t)0<<(8))) || ((dacInitStruct->m_Wave) == ((uint32_t)1<<(8))) || ((dacInitStruct->m_Wave) == ((uint32_t)2<<(8)))));
    CHECK_RESTRICTION(((((dacInitStruct->m_Mas) >> ((10) + 4)) == 0) && (((dacInitStruct->m_Mas) << (32 - (10))) == 0)));
    CHECK_RESTRICTION((((dacInitStruct->m_Clock) == ((uint32_t)0<<(4))) || ((dacInitStruct->m_Clock) == ((uint32_t)1<<(4))) || ((dacInitStruct->m_Clock) == ((uint32_t)2<<(4)))));
    CHECK_RESTRICTION((((dacInitStruct->m_ClockDiv) == ((uint32_t)0<<(9))) || ((dacInitStruct->m_ClockDiv) == ((uint32_t)1<<(9))) || ((dacInitStruct->m_ClockDiv) == ((uint32_t)2<<(9))) || ((dacInitStruct->m_ClockDiv) == ((uint32_t)3<<(9))) || ((dacInitStruct->m_ClockDiv) == ((uint32_t)4<<(9))) || ((dacInitStruct->m_ClockDiv) == ((uint32_t)5<<(9))) || ((dacInitStruct->m_ClockDiv) == ((uint32_t)6<<(9))) || ((dacInitStruct->m_ClockDiv) == ((uint32_t)7<<(9)))));
    CHECK_RESTRICTION((((dacInitStruct->m_ReferenceVoltage) == ((uint32_t)0<<(1))) || ((dacInitStruct->m_ReferenceVoltage) == ((uint32_t)1<<(1))) || ((dacInitStruct->m_ReferenceVoltage) == ((uint32_t)2<<(1)))));
    CHECK_RESTRICTION((((dacInitStruct->m_OutputBuffer) == FALSE) || (dacInitStruct->m_OutputBuffer) == TRUE));
    CHECK_RESTRICTION((((dacInitStruct->m_OutputPin) == ((uint32_t)0 << (0))) || ((dacInitStruct->m_OutputPin) == ((uint32_t)1 << (0)))));
    CHECK_RESTRICTION((((dacInitStruct->m_Output) >> 12) == 0));
...
# 313 "../src/kf32a9k1xxx_dac.c"
void
DAC_Write_Output_Data (DAC_SFRmap* DACx, uint32_t Value)
{

    CHECK_RESTRICTION((((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000700))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000780))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001D80))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001E00)))));
    CHECK_RESTRICTION((((Value) >> 12) == 0));
...
# 354 "../src/kf32a9k1xxx_dac.c"
void
DAC_PCalibration_Direction_Config (DAC_SFRmap* DACx, uint32_t Direction)
{
    uint32_t tmpreg = 0;
...
void
DAC_PCalibration_Value_Config (DAC_SFRmap* DACx, uint32_t Value)
{
    uint32_t tmpreg = 0;
...
uint16_t
DAC_PCalibration_Value_Read (DAC_SFRmap* DACx)
{
    uint32_t tmpreg = 0;
...
# 409 "../src/kf32a9k1xxx_dac.c"
void
DAC_NCalibration_Direction_Config (DAC_SFRmap* DACx, uint32_t Direction)
{
    uint32_t tmpreg = 0;
...
void
DAC_NCalibration_Value_Config (DAC_SFRmap* DACx, uint32_t Value)
{
    uint32_t tmpreg = 0;
...
uint16_t
DAC_NCalibration_Value_Read (DAC_SFRmap* DACx)
{
    uint32_t tmpreg = 0;
...
uint8_t
DAC_TRIM_STATE_Value_Read (DAC_SFRmap* DACx)
{
    uint32_t tmpreg = 0;
...
# 480 "../src/kf32a9k1xxx_dac.c"
void
DAC_TRIMHI_Enable(DAC_SFRmap* DACx, FunctionalState NewState)
{
    uint32_t tmpreg = 0;
...
# 500 "../src/kf32a9k1xxx_dac.c"
void
DAC_TRIMLO_Enable(DAC_SFRmap* DACx, FunctionalState NewState)
{
    uint32_t tmpreg = 0;
...
# 522 "../src/kf32a9k1xxx_dac.c"
void
DAC_Test_Group_Config(DAC_SFRmap* DACx, uint32_t TestGroup)
{
    uint32_t tmpreg = 0;


    CHECK_RESTRICTION((((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000700))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40000780))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001D80))) || ((DACx) == ((DAC_SFRmap *) ((uint32_t)0x40001E00)))));
    CHECK_RESTRICTION(((TestGroup) <= 0x03));

    tmpreg = TestGroup << (1);
    DACx->CAL = SFR_Config(DACx->CAL, ~((uint32_t)0x03<<((1))), tmpreg);
}
# 542 "../src/kf32a9k1xxx_dac.c"
void
DAC_Test_Group_Enable(DAC_SFRmap* DACx, FunctionalState NewState)
{
    uint32_t tmpreg = 0;
