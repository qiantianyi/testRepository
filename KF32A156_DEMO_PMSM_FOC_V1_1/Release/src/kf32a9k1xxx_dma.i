...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_dma.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_dma.c" 2
# 41 "../src/kf32a9k1xxx_dma.c"
void
DMA_Reset (DMA_SFRmap* DMAx)
{

    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
                    ...
                    DMA_InitTypeDef* dmaInitStruct)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((dmaInitStruct->m_Channel) == ((uint32_t)0)) || ((dmaInitStruct->m_Channel) == ((uint32_t)1)) || ((dmaInitStruct->m_Channel) == ((uint32_t)2)) || ((dmaInitStruct->m_Channel) == ((uint32_t)3)) || ((dmaInitStruct->m_Channel) == ((uint32_t)4)) || ((dmaInitStruct->m_Channel) == ((uint32_t)5)) || ((dmaInitStruct->m_Channel) == ((uint32_t)6))));
    CHECK_RESTRICTION((((dmaInitStruct->m_Priority) == ((uint32_t)0<<(13))) || ((dmaInitStruct->m_Priority) == ((uint32_t)1<<(13))) || ((dmaInitStruct->m_Priority) == ((uint32_t)2<<(13))) || ((dmaInitStruct->m_Priority) == ((uint32_t)3<<(13)))));
    CHECK_RESTRICTION((((dmaInitStruct->m_Direction) == ((uint32_t)0<<(4))) || ((dmaInitStruct->m_Direction) == ((uint32_t)1<<(4)))));
    CHECK_RESTRICTION((((dmaInitStruct->m_PeripheralDataSize) == ((uint32_t)0)) || ((dmaInitStruct->m_PeripheralDataSize) == ((uint32_t)1)) || ((dmaInitStruct->m_PeripheralDataSize) == ((uint32_t)2))));
    CHECK_RESTRICTION((((dmaInitStruct->m_MemoryDataSize) == ((uint32_t)0)) || ((dmaInitStruct->m_MemoryDataSize) == ((uint32_t)1)) || ((dmaInitStruct->m_MemoryDataSize) == ((uint32_t)2))));
    CHECK_RESTRICTION((((dmaInitStruct->m_PeripheralInc) == FALSE) || (dmaInitStruct->m_PeripheralInc) == TRUE));
    CHECK_RESTRICTION((((dmaInitStruct->m_MemoryInc) == FALSE) || (dmaInitStruct->m_MemoryInc) == TRUE));
    CHECK_RESTRICTION((((dmaInitStruct->m_LoopMode) == FALSE) || (dmaInitStruct->m_LoopMode) == TRUE));
    CHECK_RESTRICTION((((dmaInitStruct->m_BlockMode) == ((uint32_t)0<<(3))) || ((dmaInitStruct->m_BlockMode) == ((uint32_t)1<<(3)))));

    tmpchannel = dmaInitStruct->m_Channel;
# 102 "../src/kf32a9k1xxx_dma.c"
                    ...
                    uint32_t Channel, uint16_t Number)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((Channel) == ((uint32_t)0)) || ((Channel) == ((uint32_t)1)) || ((Channel) == ((uint32_t)2)) || ((Channel) == ((uint32_t)3)) || ((Channel) == ((uint32_t)4)) || ((Channel) == ((uint32_t)5)) || ((Channel) == ((uint32_t)6))));
                    ...
                    uint32_t Channel, uint32_t Priority)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((Channel) == ((uint32_t)0)) || ((Channel) == ((uint32_t)1)) || ((Channel) == ((uint32_t)2)) || ((Channel) == ((uint32_t)3)) || ((Channel) == ((uint32_t)4)) || ((Channel) == ((uint32_t)5)) || ((Channel) == ((uint32_t)6))));
    CHECK_RESTRICTION((((Priority) == ((uint32_t)0<<(13))) || ((Priority) == ((uint32_t)1<<(13))) || ((Priority) == ((uint32_t)2<<(13))) || ((Priority) == ((uint32_t)3<<(13)))));
                    ...
                    uint32_t Channel, uint32_t Width)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((Channel) == ((uint32_t)0)) || ((Channel) == ((uint32_t)1)) || ((Channel) == ((uint32_t)2)) || ((Channel) == ((uint32_t)3)) || ((Channel) == ((uint32_t)4)) || ((Channel) == ((uint32_t)5)) || ((Channel) == ((uint32_t)6))));
    CHECK_RESTRICTION((((Width) == ((uint32_t)0)) || ((Width) == ((uint32_t)1)) || ((Width) == ((uint32_t)2))));
                    ...
                    uint32_t Channel, uint32_t Direction)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((Channel) == ((uint32_t)0)) || ((Channel) == ((uint32_t)1)) || ((Channel) == ((uint32_t)2)) || ((Channel) == ((uint32_t)3)) || ((Channel) == ((uint32_t)4)) || ((Channel) == ((uint32_t)5)) || ((Channel) == ((uint32_t)6))));
    CHECK_RESTRICTION((((Direction) == ((uint32_t)0<<(4))) || ((Direction) == ((uint32_t)1<<(4)))));
                    ...
                    uint32_t Channel, uint32_t BlockMode)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((Channel) == ((uint32_t)0)) || ((Channel) == ((uint32_t)1)) || ((Channel) == ((uint32_t)2)) || ((Channel) == ((uint32_t)3)) || ((Channel) == ((uint32_t)4)) || ((Channel) == ((uint32_t)5)) || ((Channel) == ((uint32_t)6))));
    CHECK_RESTRICTION((((BlockMode) == ((uint32_t)0<<(3))) || ((BlockMode) == ((uint32_t)1<<(3)))));
...
DMA_Get_INT_Flag (DMA_SFRmap* DMAx, uint32_t Channel, uint32_t InterruptType)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((Channel) == ((uint32_t)0)) || ((Channel) == ((uint32_t)1)) || ((Channel) == ((uint32_t)2)) || ((Channel) == ((uint32_t)3)) || ((Channel) == ((uint32_t)4)) || ((Channel) == ((uint32_t)5)) || ((Channel) == ((uint32_t)6))));
    CHECK_RESTRICTION((((InterruptType) == ((uint32_t)1)) || ((InterruptType) == ((uint32_t)2)) || ((InterruptType) == ((uint32_t)4))));
                    ...
                    uint32_t Channel, uint32_t InterruptType)
{
    ...
    CHECK_RESTRICTION((((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001600))) || ((DMAx) == ((DMA_SFRmap *) ((uint32_t)0x40001700)))));
    CHECK_RESTRICTION((((Channel) == ((uint32_t)0)) || ((Channel) == ((uint32_t)1)) || ((Channel) == ((uint32_t)2)) || ((Channel) == ((uint32_t)3)) || ((Channel) == ((uint32_t)4)) || ((Channel) == ((uint32_t)5)) || ((Channel) == ((uint32_t)6))));
    CHECK_RESTRICTION((((InterruptType) & (~(((uint32_t)1) | ((uint32_t)2) | ((uint32_t)4)))) == 0));


    tmpmask = InterruptType << (Channel * 3);
    DMAx->LIFR &= ~tmpmask;
}
# 825 "../src/kf32a9k1xxx_dma.c"
void
