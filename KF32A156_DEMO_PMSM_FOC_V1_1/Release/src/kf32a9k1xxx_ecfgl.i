...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_ecfgl.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_ecfgl.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 11 "../src/kf32a9k1xxx_ecfgl.c" 2
# 21 "../src/kf32a9k1xxx_ecfgl.c"
void
ECFGL_Reset (void)
{
...
ECFGL_Output_Enable(uint32_t ECFGLx, FunctionalState NewState)
{
 ...
 CHECK_RESTRICTION(((ECFGLx) <= ((uint32_t)15)));
...
ECFGL_Function_Select(uint32_t ECFGLx, uint32_t Function)
{
 ...
 CHECK_RESTRICTION(((ECFGLx) <= ((uint32_t)15)));
 CHECK_RESTRICTION(((Function) <= ((uint32_t)15)));
...
ECFGLx_Clear_INT_Flag(uint32_t ECFGLx)
{
 ...
 while((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->IF) & tmask);
