...
# 8 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_ewdt.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 11 "../src/kf32a9k1xxx_ewdt.c" 2
# 21 "../src/kf32a9k1xxx_ewdt.c"
void
EWDT_Reset (void)
{
...
EWDT_Clear_Reset_INT_Flag(void)
{
 ...
 while((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) & ((uint32_t)1<<((23))));
...
EWDT_Clear_Count40_INT_Flag(void)
{
 ...
 while((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) & ((uint32_t)1<<((2))));
...
EWDT_Clock_Div_Select(uint32_t CLK_DIV)
{
 ...
 CHECK_RESTRICTION(((CLK_DIV) <= ((uint32_t)18)));
