...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_exic.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_exic.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 11 "../src/kf32a9k1xxx_exic.c" 2
# 37 "../src/kf32a9k1xxx_exic.c"
void
EXIC_Reset (void)
{
...
EXIC_Configuration (EXIC_InitTypeDef* EXICInitStruct)
{
 ...
 CHECK_RESTRICTION((((EXICInitStruct->m_Module_Enable) == FALSE) || (EXICInitStruct->m_Module_Enable) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_CS_Enable) == FALSE) || (EXICInitStruct->m_CS_Enable) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_Data_Control_Sel) == ( (uint32_t) 0x0 << (2) )) || ((EXICInitStruct->m_Data_Control_Sel) == ( (uint32_t) 0x1 << (2) )) ));
 CHECK_RESTRICTION((((EXICInitStruct->m_Write_Enable) == FALSE) || (EXICInitStruct->m_Write_Enable) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_Read_Enable) == FALSE) || (EXICInitStruct->m_Read_Enable) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_DMA_Write_EN) == FALSE) || (EXICInitStruct->m_DMA_Write_EN) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_DMA_Read_EN) == FALSE) || (EXICInitStruct->m_DMA_Read_EN) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_WriteFnish_INT_EN) == FALSE) || (EXICInitStruct->m_WriteFnish_INT_EN) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_ReadFnish_INT_EN) == FALSE) || (EXICInitStruct->m_ReadFnish_INT_EN) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_WriteData_EN) == FALSE) || (EXICInitStruct->m_WriteData_EN) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_ReadData_EN) == FALSE) || (EXICInitStruct->m_ReadData_EN) == TRUE));
 CHECK_RESTRICTION((((EXICInitStruct->m_Data_Direction_Sel) == ( (uint32_t) 0x1 << (30) )) || ((EXICInitStruct->m_Data_Direction_Sel) == ( (uint32_t) 0x0 << (30) )) ));
 CHECK_RESTRICTION((((EXICInitStruct->m_Mode_Sel) == ( (uint32_t) 0x1 << (31) )) || ((EXICInitStruct->m_Mode_Sel) == ( (uint32_t) 0x0 << (31) )) ));
 CHECK_RESTRICTION((((EXICInitStruct->m_Source_Clock_Sel) == ( (uint32_t) 0x0 << (0) )) || ((EXICInitStruct->m_Source_Clock_Sel) == ( (uint32_t) 0x1 << (0) )) || ((EXICInitStruct->m_Source_Clock_Sel) == ( (uint32_t) 0x2 << (0) )) ));
 CHECK_RESTRICTION((((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x0 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x1 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x2 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x3 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x4 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x5 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x6 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x7 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x8 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0x9 << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0xA << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0xB << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0xC << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0xD << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0xE << (4) )) ||((EXICInitStruct->m_Pulse_Width_Sel) == ( (uint32_t) 0xF << (4) )) ));
# 86 "../src/kf32a9k1xxx_exic.c"
