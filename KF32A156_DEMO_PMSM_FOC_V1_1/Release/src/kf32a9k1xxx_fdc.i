...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_fdc.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_fdc.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 10 "../src/kf32a9k1xxx_fdc.c" 2
# 21 "../src/kf32a9k1xxx_fdc.c"
void
FDC_Reset(FDC_SFRmap* FDCx)
{

 CHECK_RESTRICTION((((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002B80))) || ((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002C00))) || ((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002C80)))));
...
FDC_Clear_MDLIF_Flag(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 ...
 while(!(FDCx->CTL & ((uint32_t)1<<((23)))));
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((23))), 0);
}
# 121 "../src/kf32a9k1xxx_fdc.c"
void
...
FDC_Updata_Mode_Select(FDC_SFRmap* FDCx, uint32_t MODE)
{
 ...
 CHECK_RESTRICTION((((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002B80))) || ((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002C00))) || ((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002C80)))));
 CHECK_RESTRICTION(((MODE) <= ((uint32_t)3)));

 tmpreg = MODE << (19);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)0x03<<((19))), tmpreg);
}
# 183 "../src/kf32a9k1xxx_fdc.c"
void
   ...
   uint32_t Channel, uint8_t n, FunctionalState NewState)
{
 ...
 CHECK_RESTRICTION((((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002B80))) || ((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002C00))) || ((FDCx) == ((FDC_SFRmap *) ((uint32_t) 0x40002C80)))));
 CHECK_RESTRICTION(((Channel) <= ((uint32_t)3)));
 CHECK_RESTRICTION(((n)<=4));
 CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
