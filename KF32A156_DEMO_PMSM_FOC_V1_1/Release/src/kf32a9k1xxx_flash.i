...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_flash.h"
...
# 13 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_flash.h" 2
...
# 8 "../src/kf32a9k1xxx_flash.c" 2
# 41 "../src/kf32a9k1xxx_flash.c"
...
FLASH_Zone_Config(uint32_t ZoneSelect)
{
    ...
    CHECK_RESTRICTION((((ZoneSelect) == ((uint32_t)0<<(4))) || ((ZoneSelect) == ((uint32_t)1<<(4)))));
...
FLASH_Wipe_Configuration (uint32_t WipeMode,uint32_t WipeAddr)
{
    ...
    CHECK_RESTRICTION((((WipeMode) == ((uint32_t)0)) || ((WipeMode) == ((uint32_t)1)) || ((WipeMode) == ((uint32_t)2))));
    CHECK_RESTRICTION((((uint32_t)(WipeAddr) >> 20) == 0));
...
FLASH_Program_Configuration (FLASH_ProgramTypeDef * flashProgramStruct)
{
 ...
 CHECK_RESTRICTION((((flashProgramStruct->m_Mode) == ((uint32_t)0x15)) || ((flashProgramStruct->m_Mode) == ((uint32_t)0x05))));
 CHECK_RESTRICTION((((flashProgramStruct->m_Zone) == ((uint32_t)0)) || ((flashProgramStruct->m_Zone) == ((uint32_t)1))));
 CHECK_RESTRICTION((((uint32_t)(flashProgramStruct->m_Addr) >> 20) == 0));
 CHECK_RESTRICTION((((uint32_t)(flashProgramStruct->m_WriteSize) >> 6) == 0));
...
{
 uint32_t *read_adr;
 CHECK_RESTRICTION((((ZoneSelect) == ((uint32_t)0)) || ((ZoneSelect) == ((uint32_t)1))));
...
# 1345 "../src/kf32a9k1xxx_flash.c"
FlagStatus
CACHE_Get_CACHE_ECC_Error_Flag(void)
{
...
FlagStatus
CACHE_Get_FLASH_ECC_Error_Flag(void)
{
...
void
CACHE_RAM_Check_ECC_Error_INT_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
void
CACHE_CACHE_Check_ECC_Error_INT_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
void
CACHE_FLASH_Check_ECC_Error_INT_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
void
CACHE_CACHE_Check_ECC_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
void
CACHE_Instruction_CACHE_Read_2Row_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
void
CACHE_Instruction_CACHE_Write_2Row_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
void
CACHE_CACHE_Reset_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
void
CACHE_CACHE_Enable(FunctionalState NewState)
{
 uint32_t tmpreg = 0;
