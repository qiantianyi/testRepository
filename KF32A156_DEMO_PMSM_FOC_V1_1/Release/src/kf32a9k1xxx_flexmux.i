...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_flexmux.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_flexmux.h" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 10 "../src/kf32a9k1xxx_flexmux.c" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 11 "../src/kf32a9k1xxx_flexmux.c" 2
...
# 35 "../src/kf32a9k1xxx_flexmux.c"
void
FMUX_Channel_Enable(uint32_t Channel, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
# 166 "../src/kf32a9k1xxx_flexmux.c"
void
FMUX_Channel_Triggle_Source_Select(uint32_t Channel, uint32_t Source)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
 ...
 CHECK_RESTRICTION(((Channel) <= ((uint32_t)3)));
 CHECK_RESTRICTION((((Source) <= ((uint32_t)118)) && ((Source) != 36) && ((Source) != 37) && ((Source) != 38) && ((Source) != 39) && ((Source) != 40) && ((Source) != 41) && ((Source) != 63) && ((Source) != 64) && ((Source) != 65) && ((Source) != 66) && ((Source) != 111)));

 tmpreg = Source << Channel*8;
 tmask = ((uint32_t)0x7F<<((0))) << Channel*8;
 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->SOU) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->SOU), ~tmask, tmpreg);
}
# 188 "../src/kf32a9k1xxx_flexmux.c"
void
FMUX_Enable(FunctionalState NewState)
{
...
# 206 "../src/kf32a9k1xxx_flexmux.c"
void
FMUX_Output_Channel_DMA_Enable(uint32_t Channel, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
# 232 "../src/kf32a9k1xxx_flexmux.c"
void
FMUX_Triggle_Single_Maintain_Time_Select(uint32_t Channel, uint32_t DIV)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
# 258 "../src/kf32a9k1xxx_flexmux.c"
void
FMUX_Output_Select(uint32_t Channel, uint32_t MODE)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
void
FMUX_Work_CLK_Select(uint32_t CLK)
{
