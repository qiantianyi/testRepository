...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_gpio.c" 2
# 27 "../src/kf32a9k1xxx_gpio.c"
void
GPIO_Reset (GPIO_SFRmap * GPIOx)
{

 CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
...
GPIO_Configuration (GPIO_SFRmap* GPIOx, GPIO_InitTypeDef* gpioInitStruct)
{
    ...
    CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
    CHECK_RESTRICTION((((gpioInitStruct->m_Pin) >> 16 ) == (uint32_t)0x00));
    CHECK_RESTRICTION((((gpioInitStruct->m_Mode) == GPIO_MODE_IN) || ((gpioInitStruct->m_Mode) == GPIO_MODE_OUT) || ((gpioInitStruct->m_Mode) == GPIO_MODE_RMP) || ((gpioInitStruct->m_Mode) == GPIO_MODE_AN)));
    CHECK_RESTRICTION((((gpioInitStruct->m_Speed) == GPIO_LOW_SPEED) || ((gpioInitStruct->m_Speed) == GPIO_HIGH_SPEED)));
    CHECK_RESTRICTION((((gpioInitStruct->m_PullUp) == GPIO_NOPULL) || ((gpioInitStruct->m_PullUp) == GPIO_PULLUP)));
    CHECK_RESTRICTION((((gpioInitStruct->m_PullDown) == GPIO_NOPULL) || ((gpioInitStruct->m_PullDown) == GPIO_PULLUP)));
     ...
     if(currentpin == pos)
     {
      ...
      GPIOx->PMOD = SFR_Config(GPIOx->PMOD,
                ...
                || (gpioInitStruct->m_Mode == GPIO_MODE_RMP))
            {
                ...
                CHECK_RESTRICTION((((gpioInitStruct->m_OpenDrain) == GPIO_POD_PP) || ((gpioInitStruct->m_OpenDrain) == GPIO_POD_OD)));
    ...
    uint16_t GpioPin, FunctionalState NewState)
{
 ...
 CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
 CHECK_RESTRICTION((((GpioPin) >> 16 ) == (uint32_t)0x00));
     ...
     uint16_t GpioPin, GPIOPOD_TypeDef NewState)
{
 ...
 CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
 CHECK_RESTRICTION((((GpioPin) >> 16 ) == (uint32_t)0x00));
 CHECK_RESTRICTION((((NewState) == GPIO_POD_PP) || ((NewState) == GPIO_POD_OD)));
     ...
     uint16_t GpioPin, GPIOMode_TypeDef NewState)
{
 ...
 CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
 CHECK_RESTRICTION((((GpioPin) >> 16 ) == (uint32_t)0x00));
 CHECK_RESTRICTION((((NewState) == GPIO_MODE_IN) || ((NewState) == GPIO_MODE_OUT) || ((NewState) == GPIO_MODE_RMP) || ((NewState) == GPIO_MODE_AN)));
    ...
    uint16_t GpioPin, GPIOSpeed_TypeDef NewState)
{
 ...
 CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
 CHECK_RESTRICTION((((GpioPin) >> 16 ) == (uint32_t)0x00));
 CHECK_RESTRICTION((((NewState) == GPIO_LOW_SPEED) || ((NewState) == GPIO_HIGH_SPEED)));
                    ...
                    uint16_t GpioPin, BitAction BitsValue)
{
    ...
    CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
    CHECK_RESTRICTION((((GpioPin) >> 16 ) == (uint32_t)0x00));
    CHECK_RESTRICTION((((BitsValue) == Bit_RESET) || ((BitsValue) == Bit_SET)));
...
GPIO_Pin_RMP_Config(GPIO_SFRmap* GPIOx, uint16_t GpioPinNum, uint32_t PinRemap)
{
    ...
    CHECK_RESTRICTION((((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000000))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000040))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000080))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500000C0))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000100))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000140))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x50000180))) || ((GPIOx) == ((GPIO_SFRmap *) ((uint32_t)0x500001C0)))));
    CHECK_RESTRICTION(((GpioPinNum) <= ((uint32_t)0xF)));
    switch(PageNum)
    {
    case 0x01:
     CHECK_RESTRICTION((((PinRemap) <= ((uint32_t)0x010F)) && ((PinRemap) >= ((uint32_t)0x0100))));
     break;
    case 0x02:
     CHECK_RESTRICTION((((PinRemap) <= ((uint32_t)0x020C)) && ((PinRemap) >= ((uint32_t)0x0200))));
     break;
    case 0x03:
     CHECK_RESTRICTION((((PinRemap) <= ((uint32_t)0x030E)) && ((PinRemap) >= ((uint32_t)0x0300))));
     break;
    default:break;
    }
...
# 783 "../src/kf32a9k1xxx_gpio.c"
void
FlexRM_Channel_Direction_Select(uint32_t Channel, uint32_t Direction)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;


 CHECK_RESTRICTION(((Channel) <= ((uint32_t)11)));
...
# 817 "../src/kf32a9k1xxx_gpio.c"
void
FlexRM_Group_Enable(uint32_t Group, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;


 CHECK_RESTRICTION(((Group) <= ((uint32_t)11)));
 CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
# 864 "../src/kf32a9k1xxx_gpio.c"
void
FlexRM_Group_Function_Select(uint32_t Group, uint32_t Port)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
 ...
 CHECK_RESTRICTION(((Group) <= ((uint32_t)11)));
 CHECK_RESTRICTION(((Port) <= ((uint32_t)15)));
...
# 918 "../src/kf32a9k1xxx_gpio.c"
void
FlexRM_Group_Output_Select(uint32_t Group, uint32_t Channel)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
# 978 "../src/kf32a9k1xxx_gpio.c"
void
FlexRM_Group_Input_Select(uint32_t Group, uint32_t Channel)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
