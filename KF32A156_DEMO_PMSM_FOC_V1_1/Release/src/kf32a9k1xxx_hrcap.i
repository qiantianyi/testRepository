...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_hrcap.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_hrcap.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 11 "../src/kf32a9k1xxx_hrcap.c" 2
# 21 "../src/kf32a9k1xxx_hrcap.c"
void
HRCAP_Reset (HRCAP_SFRmap* HRCAPx)
{

 CHECK_RESTRICTION((((HRCAPx) == ((HRCAP_SFRmap *) ((uint32_t)0x40002400))) || ((HRCAPx) == ((HRCAP_SFRmap *) ((uint32_t)0x40002480))) || ((HRCAPx) == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))));
...
# 65 "../src/kf32a9k1xxx_hrcap.c"
void
HRCAP_CLK_Select(HRCAP_SFRmap* HRCAPx, uint32_t CLK)
{
 uint32_t tmpreg = 0;
...
# 100 "../src/kf32a9k1xxx_hrcap.c"
void
HRCAP_Software_Reset_Enable(HRCAP_SFRmap* HRCAPx, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
...
# 138 "../src/kf32a9k1xxx_hrcap.c"
void
HRCAP_INT_Enable(HRCAP_SFRmap* HRCAPx,
...
# 177 "../src/kf32a9k1xxx_hrcap.c"
void
HRCAP_Cap_Input_Select(HRCAP_SFRmap* HRCAPx, uint32_t Select)
{
...
uint16_t
HRCAP_Read_Latch_Count_Value(HRCAP_SFRmap* HRCAPx)
{
 uint32_t Value = 0;
...
uint16_t
HRCAP_Read_Count_Value(HRCAP_SFRmap* HRCAPx)
{
 uint32_t Value = 0;
...
# 276 "../src/kf32a9k1xxx_hrcap.c"
uint16_t
HRCAP_Read_Rise_Integer_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 uint32_t Value = 0;


 CHECK_RESTRICTION((((HRCAPx) == ((HRCAP_SFRmap *) ((uint32_t)0x40002400))) || ((HRCAPx) == ((HRCAP_SFRmap *) ((uint32_t)0x40002480))) || ((HRCAPx) == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))));
 CHECK_RESTRICTION(((HRCAP_REG) <= ((uint32_t)1)));

 Value = HRCAPx->RISE[HRCAP_REG] & ((uint32_t)0xFFFF<<((0)));

 return Value;
}
# 297 "../src/kf32a9k1xxx_hrcap.c"
uint16_t
HRCAP_Read_Fall_Integer_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 uint32_t Value = 0;
...
# 318 "../src/kf32a9k1xxx_hrcap.c"
uint16_t
HRCAP_Read_Rise_Decimal_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 uint32_t Value = 0;
...
# 339 "../src/kf32a9k1xxx_hrcap.c"
uint16_t
HRCAP_Read_Fall_Decimal_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 uint32_t Value = 0;
...
# 363 "../src/kf32a9k1xxx_hrcap.c"
FlagStatus
HRCAP_Get_INT_Flag(HRCAP_SFRmap* HRCAPx, uint32_t Select)
{
 uint32_t Value = 0;
 uint32_t tmask = 0;
...
# 403 "../src/kf32a9k1xxx_hrcap.c"
void
HRCAP_Clear_INT_Flag(HRCAP_SFRmap* HRCAPx, uint32_t Select)
{
 uint32_t tmask = 0;
 ...
 while(HRCAPx->SR & tmask);
 HRCAPx->SRIC = SFR_Config(HRCAPx->SRIC, ~tmask, 0);
}
# 429 "../src/kf32a9k1xxx_hrcap.c"
void
HRCAP_INT_Mandatory_Enable(HRCAP_SFRmap* HRCAPx, uint32_t Select, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
