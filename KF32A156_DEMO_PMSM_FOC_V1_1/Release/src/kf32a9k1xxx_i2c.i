...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_i2c.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_i2c.c" 2
# 37 "../src/kf32a9k1xxx_i2c.c"
void
I2C_Reset (I2C_SFRmap* I2Cx)
{

    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
...
I2C_Configuration (I2C_SFRmap* I2Cx, I2C_InitTypeDef* i2cInitStruct)
{
    ...
    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION((((i2cInitStruct->m_Mode) == ((uint32_t)0<<(24))) || ((i2cInitStruct->m_Mode) == ((uint32_t)1<<(24)))));
    CHECK_RESTRICTION((((i2cInitStruct->m_ClockSource) == ((uint32_t)0<<(16))) || ((i2cInitStruct->m_ClockSource) == ((uint32_t)1<<(16))) || ((i2cInitStruct->m_ClockSource) == ((uint32_t)2<<(16)))));
    CHECK_RESTRICTION((((i2cInitStruct->m_BADR10) == ((uint32_t)0<<(1)) ) || ((i2cInitStruct->m_BADR10) == ((uint32_t)1<<(1)) )));
    CHECK_RESTRICTION((((i2cInitStruct->m_MasterSlave) == ((uint32_t)0<<(25))) || ((i2cInitStruct->m_MasterSlave) == ((uint32_t)1<<(25)))));
    CHECK_RESTRICTION((((i2cInitStruct->m_AckEn) == FALSE) || (i2cInitStruct->m_AckEn) == TRUE));
    CHECK_RESTRICTION((((i2cInitStruct->m_AckData) == ((uint32_t)0<<(13))) || ((i2cInitStruct->m_AckData) == ((uint32_t)1<<(13)))));
# 100 "../src/kf32a9k1xxx_i2c.c"
...
# 296 "../src/kf32a9k1xxx_i2c.c"
void
I2C_Ack_DATA_Config (I2C_SFRmap* I2Cx, uint32_t NewState)
{

    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION((((NewState) == ((uint32_t)0<<(13))) || ((NewState) == ((uint32_t)1<<(13)))));
...
# 350 "../src/kf32a9k1xxx_i2c.c"
void
I2C_Clock_Config (I2C_SFRmap* I2Cx,uint32_t ClkSource)
{

    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION((((ClkSource) == ((uint32_t)0<<(16))) || ((ClkSource) == ((uint32_t)1<<(16))) || ((ClkSource) == ((uint32_t)2<<(16)))));
...
# 475 "../src/kf32a9k1xxx_i2c.c"
void
I2C_SMBT_Config(I2C_SFRmap* I2Cx, uint32_t NewState)
{

    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION((((NewState) == ((uint32_t)0<<(25))) || ((NewState) == ((uint32_t)1<<(25)))));
...
I2C_SendData (I2C_SFRmap* I2Cx, uint32_t Data)
{
    ...
    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION((((uint32_t)(Data) >> 10) == 0));
...
I2C_ADDR_Config(I2C_SFRmap* I2Cx, uint32_t AddrSelect, uint32_t Data)
{
    ...
    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION((((AddrSelect) >= 0) && ((AddrSelect) <= 3)));
    CHECK_RESTRICTION((((uint32_t)(Data) >> 10) == 0));
...
I2C_MSK_Config(I2C_SFRmap* I2Cx, uint32_t AddrSelect, uint32_t DataMask)
{
    ...
    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION((((AddrSelect) >= 0) && ((AddrSelect) <= 3)));
    CHECK_RESTRICTION((((uint32_t)(DataMask) >> 10) == 0));
...
I2C_CLOCK_Div_Config(I2C_SFRmap* I2Cx, uint32_t DIV)
{
    ...
    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
    CHECK_RESTRICTION(((DIV) <= ((uint32_t)3)));

    tmpreg = DIV << (18);
    I2Cx->CTLR = SFR_Config(I2Cx->CTLR, ~((uint32_t)3<<((18))), tmpreg);
}
# 739 "../src/kf32a9k1xxx_i2c.c"
void
I2C_Keep_Data_Time_Config(I2C_SFRmap* I2Cx, uint32_t Time)
{
    ...
    CHECK_RESTRICTION((((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000D80))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40000E00))) || ((I2Cx) == ((I2C_SFRmap *) ((uint32_t)0x40002380)))));
 CHECK_RESTRICTION((((Time) <= ((uint32_t)15)) && ((Time) >= ((uint32_t)0))));

    tmpreg = Time << (2);
    I2Cx->CTLR = SFR_Config(I2Cx->CTLR, ~((uint32_t)0x0F<<((2))), tmpreg);
}
# 766 "../src/kf32a9k1xxx_i2c.c"
void
