...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_int.h" 2
...
# 15 "../src/kf32a9k1xxx_int.c" 2
# 24 "../src/kf32a9k1xxx_int.c"
uint8_t
...
# 93 "../src/kf32a9k1xxx_int.c"
void
INT_Stack_Align_Config (uint32_t StackAlign)
{
    CHECK_RESTRICTION((((StackAlign) == ((uint32_t)0<<((7)))) || ((StackAlign) == ((uint32_t)1<<((7))))));
...
# 191 "../src/kf32a9k1xxx_int.c"
void
INT_Priority_Group_Config (uint32_t PriorityGroup)
{

    CHECK_RESTRICTION((((PriorityGroup) == ((uint32_t)0<<((1)))) || ((PriorityGroup) == ((uint32_t)1<<((1)))) || ((PriorityGroup) == ((uint32_t)2<<((1)))) || ((PriorityGroup) == ((uint32_t)3<<((1))))));
...
INT_Interrupt_Enable (InterruptIndex Peripheral, FunctionalState NewState)
{
 ...
 uint32_t tmpreg = 0x00;
    ...
    CHECK_RESTRICTION(((Peripheral) <= INT_USART7));
    CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
                    ...
                    uint32_t Preemption, uint32_t SubPriority)
{
    ...
    CHECK_RESTRICTION(((Peripheral) <= INT_USART7));
    CHECK_RESTRICTION(((((tmpreg) == ((uint32_t)0<<((1)))) && ((Preemption) <= 7) && ((SubPriority) <= 1)) || (((tmpreg) == ((uint32_t)1<<((1)))) && ((Preemption) <= 3) && ((SubPriority) <= 3)) || (((tmpreg) == ((uint32_t)2<<((1)))) && ((Preemption) <= 1) && ((SubPriority) <= 7)) || (((tmpreg) == ((uint32_t)3<<((1)))) && ((Preemption) <= 0) && ((SubPriority) <= 15))));
...
INT_Stack_Delay_Enable (uint8_t IntDelay)
{
 ...
 CHECK_RESTRICTION((((IntDelay) >> 0x08) == 0x00));
...
INT_External_Configuration (EINT_InitTypeDef* eintInitStruct)
{
 uint32_t tmpreg = 0;
    ...
    CHECK_RESTRICTION((((eintInitStruct->m_Line) >= 0) && ((eintInitStruct->m_Line) <= 21)));
    CHECK_RESTRICTION((((eintInitStruct->m_Mask) == FALSE) || (eintInitStruct->m_Mask) == TRUE));
    CHECK_RESTRICTION((((eintInitStruct->m_Rise) == FALSE) || (eintInitStruct->m_Rise) == TRUE));
    CHECK_RESTRICTION((((eintInitStruct->m_Fall) == FALSE) || (eintInitStruct->m_Fall) == TRUE));
    CHECK_RESTRICTION((((eintInitStruct->m_Source) >= ((uint32_t)0)) && ((eintInitStruct->m_Source) <= ((uint32_t)8))));
...
# 689 "../src/kf32a9k1xxx_int.c"
FlagStatus
INT_Get_External_Flag (uint32_t EintNum)
{

    CHECK_RESTRICTION((((EintNum) >= 0) && ((EintNum) <= 21)));
...
INT_External_Clear_Flag (uint32_t EintNum)
{
    ...
    while(((((INT_SFRmap *)((uint32_t)0x40200000))->EINTF) & tmpreg)>>(EintNum))
    {
     (((INT_SFRmap *)((uint32_t)0x40200000))->EINTF) &= ~tmpreg;
    }
}
# 756 "../src/kf32a9k1xxx_int.c"
void
INT_External_Source_Enable (uint32_t EintNum, uint32_t PeripheralSource)
{
    ...
    CHECK_RESTRICTION((((EintNum) >= 0) && ((EintNum) <= 21)));
    CHECK_RESTRICTION((((PeripheralSource) >= ((uint32_t)0)) && ((PeripheralSource) <= ((uint32_t)8))));
