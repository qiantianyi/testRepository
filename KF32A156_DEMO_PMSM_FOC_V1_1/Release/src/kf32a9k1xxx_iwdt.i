...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_iwdt.h" 2
...
# 14 "../src/kf32a9k1xxx_iwdt.c" 2
# 39 "../src/kf32a9k1xxx_iwdt.c"
void
IWDT_Prescaler_Config (uint32_t Prescaler)
{

    CHECK_RESTRICTION((((Prescaler) == ((uint32_t)0x0<<(0))) || ((Prescaler) == ((uint32_t)0x1<<(0))) || ((Prescaler) == ((uint32_t)0x2<<(0))) || ((Prescaler) == ((uint32_t)0x3<<(0))) || ((Prescaler) == ((uint32_t)0x4<<(0))) || ((Prescaler) == ((uint32_t)0x5<<(0))) || ((Prescaler) == ((uint32_t)0x6<<(0))) || ((Prescaler) == ((uint32_t)0x7<<(0))) || ((Prescaler) == ((uint32_t)0x8<<(0))) || ((Prescaler) == ((uint32_t)0x9<<(0))) || ((Prescaler) == ((uint32_t)0xA<<(0))) || ((Prescaler) == ((uint32_t)0xB<<(0)))));


    (((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL) = SFR_Config ((((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL), ~((uint32_t)0xF<<((0))), Prescaler);
}
# 56 "../src/kf32a9k1xxx_iwdt.c"
void
IWDT_SCK_Source_Select(uint32_t Source)
{

 CHECK_RESTRICTION(((Source) <= ((uint32_t)1)));
...
IWDT_Overflow_Config (uint32_t Overflow)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(Overflow) <= 0xFFF));
