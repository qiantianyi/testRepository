...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_op.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_op.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 10 "../src/kf32a9k1xxx_op.c" 2
# 21 "../src/kf32a9k1xxx_op.c"
void
OP_Reset(void)
{
...
void
OP_Enable(uint32_t OPx_NUM, FunctionalState NewState)
{

 CHECK_RESTRICTION(((OPx_NUM) <= ((uint32_t)3)));
...
void
OP_OUTPUT_Enable(uint32_t OPx_NUM, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
# 75 "../src/kf32a9k1xxx_op.c"
void
OP_GAIN_Select(uint32_t OPx_NUM,
   uint32_t GAIN_Value, FunctionalState NewState)
{
 ...
 CHECK_RESTRICTION(((OPx_NUM) <= ((uint32_t)3)));
 CHECK_RESTRICTION((((GAIN_Value) == ((uint32_t)0)) || ((GAIN_Value) == ((uint32_t)1)) || ((GAIN_Value) == ((uint32_t)2)) || ((GAIN_Value) == ((uint32_t)3)) || ((GAIN_Value) == ((uint32_t)4)) || ((GAIN_Value) == ((uint32_t)5))));
 CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
void
OP_OPUPUT_Parallel_Resistance(uint32_t OPx_NUM, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
# 120 "../src/kf32a9k1xxx_op.c"
void
OP_Positive_INPUT_Selsect(uint32_t OPx_NUM_OUTPUT,
   uint32_t OPx_NUM_PINPUT, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;


 CHECK_RESTRICTION(((OPx_NUM_OUTPUT) <= ((uint32_t)3)));
 CHECK_RESTRICTION(((OPx_NUM_PINPUT) <= ((uint32_t)2)));
 CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
void
OP_Positive_Negetive_Short(uint32_t OPx_NUM, FunctionalState NewState)
{
 uint32_t tmpreg = 0;
 uint32_t tmask = 0;
...
void
OP_VCOM_Positive_Select(uint32_t Select)
{

 CHECK_RESTRICTION((((Select) == ((uint32_t)1)) || ((Select) == ((uint32_t)3))));
...
void
OP_VCOM_Buffer_Output_Enable(FunctionalState NewState)
{
...
void
OP_VCOM_Buffer_Enable(FunctionalState NewState)
{
...
void
CMP3_Enable(FunctionalState NewState)
{
...
# 228 "../src/kf32a9k1xxx_op.c"
void
OP_TRIM_PMOS_Enable(FunctionalState NewState)
{
...
void
OP_TRIM_NMOS_Enable(FunctionalState NewState)
{
...
void
OP_TRIM_PMOS_Value_Config(uint32_t OPx_NUM, uint8_t Value)
{
 uint32_t tmpreg = 0;


 CHECK_RESTRICTION(((OPx_NUM) <= ((uint32_t)3)));
 CHECK_RESTRICTION((((Value) >> 0x06) == 0x00));
...
void
OP_TRIM_PMOS_Direction_Select(uint32_t OPx_NUM, uint32_t Direction)
{
 uint32_t tmpreg = 0;
...
void
OP_TRIM_NMOS_Value_Config(uint32_t OPx_NUM, uint8_t Value)
{
 uint32_t tmpreg = 0;
...
void
OP_TRIM_NMOS_Direction_Select(uint32_t OPx_NUM, uint32_t Direction)
{
 uint32_t tmpreg = 0;
