...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_osc.h" 2
...
# 15 "../src/kf32a9k1xxx_osc.c" 2
# 25 "../src/kf32a9k1xxx_osc.c"
void
OSC_SCLK_Configuration (OSC_InitTypeDef* oscInitStruct)
{
 ...
 uint32_t tmpmask = 0x00;
    ...
    CHECK_RESTRICTION((((oscInitStruct->m_InputSource) >> 0x03) == 0x00));
    CHECK_RESTRICTION(((uint32_t)(oscInitStruct->m_CLKDivision) <= ((uint32_t)0x7)));
    CHECK_RESTRICTION((((oscInitStruct->m_PLLInputSource) >> 0x01) == 0x00));
    CHECK_RESTRICTION((((oscInitStruct->m_StartDelay) >> 0x04) == 0x00));
...
OSC_LFCK_Configuration (OSC_InitTypeDef* oscInitStruct)
{
    ...
    CHECK_RESTRICTION(((oscInitStruct->m_InputSource) <= ((uint32_t)0x1)));
    CHECK_RESTRICTION(((uint32_t)(oscInitStruct->m_CLKDivision) <= ((uint32_t)0x7)));
...
OSC_LFCK_Division_Config (uint32_t LFDivision)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(LFDivision) <= ((uint32_t)0x7)));
...
OSC_HFCK_Division_Config (uint32_t HFDivision)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(HFDivision) <= ((uint32_t)0x9)));
...
OSC_SCK_Division_Config (uint32_t SclkDivision)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(SclkDivision) <= ((uint32_t)0x7)));
...
# 245 "../src/kf32a9k1xxx_osc.c"
void
OSC_PLL_Input_Source_Config (uint32_t NewState)
{

    CHECK_RESTRICTION((((NewState) >> 0x01) == 0x00));
...
OSC_HFCK_Source_Config (uint32_t HFSource)
{
    ...
    CHECK_RESTRICTION((((HFSource) >> 0x03) == 0x00));
...
# 318 "../src/kf32a9k1xxx_osc.c"
void
OSC_LFCK_Source_Config (uint32_t NewState)
{

    CHECK_RESTRICTION(((NewState) <= ((uint32_t)0x1)));
...
OSC_SCK_Source_Config (uint32_t SclkSource)
{
    ...
    CHECK_RESTRICTION((((SclkSource) >> 0x03) == 0x00));
...
# 447 "../src/kf32a9k1xxx_osc.c"
void
OSC_SCLK_Output_Select (uint32_t ClkSource)
{
    uint32_t tmpreg = 0;

    CHECK_RESTRICTION((((ClkSource) >> 0x03) == 0x00));


    tmpreg = ClkSource << (25);
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1) = SFR_Config ((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1), ~((uint32_t)0x07<<((25))), tmpreg);
}
# 472 "../src/kf32a9k1xxx_osc.c"
void
OSC_SCLK_Output_Division_Config (uint32_t OutputDivision)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(OutputDivision) <= ((uint32_t)0x7)));
...
# 518 "../src/kf32a9k1xxx_osc.c"
void
OSC_Clock_Failure_Check_Division_Config (uint32_t FSCM_DIV)
{
 uint32_t tmpreg = 0x00;


    CHECK_RESTRICTION((((FSCM_DIV) >> 0x02) == 0x00));


    tmpreg = FSCM_DIV << (17);
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1) = SFR_Config((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1), ~(((uint32_t)0x03<<((17)))), tmpreg);
}
# 541 "../src/kf32a9k1xxx_osc.c"
void
OSC_PLL_Multiple_Value_Select (uint32_t PLLmultiple_M,uint32_t PLLmultiple_N,uint32_t PLLmultiple_NO)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(PLLmultiple_M) <= 0x3FFF));
    CHECK_RESTRICTION(((uint32_t)(PLLmultiple_N) <= 0xF));
    CHECK_RESTRICTION((((PLLmultiple_NO) == 1) || ((PLLmultiple_NO) == 2) || ((PLLmultiple_NO) == 4) || ((PLLmultiple_NO) == 8)));
...
OSC_EXTHF_Start_Delay_Config (uint32_t ExternalDelay)
{
    ...
    CHECK_RESTRICTION((((ExternalDelay) >> 0x04) == 0x00));
...
void
OSC_LP4M_Software_Enable (FunctionalState NewState)
{
...
OSC_Positive_Drift_Config (uint32_t PositiveDrift)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(PositiveDrift) <= 0x1F));
...
OSC_Current_Gain_Config (uint32_t PositiveDrift)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(PositiveDrift) <= 3));
...
# 954 "../src/kf32a9k1xxx_osc.c"
void
OSC_Feedback_Resistance_Config (uint32_t NewState)
{

    CHECK_RESTRICTION((((NewState) == ((uint32_t)0)) || ((NewState) == ((uint32_t)1))));
