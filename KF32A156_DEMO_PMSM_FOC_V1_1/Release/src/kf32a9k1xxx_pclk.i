...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_pclk.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 13 "../src/kf32a9k1xxx_pclk.c" 2
# 33 "../src/kf32a9k1xxx_pclk.c"
void
PCLK_CTL0_Peripheral_Clock_Enable (uint32_t PCLK_CTL0_bit,
                    FunctionalState NewState)
{

    CHECK_RESTRICTION(((((PCLK_CTL0_bit) >> 8) == 0x00) && ((PCLK_CTL0_bit) != 0x00)));
...
# 80 "../src/kf32a9k1xxx_pclk.c"
void
PCLK_CTL1_Peripheral_Clock_Enable (uint32_t PCLK_CTL1_bit,
                    FunctionalState NewState)
{

    CHECK_RESTRICTION(((((PCLK_CTL1_bit) & 0xE0440381) == 0x00) && ((PCLK_CTL1_bit) != 0x00)));
    CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
# 121 "../src/kf32a9k1xxx_pclk.c"
void
PCLK_CTL2_Peripheral_Clock_Enable (uint32_t PCLK_CTL2_bit,
     FunctionalState NewState)
{

 CHECK_RESTRICTION(((((PCLK_CTL2_bit) & 0x469EA0DC) == 0x00) && ((PCLK_CTL2_bit) != 0x00)));
 CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
# 170 "../src/kf32a9k1xxx_pclk.c"
void
PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
     FunctionalState NewState)
{

 CHECK_RESTRICTION(((((PCLK_CTL3_bit) & 0x49879) == 0x00) && ((PCLK_CTL3_bit) != 0x00)));
 CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
