...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_qei.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_qei.c" 2
# 43 "../src/kf32a9k1xxx_qei.c"
void
QEI_Reset (QEI_SFRmap* QEIx)
{

    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
...
QEI_Configuration(QEI_SFRmap* QEIx, QEI_InitTypeDef* qeiInitStruct)
{
    ...
    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION((((qeiInitStruct->m_IndexReset) == FALSE) || (qeiInitStruct->m_IndexReset) == TRUE));
    CHECK_RESTRICTION((((qeiInitStruct->m_DirectionEn) == FALSE) || (qeiInitStruct->m_DirectionEn) == TRUE));
    CHECK_RESTRICTION((((qeiInitStruct->m_WorkClock) == ((uint32_t)0<<(5))) || ((qeiInitStruct->m_WorkClock) == ((uint32_t)1<<(5))) || ((qeiInitStruct->m_WorkClock) == ((uint32_t)2<<(5)))));
    CHECK_RESTRICTION((((qeiInitStruct->m_DigitalFilterEn) == FALSE) || (qeiInitStruct->m_DigitalFilterEn) == TRUE));
    CHECK_RESTRICTION((((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)0<<(1))) || ((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)1<<(1))) || ((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)2<<(1))) || ((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)3<<(1))) || ((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)4<<(1))) || ((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)5<<(1))) || ((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)6<<(1))) || ((qeiInitStruct->m_DigitalFilterPrescaler) == ((uint32_t)7<<(1))))
                                                                    );
    CHECK_RESTRICTION((((qeiInitStruct->m_SwapABEn) == FALSE) || (qeiInitStruct->m_SwapABEn) == TRUE));
...
QEI_Timer_Configuration(QEI_SFRmap* QEIx, QEI_TimerTypeDef* qeiTimerInitStruct)
{
    ...
    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION((((qeiTimerInitStruct->m_CounterMode) == (0)) || ((qeiTimerInitStruct->m_CounterMode) == ((uint32_t)1<<(0)))));
    CHECK_RESTRICTION((((qeiTimerInitStruct->m_ClockSource) == ((uint32_t)0<<(3))) || ((qeiTimerInitStruct->m_ClockSource) == ((uint32_t)1<<(3)))));
...
QEI_Encoder_Mode_Config (QEI_SFRmap* QEIx, uint32_t PortMode)
{
    ...
    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION((((PortMode) == ((uint32_t)0)) || ((PortMode) == ((uint32_t)1)) || ((PortMode) == ((uint32_t)4)) || ((PortMode) == ((uint32_t)5)) || ((PortMode) == ((uint32_t)6)) || ((PortMode) == ((uint32_t)7))));
...
# 270 "../src/kf32a9k1xxx_qei.c"
void
QEI_Timer_Source_Clock_Config (QEI_SFRmap* QEIx, uint32_t TimerClock)
{

    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION((((TimerClock) == ((uint32_t)0<<(3))) || ((TimerClock) == ((uint32_t)1<<(3)))));
...
# 348 "../src/kf32a9k1xxx_qei.c"
void
QEI_Location_Counter_Direction_Config (QEI_SFRmap* QEIx, uint32_t Direction)
{

    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION((((Direction) == (0)) || ((Direction) == ((uint32_t)1<<(0)))));
...
QEI_LP_Source_Clock_Config(QEI_SFRmap* QEIx, uint32_t QEICLK)
{
 uint32_t tmpreg = 0;
    ...
    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION(((QEICLK) <= 0x01));


    tmpreg = QEICLK << (11);
    QEIx->CTL0 = SFR_Config(QEIx->CTL0, ~((uint32_t)1<<((11))), tmpreg);
}
# 423 "../src/kf32a9k1xxx_qei.c"
void
QEI_Source_Clock_Config (QEI_SFRmap* QEIx, uint32_t PeripheralClock)
{

    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION((((PeripheralClock) == ((uint32_t)0<<(5))) || ((PeripheralClock) == ((uint32_t)1<<(5))) || ((PeripheralClock) == ((uint32_t)2<<(5)))));
...
# 477 "../src/kf32a9k1xxx_qei.c"
void
QEI_Digital_Filter_Clock_Config (QEI_SFRmap* QEIx, uint32_t DigitalFilterClock)
{

    CHECK_RESTRICTION((((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000500))) || ((QEIx) == ((QEI_SFRmap *) ((uint32_t)0x40000080)))));
    CHECK_RESTRICTION((((DigitalFilterClock) == ((uint32_t)0<<(1))) || ((DigitalFilterClock) == ((uint32_t)1<<(1))) || ((DigitalFilterClock) == ((uint32_t)2<<(1))) || ((DigitalFilterClock) == ((uint32_t)3<<(1))) || ((DigitalFilterClock) == ((uint32_t)4<<(1))) || ((DigitalFilterClock) == ((uint32_t)5<<(1))) || ((DigitalFilterClock) == ((uint32_t)6<<(1))) || ((DigitalFilterClock) == ((uint32_t)7<<(1)))));
