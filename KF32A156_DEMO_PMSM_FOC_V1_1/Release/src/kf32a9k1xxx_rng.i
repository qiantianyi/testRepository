...
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_rng.h"
...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_rng.h" 2
...
RNG_Real_RNG_Mode_Enable(FunctionalState NewState)
{
 ...
 (((RNG_SFRmap *) ((uint32_t) 0x40002F80))->CTL) = SFR_Config((((RNG_SFRmap *) ((uint32_t) 0x40002F80))->CTL), ~((uint32_t)1<<((30))), NewState << (30));
}
...
RNG_Real_RNG_Seed_Correct_Enable(FunctionalState NewState)
{
 ...
 (((RNG_SFRmap *) ((uint32_t) 0x40002F80))->CTL) = SFR_Config((((RNG_SFRmap *) ((uint32_t) 0x40002F80))->CTL), ~((uint32_t)1<<((29))), NewState << (29));
}
...
RNG_Real_RNG_Seed_High_Pow_Enable(FunctionalState NewState)
{
 ...
 (((RNG_SFRmap *) ((uint32_t) 0x40002F80))->CTL) = SFR_Config((((RNG_SFRmap *) ((uint32_t) 0x40002F80))->CTL), ~((uint32_t)1<<((28))), NewState << (28));
}
# 78 "../src/kf32a9k1xxx_rng.c"
void
...
RNG_Seed_Select(uint32_t Seed)
{
 ...
 CHECK_RESTRICTION(((Seed) <= ((uint32_t)1)));
