...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 13 "../src/kf32a9k1xxx_rst.c" 2
# 34 "../src/kf32a9k1xxx_rst.c"
void
RST_CTL0_Peripheral_Reset_Enable (uint32_t RST_CTL0_bit,
     FunctionalState NewState)
{

 CHECK_RESTRICTION(((((RST_CTL0_bit) >> 9) == 0x00) && ((RST_CTL0_bit) != 0x00)));
...
# 81 "../src/kf32a9k1xxx_rst.c"
void
RST_CTL1_Peripheral_Reset_Enable (uint32_t RST_CTL1_bit,
     FunctionalState NewState)
{

 CHECK_RESTRICTION(((((RST_CTL1_bit) & 0xE0440381) == 0x00) && ((RST_CTL1_bit) != 0x00)));
 CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
# 122 "../src/kf32a9k1xxx_rst.c"
void
RST_CTL2_Peripheral_Reset_Enable (uint32_t RST_CTL2_bit,
     FunctionalState NewState)
{

    CHECK_RESTRICTION(((((RST_CTL2_bit) & 0x469EA0DC) == 0x00) && ((RST_CTL2_bit) != 0x00)));
    CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
...
# 169 "../src/kf32a9k1xxx_rst.c"
void
RST_CTL3_Peripheral_Reset_Enable (uint32_t RST_CTL3_bit,
                    FunctionalState NewState)
{

    CHECK_RESTRICTION(((((RST_CTL3_bit) & 0x49879) == 0x00) && ((RST_CTL3_bit) != 0x00)));
    CHECK_RESTRICTION((((NewState) == FALSE) || (NewState) == TRUE));
