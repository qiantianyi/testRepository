...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_spi.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_spi.c" 2
# 44 "../src/kf32a9k1xxx_spi.c"
void
SPI_Reset(SPI_SFRmap* SPIx)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
...
SPI_Configuration(SPI_SFRmap* SPIx, SPI_InitTypeDef* spiInitStruct)
{
    ...
    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((spiInitStruct->m_Mode) == ((uint32_t)0<<(1))) || ((spiInitStruct->m_Mode) == ((uint32_t)1<<(1))) || ((spiInitStruct->m_Mode) == ((uint32_t)2<<(1))) || ((spiInitStruct->m_Mode) == ((uint32_t)3<<(1))) || ((spiInitStruct->m_Mode) == ((uint32_t)4<<(1)))));
    CHECK_RESTRICTION((((spiInitStruct->m_Clock) == ((uint32_t)0<<(4))) || ((spiInitStruct->m_Clock) == ((uint32_t)1<<(4))) || ((spiInitStruct->m_Clock) == ((uint32_t)2<<(4)))));
    CHECK_RESTRICTION((((spiInitStruct->m_FirstBit) == ((uint32_t)1<<(6))) || ((spiInitStruct->m_FirstBit) == ((uint32_t)0<<(6)))));
    CHECK_RESTRICTION((((spiInitStruct->m_CKP) == ((uint32_t)1<<(8))) || ((spiInitStruct->m_CKP) == ((uint32_t)0<<(8)))));
    CHECK_RESTRICTION((((spiInitStruct->m_CKE) == ((uint32_t)0<<(9))) || ((spiInitStruct->m_CKE) == ((uint32_t)1<<(9)))));
    CHECK_RESTRICTION((((spiInitStruct->m_DataSize) == ((uint32_t)0<<(12))) || ((spiInitStruct->m_DataSize) == ((uint32_t)1<<(12))) || ((spiInitStruct->m_DataSize) == ((uint32_t)2<<(12)))));
# 107 "../src/kf32a9k1xxx_spi.c"
...
I2S_Configuration(SPI_SFRmap* SPIx, I2S_InitTypeDef* i2sInitStruct)
{
    ...
    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((i2sInitStruct->m_Mode) == ((uint32_t)0<<(20))) || ((i2sInitStruct->m_Mode) == ((uint32_t)1<<(20))) || ((i2sInitStruct->m_Mode) == ((uint32_t)2<<(20))) || ((i2sInitStruct->m_Mode) == ((uint32_t)3<<(20)))));
    CHECK_RESTRICTION((((i2sInitStruct->m_Standard) == ((uint32_t)0<<(22))) || ((i2sInitStruct->m_Standard) == ((uint32_t)1<<(22))) || ((i2sInitStruct->m_Standard) == ((uint32_t)2<<(22))) || ((i2sInitStruct->m_Standard) == ((uint32_t)3<<(22)))));
    CHECK_RESTRICTION((((i2sInitStruct->m_PCM) == ((uint32_t)0<<(24))) || ((i2sInitStruct->m_PCM) == ((uint32_t)1<<(24)) )));
    CHECK_RESTRICTION((((i2sInitStruct->m_Clock) == ((uint32_t)3<<(25))) || ((i2sInitStruct->m_Clock) == ((uint32_t)2<<(25))) || ((i2sInitStruct->m_Clock) == ((uint32_t)0<<(25)) )));
    CHECK_RESTRICTION((((i2sInitStruct->m_CKP) == ((uint32_t)0<<(27))) || ((i2sInitStruct->m_CKP) == ((uint32_t)1<<(27)))));
...
SPI_Struct_Init(SPI_InitTypeDef* SPI_InitStruct)
{
    ...
    SPI_InitStruct->m_CKP = ((uint32_t)1<<(8));
...
# 364 "../src/kf32a9k1xxx_spi.c"
void
SPI_MODE_Config (SPI_SFRmap* SPIx,uint32_t MODE)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((MODE) == ((uint32_t)0<<(1))) || ((MODE) == ((uint32_t)1<<(1))) || ((MODE) == ((uint32_t)2<<(1))) || ((MODE) == ((uint32_t)3<<(1))) || ((MODE) == ((uint32_t)4<<(1)))));


    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)7<<((1))), MODE);
}
# 384 "../src/kf32a9k1xxx_spi.c"
void
SPI_CLK_Config (SPI_SFRmap* SPIx,uint32_t ClockSource)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((ClockSource) == ((uint32_t)0<<(4))) || ((ClockSource) == ((uint32_t)1<<(4))) || ((ClockSource) == ((uint32_t)2<<(4)))));


    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((4))), ClockSource);
}
# 403 "../src/kf32a9k1xxx_spi.c"
void
SPI_Data_Direction_Config(SPI_SFRmap* SPIx,uint32_t DataDirection)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((DataDirection) == ((uint32_t)1<<(6))) || ((DataDirection) == ((uint32_t)0<<(6)))));
...
# 431 "../src/kf32a9k1xxx_spi.c"
void
SPI_Clock_Polarity_Config (SPI_SFRmap* SPIx,uint32_t Polarity)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((Polarity) == ((uint32_t)1<<(8))) || ((Polarity) == ((uint32_t)0<<(8)))));


    if (Polarity != ((uint32_t)1<<(8)))
    {
...
# 459 "../src/kf32a9k1xxx_spi.c"
void
SPI_Clock_Edge_Config (SPI_SFRmap* SPIx,uint32_t ClockEdge)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((ClockEdge) == ((uint32_t)0<<(9))) || ((ClockEdge) == ((uint32_t)1<<(9)))));
...
# 488 "../src/kf32a9k1xxx_spi.c"
void
SPI_BIT_SELECT_Config(SPI_SFRmap* SPIx,uint32_t DataSize)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((DataSize) == ((uint32_t)0<<(12))) || ((DataSize) == ((uint32_t)1<<(12))) || ((DataSize) == ((uint32_t)2<<(12)))));


    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((12))), DataSize);
}
# 509 "../src/kf32a9k1xxx_spi.c"
void
SPI_I2S_MODE_Config (SPI_SFRmap* SPIx,uint32_t Mode)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((Mode) == ((uint32_t)0<<(20))) || ((Mode) == ((uint32_t)1<<(20))) || ((Mode) == ((uint32_t)2<<(20))) || ((Mode) == ((uint32_t)3<<(20)))));


    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((20))), Mode);
}
# 530 "../src/kf32a9k1xxx_spi.c"
void
SPI_I2S_STANDARD_Config(SPI_SFRmap* SPIx,uint32_t Standard)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((Standard) == ((uint32_t)0<<(22))) || ((Standard) == ((uint32_t)1<<(22))) || ((Standard) == ((uint32_t)2<<(22))) || ((Standard) == ((uint32_t)3<<(22)))));


    SPIx->CTLR = SFR_Config (SPIx->CTLR, ~((uint32_t)3<<((22))), Standard);
}
# 549 "../src/kf32a9k1xxx_spi.c"
void
SPI_PCM_Config (SPI_SFRmap* SPIx,uint32_t NewState)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((NewState) == ((uint32_t)0<<(24))) || ((NewState) == ((uint32_t)1<<(24)) )));
...
# 577 "../src/kf32a9k1xxx_spi.c"
void
SPI_CHLEN_Config (SPI_SFRmap* SPIx,uint32_t NewState)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((NewState) == ((uint32_t)3<<(25))) || ((NewState) == ((uint32_t)2<<(25))) || ((NewState) == ((uint32_t)0<<(25)) )));
...
# 613 "../src/kf32a9k1xxx_spi.c"
void
SPI_PCM_CLOCK_Polarity_Config(SPI_SFRmap* SPIx,uint32_t NewState)
{

    CHECK_RESTRICTION((((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C00))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40000C80))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002080))) || ((SPIx) == ((SPI_SFRmap *) ((uint32_t)0x40002100)))));
    CHECK_RESTRICTION((((NewState) == ((uint32_t)0<<(27))) || ((NewState) == ((uint32_t)1<<(27)))));
...
# 666 "../src/kf32a9k1xxx_spi.c"
void
SPI_I2S_Idle_MCK_Outpue_Select(SPI_SFRmap* SPIx,FunctionalState NewState)
{
