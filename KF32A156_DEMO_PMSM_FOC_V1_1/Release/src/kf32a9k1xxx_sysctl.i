...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_sysctl.h" 2
...
# 14 "../src/kf32a9k1xxx_sysctl.c" 2
# 31 "../src/kf32a9k1xxx_sysctl.c"
FlagStatus
...
# 331 "../src/kf32a9k1xxx_sysctl.c"
void
SYSCTL_Stack_Pointer_Config (uint32_t PresentSP)
{

    CHECK_RESTRICTION((((PresentSP) == ((uint32_t)0<<(16))) || ((PresentSP) == ((uint32_t)1<<(16)))));
...
SYSCTL_Cdmaam_Config(uint32_t Mode)
{
 uint32_t tmpreg = 0x00;
    ...
    CHECK_RESTRICTION((((Mode) == ((uint32_t)0<<(5))) || ((Mode) == ((uint32_t)1<<(5)))));
...
SYSCTL_RW_Per_Cycle_Config(uint32_t Cycle)
{
 uint32_t tmpreg = 0x00;
    ...
    CHECK_RESTRICTION((((Cycle) == ((uint32_t)0<<(6))) || ((Cycle) == ((uint32_t)1<<(6)))));
...
SYSCTL_RW_Dma_Cycle_Config(uint32_t Cycle)
{
 uint32_t tmpreg = 0x00;
    ...
    CHECK_RESTRICTION((((Cycle) == ((uint32_t)0<<(7))) || ((Cycle) == ((uint32_t)1<<(7)))));
...
SYSCTL_RW_Dma_Long_Cycle_Config(uint32_t Cycle)
{
 uint32_t tmpreg = 0x00;
    ...
    CHECK_RESTRICTION((((Cycle) <= ((uint32_t)3<<(9))) && ((Cycle) >= ((uint32_t)0<<(9)))));
...
SYSCTL_Ram_Space_Config (uint32_t RamSpace)
{
 uint32_t tmpreg = 0;
    ...
    CHECK_RESTRICTION(((uint32_t)(RamSpace) <= ((uint32_t)0x3FFFFFF<<((0)))));
...
# 522 "../src/kf32a9k1xxx_sysctl.c"
void
SYSCTL_Flash_Start_Remap_Config (uint32_t MemCtl)
{

    CHECK_RESTRICTION((((MemCtl) <= ((uint32_t)3 << (0))) && ((MemCtl) >= ((uint32_t)0 << (0)))));
...
SYSCTL_MSPSPAH_Threshold_Config (uint16_t Mspspah)
{
    ...
    CHECK_RESTRICTION((((Mspspah) >> 0x10) == 0x00));
...
SYSCTL_MSPSPAL_Threshold_Config (uint16_t Mspspal)
{
 ...
 CHECK_RESTRICTION((((Mspspal) >> 0x10) == 0x00));
...
SYSCTL_PSPSPAH_Threshold_Config (uint16_t Pspspah)
{
    ...
    CHECK_RESTRICTION((((Pspspah) >> 0x10) == 0x00));
...
SYSCTL_PSPSPAL_Threshold_Config (uint16_t Pspspal)
{
    ...
    CHECK_RESTRICTION((((Pspspal) >> 0x10) == 0x00));
