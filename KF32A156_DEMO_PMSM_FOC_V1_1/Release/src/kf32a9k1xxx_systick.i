...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_systick.h" 2
...
# 14 "../src/kf32a9k1xxx_systick.c" 2
# 41 "../src/kf32a9k1xxx_systick.c"
void
SYSTICK_Configuration (uint32_t Clock, uint32_t SysTickINT, uint32_t Reload)
{
    ...
    CHECK_RESTRICTION((((Clock) == ((uint32_t)0x0 << (2))) || ((Clock) == ((uint32_t)0x1 << (2)))));
    CHECK_RESTRICTION((((Reload) >> 24) == 0));
    CHECK_RESTRICTION((((SysTickINT) == FALSE) || (SysTickINT) == TRUE));
...
# 112 "../src/kf32a9k1xxx_systick.c"
void
SYSTICK_Clock_Config (uint32_t SysClock)
{

    CHECK_RESTRICTION((((SysClock) == ((uint32_t)0x0 << (2))) || ((SysClock) == ((uint32_t)0x1 << (2)))));
...
SYSTICK_Systick_INT_Enable (uint32_t SysClock)
{
    ...
    CHECK_RESTRICTION((((SysClock) == FALSE) || (SysClock) == TRUE));
