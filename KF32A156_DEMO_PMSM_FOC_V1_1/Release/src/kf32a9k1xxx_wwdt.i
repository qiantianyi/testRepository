...
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_wwdt.h" 2
...
# 15 "../src/kf32a9k1xxx_wwdt.c" 2
# 1 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_rst.h" 1
# 11 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_rst.h"
# 1 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/KF32A9K1XXX.h" 1
# 12 "E:\\qiantianyi\\testRepository\\KF32A156_DEMO_PMSM_FOC_V1_1\\inc/kf32a9k1xxx_rst.h" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../src/kf32a9k1xxx_wwdt.c" 2
# 27 "../src/kf32a9k1xxx_wwdt.c"
void
WWDT_Reset (void)
{
...
WWDT_Threshold_Config (uint32_t Threshold)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(Threshold) <= 0x3F));


    tmpreg = Threshold << (8);
    (((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL) = SFR_Config ((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL), ~((uint32_t)0x7F<<((8))), tmpreg);
}
# 80 "../src/kf32a9k1xxx_wwdt.c"
void
WWDT_Prescaler_Config (uint32_t Prescaler)
{

    CHECK_RESTRICTION((((Prescaler) == ((uint32_t)0x0<<(3))) || ((Prescaler) == ((uint32_t)0x1<<(3))) || ((Prescaler) == ((uint32_t)0x2<<(3))) || ((Prescaler) == ((uint32_t)0x3<<(3))) || ((Prescaler) == ((uint32_t)0x4<<(3))) || ((Prescaler) == ((uint32_t)0x5<<(3))) || ((Prescaler) == ((uint32_t)0x6<<(3))) || ((Prescaler) == ((uint32_t)0x7<<(3))) || ((Prescaler) == ((uint32_t)0x8<<(3))) || ((Prescaler) == ((uint32_t)0x9<<(3))) || ((Prescaler) == ((uint32_t)0xA<<(3))) || ((Prescaler) == ((uint32_t)0xB<<(3))) || ((Prescaler) == ((uint32_t)0xC<<(3))) || ((Prescaler) == ((uint32_t)0xD<<(3))) || ((Prescaler) == ((uint32_t)0xE<<(3))) || ((Prescaler) == ((uint32_t)0xF<<(3))) || ((Prescaler) == ((uint32_t)0x10<<(3))) || ((Prescaler) == ((uint32_t)0x11<<(3))) || ((Prescaler) == ((uint32_t)0x12<<(3)))));


    (((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL) = SFR_Config ((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL), ~((uint32_t)0x1F<<((3))), Prescaler);
}
# 99 "../src/kf32a9k1xxx_wwdt.c"
void
...
WWDT_Counter_Config (uint32_t Counter)
{
    ...
    CHECK_RESTRICTION(((uint32_t)(Counter) <= 0x3F));
