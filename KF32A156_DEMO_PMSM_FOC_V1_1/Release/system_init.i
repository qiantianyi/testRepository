...
# 3 "../driver/system_init.c" 2

uint32_t ST_Delay_num = 120;
...
void cfg_CLK(void)
{
 ...
 HFCK_Config();
 LFCK_Config();
 (((FLASH_SFRmap *) ((uint32_t)0x40200100))->CFG) = 0x000000C4;
 (((CACHE_SFRmap *) ((uint32_t)0x402000C0))->CTLR) |= 0x0001;
}
...
void SCLK_Config(void)
{
 ...
 (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL0) |= 0x01;
 PM_EXTHF_PIN_Selection_Config(((uint32_t)0<<(15)));
 OSC_EXTHF_Start_Delay_Config(((uint32_t)0x09));
 ...
 OSC_PLL_Start_Delay_Config(((uint32_t)0x09));
...
void SCLK_OUTPUT(uint8_t CLKOUT_PIN)
{
 if(CLKOUT_PIN == 1)
 {
     GPIO_Speed_Config(((GPIO_SFRmap *) ((uint32_t)0x50000140)), ((uint16_t)0x0008), GPIO_HIGH_SPEED);
  GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000140)), ((uint16_t)0x0008), GPIO_MODE_RMP);
  GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000140)), ((uint32_t)0x3), ((uint32_t)0x0100));
 }
 else
 {
  GPIO_Speed_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)), ((uint16_t)0x0001), GPIO_HIGH_SPEED);
  GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)), ((uint16_t)0x0001), GPIO_MODE_RMP);
  GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)), ((uint32_t)0x0), ((uint32_t)0x0100));
 }
...
void Delay_ms_ST(uint32_t delay_temp)
{
 SYSTICK_Configuration(((uint32_t)0x1 << (2)),FALSE,ST_Delay_num*1000);
 SYSTICK_Cmd(TRUE);
 while(delay_temp)
 {
...
void Delay_us_ST(uint32_t delay_temp)
{
 SYSTICK_Configuration(((uint32_t)0x1 << (2)),FALSE,ST_Delay_num);
 SYSTICK_Cmd(TRUE);
 while(delay_temp)
 {
  if(SYSTICK_Get_Count_Zero_Flag() == SET)
