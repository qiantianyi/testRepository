...
#ifndef KF32A9K1XXX_H_
#define KF32A9K1XXX_H_
...
#define OSC_CTL1_FSCMGAP				((uint32_t)0x03<<(OSC_CTL1_FSCMGAP0_POS))
...
#define CAN_CTLR_TRIEN					((uint32_t)1<<(CAN_CTLR_TRIEN_POS))
...
#define CNA_RCR_RAMMB0_POS				(16)
#define CNA_RCR_RAMMB1_POS				(17)
#define CNA_RCR_RAMMB2_POS				(18)
#define CNA_RCR_RAMMB3_POS				(19)
#define CNA_RCR_RAMMB4_POS				(20)
#define CNA_RCR_RAMMB5_POS				(21)
...
#define CAN_RCR_RAMMB					((uint32_t)0x3F<<(CNA_RCR_RAMMB0_POS))
#define CAN_RCR_RAMMB0					((uint32_t)1<<(CNA_RCR_RAMMB0_POS))
#define CAN_RCR_RAMMB1					((uint32_t)1<<(CNA_RCR_RAMMB1_POS))
#define CAN_RCR_RAMMB2					((uint32_t)1<<(CNA_RCR_RAMMB2_POS))
#define CAN_RCR_RAMMB3					((uint32_t)1<<(CNA_RCR_RAMMB3_POS))
#define CAN_RCR_RAMMB4					((uint32_t)1<<(CNA_RCR_RAMMB4_POS))
#define CAN_RCR_RAMMB5					((uint32_t)1<<(CNA_RCR_RAMMB5_POS))
...
typedef struct CANFD_MenMap
{
	...
	volatile const uint32_t 	RXDATA[18];       /* CANFD数据接收缓冲寄存器0,偏移：0x020 */
	volatile 	   uint32_t 	TIMER;   		/* 时间戳计数器,偏移：0x068 */
	volatile const uint32_t 	CRC;      		/* FLEXCRC寄存器,偏移：0x06C */
			       uint32_t 	RESERVED2;   	/* 保留地址, 偏移:0x70 */
