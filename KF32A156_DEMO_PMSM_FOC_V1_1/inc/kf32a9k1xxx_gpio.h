...
#ifndef KF32A9K1XXX_GPIO_H_
#define KF32A9K1XXX_GPIO_H_
...
/**
  * GPIO引脚重映射
  */
#define	GPIO_RMP_PAGE1_AF0			     ((uint32_t)0x0100)
#define	GPIO_RMP_PAGE1_AF1			     ((uint32_t)0x0101)
#define	GPIO_RMP_PAGE1_AF2			     ((uint32_t)0x0102)
#define	GPIO_RMP_PAGE1_AF3			     ((uint32_t)0x0103)
#define	GPIO_RMP_PAGE1_AF4			     ((uint32_t)0x0104)
#define	GPIO_RMP_PAGE1_AF5			     ((uint32_t)0x0105)
#define	GPIO_RMP_PAGE1_AF6			     ((uint32_t)0x0106)
#define	GPIO_RMP_PAGE1_AF7			     ((uint32_t)0x0107)
#define	GPIO_RMP_PAGE1_AF8			     ((uint32_t)0x0108)
#define	GPIO_RMP_PAGE1_AF9			     ((uint32_t)0x0109)
#define	GPIO_RMP_PAGE1_AF10			     ((uint32_t)0x010A)
#define	GPIO_RMP_PAGE1_AF11			     ((uint32_t)0x010B)
#define	GPIO_RMP_PAGE1_AF12			     ((uint32_t)0x010C)
#define	GPIO_RMP_PAGE1_AF13			     ((uint32_t)0x010D)
#define	GPIO_RMP_PAGE1_AF14			     ((uint32_t)0x010E)
#define	GPIO_RMP_PAGE1_AF15			     ((uint32_t)0x010F)
#define CHECK_GPIO_PAGE1_REMAP(RMP)		 (((RMP) <= GPIO_RMP_PAGE1_AF15) && ((RMP) >= GPIO_RMP_PAGE1_AF0))

#define	GPIO_RMP_PAGE2_AF0			     ((uint32_t)0x0200)
#define	GPIO_RMP_PAGE2_AF1			     ((uint32_t)0x0201)
#define	GPIO_RMP_PAGE2_AF2			     ((uint32_t)0x0202)
#define	GPIO_RMP_PAGE2_AF3			     ((uint32_t)0x0203)
#define	GPIO_RMP_PAGE2_AF4			     ((uint32_t)0x0204)
#define	GPIO_RMP_PAGE2_AF5			     ((uint32_t)0x0205)
#define	GPIO_RMP_PAGE2_AF6			     ((uint32_t)0x0206)
#define	GPIO_RMP_PAGE2_AF7			     ((uint32_t)0x0207)
#define	GPIO_RMP_PAGE2_AF8			     ((uint32_t)0x0208)
#define	GPIO_RMP_PAGE2_AF9			     ((uint32_t)0x0209)
#define	GPIO_RMP_PAGE2_AF10			     ((uint32_t)0x020A)
#define	GPIO_RMP_PAGE2_AF11			     ((uint32_t)0x020B)
#define	GPIO_RMP_PAGE2_AF12			     ((uint32_t)0x020C)
#define CHECK_GPIO_PAGE2_REMAP(RMP)		 (((RMP) <= GPIO_RMP_PAGE2_AF12) && ((RMP) >= GPIO_RMP_PAGE2_AF0))

#define	GPIO_RMP_PAGE3_AF0			     ((uint32_t)0x0300)
#define	GPIO_RMP_PAGE3_AF1			     ((uint32_t)0x0301)
#define	GPIO_RMP_PAGE3_AF2			     ((uint32_t)0x0302)
#define	GPIO_RMP_PAGE3_AF3			     ((uint32_t)0x0303)
#define	GPIO_RMP_PAGE3_AF4			     ((uint32_t)0x0304)
#define	GPIO_RMP_PAGE3_AF5			     ((uint32_t)0x0305)
#define	GPIO_RMP_PAGE3_AF6			     ((uint32_t)0x0306)
#define	GPIO_RMP_PAGE3_AF7			     ((uint32_t)0x0307)
#define	GPIO_RMP_PAGE3_AF8			     ((uint32_t)0x0308)
#define	GPIO_RMP_PAGE3_AF9			     ((uint32_t)0x0309)
#define	GPIO_RMP_PAGE3_AF10			     ((uint32_t)0x030A)
#define	GPIO_RMP_PAGE3_AF11			     ((uint32_t)0x030B)
#define	GPIO_RMP_PAGE3_AF12			     ((uint32_t)0x030C)
#define	GPIO_RMP_PAGE3_AF13			     ((uint32_t)0x030D)
#define	GPIO_RMP_PAGE3_AF14			     ((uint32_t)0x030E)
#define CHECK_GPIO_PAGE3_REMAP(RMP)		 (((RMP) <= GPIO_RMP_PAGE3_AF14) && ((RMP) >= GPIO_RMP_PAGE3_AF0))
