...
#ifndef KF32A9K1XXX_OSC_H_
#define KF32A9K1XXX_OSC_H_
 ...
 */
#define FSCM_DIVISION_16				 ((uint32_t)0x0)
#define FSCM_DIVISION_32				 ((uint32_t)0x1)
#define FSCM_DIVISION_64				 ((uint32_t)0x2)
#define FSCM_DIVISION_128				 ((uint32_t)0x3)
#define CHECK_FSMC_DIVISION(DIV)		 (((DIV) >> 0x02) == 0x00)
...
/**
  * 外部启动延时时间配置
  */
#define EXT_START_DELAY_128              ((uint32_t)0x00)
#define EXT_START_DELAY_256              ((uint32_t)0x01)
#define EXT_START_DELAY_512              ((uint32_t)0x02)
#define EXT_START_DELAY_1024             ((uint32_t)0x03)
#define EXT_START_DELAY_2048             ((uint32_t)0x04)
#define EXT_START_DELAY_4096             ((uint32_t)0x05)
#define EXT_START_DELAY_8192             ((uint32_t)0x06)
#define EXT_START_DELAY_16384            ((uint32_t)0x07)
#define EXT_START_DELAY_32769            ((uint32_t)0x08)
#define EXT_START_DELAY_65535            ((uint32_t)0x09)
