...
#ifndef KF32A9K1XXX_SPI_H_
#define KF32A9K1XXX_SPI_H_
...
/**
  * SPI时钟极性
  */
#define SPI_CKP_LOW                    ((uint32_t)1<<SPI_CTLR_SPICKP_POS)
#define SPI_CKP_HIGH                   ((uint32_t)0<<SPI_CTLR_SPICKP_POS)
