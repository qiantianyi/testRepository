...
/**
  * 描述  设置SRAM在standby模式下工作配置。
  * 输入  WorkMode: DPRAM_A区在standby模式下工作配置，取值为:
  *                   PM_SRAM_IN_STANDBY_POWER_DOWN: SRAM的A区在standby模式下掉电
  *                   PM_SRAM_IN_STANDBY_KEEP_DATA: SRAM的A区在standby模式下保持数据
  * 返回  无。
  */
void
